...
#define _onEdit(__c, __i, dataBox, obsolete, x, y, w, h, userData) \
   SVMETHOD(__c, class, onEdit, (C(Instance))null, C(Window), \
...
#define Instance_onEdit(__c, __i, dataBox, obsolete, x, y, w, h, userData) \
   SVMETHOD(__c, class, onEdit, __i, C(Window), \
...
extern THIS_LIB_IMPORT C(Application) eC_init(C(Module) fromModule, C(bool) loadEcere, C(bool) guiApp, int argc, char * argv[]);
