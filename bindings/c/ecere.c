...
LIB_EXPORT C(GlobalFunction) * FUNCTION(gLMultisampling);
...
LIB_EXPORT C(GlobalFunction) * FUNCTION(gLABBindVertexArray);
...
LIB_EXPORT C(GlobalFunction) * FUNCTION(glmsMultMatrixf);
...
LIB_EXPORT C(GlobalFunction) * FUNCTION(queryCompass);
...
LIB_EXPORT C(GlobalFunction) * FUNCTION(setCurlEmbeddedCA);
...
LIB_EXPORT C(Method) * METHOD(FreeSpots, init);
LIB_EXPORT C(Method) * METHOD(FreeSpots, markFree);
LIB_EXPORT C(Method) * METHOD(FreeSpots, next);
LIB_EXPORT C(Method) * METHOD(FreeSpots, resize);

LIB_EXPORT C(Method) * METHOD(GLArrayTexture, _init);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, allocateLayer);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, bind);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, copy);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, free);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, freeLayer);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, init);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, initMaxLevel);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, initRGBAUShort);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, initRGBUShort);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, initUShort);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, resize);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, set1x1Layer);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setFilter);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayer);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayerCompressed);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayerFormat);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayerRGBAUShort);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayerRGBUShort);
LIB_EXPORT C(Method) * METHOD(GLArrayTexture, setLayerUShort);

LIB_EXPORT C(Method) * METHOD(GLMultiDraw, addDrawCommand);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, addDrawCommandCustomID);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, allocateIx);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, allocateVbo);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, draw);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, free);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, freeIx);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, freeVbo);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, init);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, prepare);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, printStats);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, resize);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, resizeCommands);
LIB_EXPORT C(Method) * METHOD(GLMultiDraw, resizeIDs);
...
LIB_EXPORT C(Method) * METHOD(Bitmap, copy2);
...
LIB_EXPORT C(Method) * METHOD(Bitmap, processDD);
...
LIB_EXPORT C(Method) * METHOD(CubeMap, loadFromFiles);
...
LIB_EXPORT C(Method) * METHOD(Display, drawMeshEx);
LIB_EXPORT C(Method) * METHOD(Display, drawObject);
LIB_EXPORT C(Method) * METHOD(Display, drawObjectEx);
...
LIB_EXPORT C(Method) * METHOD(Display, setCameraVR);
...
LIB_EXPORT C(Method) * METHOD(DisplayDriver, setCameraVR);
...
LIB_EXPORT C(Method) * METHOD(DisplayDriver, stretchf);
...
LIB_EXPORT C(Method) * METHOD(DrawList, addObject);
LIB_EXPORT C(Method) * METHOD(DrawList, init);
LIB_EXPORT C(Method) * METHOD(DrawList, prepare);
LIB_EXPORT C(Method) * METHOD(DrawList, render);
...
LIB_EXPORT C(Method) * METHOD(Surface, stretchf);
...
LIB_EXPORT C(Method) * METHOD(DefaultShader, setBoneMatrices);
...
LIB_EXPORT C(Method) * METHOD(DefaultShader, useExternalTexture);

LIB_EXPORT C(Method) * METHOD(FreeBlockMap, allocate);
LIB_EXPORT C(Method) * METHOD(FreeBlockMap, freeBlock);
LIB_EXPORT C(Method) * METHOD(FreeBlockMap, onExpand);

LIB_EXPORT C(Method) * METHOD(GLAB, use);
LIB_EXPORT C(Method) * METHOD(GLAB, useVertTrans);

LIB_EXPORT C(Method) * METHOD(GLB, _allocate);
LIB_EXPORT C(Method) * METHOD(GLB, _upload);
LIB_EXPORT C(Method) * METHOD(GLB, allocate);
LIB_EXPORT C(Method) * METHOD(GLB, copy);
LIB_EXPORT C(Method) * METHOD(GLB, deleteBuffers);
LIB_EXPORT C(Method) * METHOD(GLB, free);
LIB_EXPORT C(Method) * METHOD(GLB, resize);
LIB_EXPORT C(Method) * METHOD(GLB, upload);

LIB_EXPORT C(Method) * METHOD(GLCAB, allocate);
LIB_EXPORT C(Method) * METHOD(GLCAB, upload);

LIB_EXPORT C(Method) * METHOD(GLEAB, allocate);
LIB_EXPORT C(Method) * METHOD(GLEAB, draw);
LIB_EXPORT C(Method) * METHOD(GLEAB, draw2);
LIB_EXPORT C(Method) * METHOD(GLEAB, upload);

LIB_EXPORT C(Method) * METHOD(GLFB, copy);
LIB_EXPORT C(Method) * METHOD(GLFB, copyToTexture);
LIB_EXPORT C(Method) * METHOD(GLFB, free);
LIB_EXPORT C(Method) * METHOD(GLFB, read);
LIB_EXPORT C(Method) * METHOD(GLFB, setup);

LIB_EXPORT C(Method) * METHOD(GLMB, free);
LIB_EXPORT C(Method) * METHOD(GLMB, printStats);

LIB_EXPORT C(Method) * METHOD(GLStats, allocBuffer);
LIB_EXPORT C(Method) * METHOD(GLStats, allocTexture);
LIB_EXPORT C(Method) * METHOD(GLStats, freeBuffers);
LIB_EXPORT C(Method) * METHOD(GLStats, freeTextures);
LIB_EXPORT C(Method) * METHOD(GLStats, print);
LIB_EXPORT C(Method) * METHOD(GLStats, printBuf);
...
LIB_EXPORT C(Method) * METHOD(Shader, setupDrawCommand);
...
LIB_EXPORT C(Method) * METHOD(Camera, setupVR);
...
LIB_EXPORT C(Method) * METHOD(Euler, fromMatrix);
LIB_EXPORT C(Method) * METHOD(Euler, fromQuaternion);
...
LIB_EXPORT C(Method) * METHOD(Matrix, inverseTransposeTransform);
LIB_EXPORT C(Method) * METHOD(Matrix, multiply);
LIB_EXPORT C(Method) * METHOD(Matrix, multiply3x4);
...
LIB_EXPORT C(Method) * METHOD(Matrix, isIdentity);

LIB_EXPORT C(Method) * METHOD(Matrixf, identity);
LIB_EXPORT C(Method) * METHOD(Matrixf, fromMatrix);
...
LIB_EXPORT C(Method) * METHOD(Mesh, applyMorphs);
LIB_EXPORT C(Method) * METHOD(Mesh, applySkin);
LIB_EXPORT C(Method) * METHOD(Mesh, applyTranslucency);
LIB_EXPORT C(Method) * METHOD(Mesh, combineMorphs);
LIB_EXPORT C(Method) * METHOD(Mesh, computeNormals);
LIB_EXPORT C(Method) * METHOD(Mesh, computeNormals2);
LIB_EXPORT C(Method) * METHOD(Mesh, computeNormals3);
LIB_EXPORT C(Method) * METHOD(Mesh, copy);
LIB_EXPORT C(Method) * METHOD(Mesh, findClosestVertex);
LIB_EXPORT C(Method) * METHOD(Mesh, free);
LIB_EXPORT C(Method) * METHOD(Mesh, freeCPUVertexAttributes);
...
LIB_EXPORT C(Method) * METHOD(Mesh, unapplySkin);
LIB_EXPORT C(Method) * METHOD(Mesh, unapplyTranslucency);
...
LIB_EXPORT C(Method) * METHOD(Mesh, upload);
LIB_EXPORT C(Method) * METHOD(Mesh, uploadPrimitive);
LIB_EXPORT C(Method) * METHOD(Mesh, uploadTexture);
LIB_EXPORT C(Method) * METHOD(Mesh, fixMorphSkin);
LIB_EXPORT C(Method) * METHOD(Mesh, fixSkeletonBones);

LIB_EXPORT C(Method) * METHOD(Object, add);
LIB_EXPORT C(Method) * METHOD(Object, addFrameTrack);
LIB_EXPORT C(Method) * METHOD(Object, addName);
LIB_EXPORT C(Method) * METHOD(Object, animate);
LIB_EXPORT C(Method) * METHOD(Object, applyMorphs);
LIB_EXPORT C(Method) * METHOD(Object, applySkins);
LIB_EXPORT C(Method) * METHOD(Object, combineMorphs);
LIB_EXPORT C(Method) * METHOD(Object, delete);
LIB_EXPORT C(Method) * METHOD(Object, doubleSided);
LIB_EXPORT C(Method) * METHOD(Object, duplicate);
LIB_EXPORT C(Method) * METHOD(Object, duplicate2);
...
LIB_EXPORT C(Method) * METHOD(Object, insideFrustum);
LIB_EXPORT C(Method) * METHOD(Object, intersectsGroundPolygon);
LIB_EXPORT C(Method) * METHOD(Object, inverseKinematics);
LIB_EXPORT C(Method) * METHOD(Object, load);
LIB_EXPORT C(Method) * METHOD(Object, loadEx);
LIB_EXPORT C(Method) * METHOD(Object, merge);
LIB_EXPORT C(Method) * METHOD(Object, mergeEx);
LIB_EXPORT C(Method) * METHOD(Object, move);
LIB_EXPORT C(Method) * METHOD(Object, remove);
LIB_EXPORT C(Method) * METHOD(Object, resetPose);
LIB_EXPORT C(Method) * METHOD(Object, rotateEuler);
LIB_EXPORT C(Method) * METHOD(Object, save);
LIB_EXPORT C(Method) * METHOD(Object, saveEx);
LIB_EXPORT C(Method) * METHOD(Object, setMinMaxRadius);
LIB_EXPORT C(Method) * METHOD(Object, updateTransform);
LIB_EXPORT C(Method) * METHOD(Object, upload);
LIB_EXPORT C(Method) * METHOD(Object, listTextures);

LIB_EXPORT C(Method) * METHOD(ObjectFormat, load);
LIB_EXPORT C(Method) * METHOD(ObjectFormat, save);
LIB_EXPORT C(Method) * METHOD(ObjectFormat, listTextures);
...
LIB_EXPORT C(Method) * METHOD(Plane, intersectLinefT);
...
LIB_EXPORT C(Method) * METHOD(Quaternion, rotationEuler);
...
LIB_EXPORT C(Method) * METHOD(Quaternion, rotateQuats);

LIB_EXPORT C(Method) * METHOD(Transform, getMatrix3x4f);
...
LIB_EXPORT C(Method) * METHOD(Vector3Df, multQuaternion);
...
LIB_EXPORT C(Method) * METHOD(Cursor, free);
...
LIB_EXPORT C(Method) * METHOD(Window, setMousePosition);
...
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, canImpactOtherLines);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, figureStartSyntaxStates);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, gotSpace);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, initDraw);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, nextLine);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, parseWord);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, process);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, resetState);
LIB_EXPORT C(Method) * METHOD(EditSyntaxHL, startLine);
...
LIB_EXPORT C(Method) * METHOD(ListBox, multiSort);
...
LIB_EXPORT C(Method) * METHOD(ListBox, sortAlsoBy);
...
LIB_EXPORT C(Method) * METHOD(Stacker, moveControl);
...
LIB_EXPORT C(Method) * METHOD(HTTPFile, openURLEx);
...
LIB_EXPORT void (* FreeSpots_init)(C(FreeSpots) * __this, uint count);
LIB_EXPORT void (* FreeSpots_markFree)(C(FreeSpots) * __this, int spot);
LIB_EXPORT int (* FreeSpots_next)(C(FreeSpots) * __this);
LIB_EXPORT void (* FreeSpots_resize)(C(FreeSpots) * __this, uint count);

LIB_EXPORT void (* GLArrayTexture__init)(C(GLArrayTexture) * __this, int levels, int w, int h, int count, int format, C(bool) setMaxLevel);
LIB_EXPORT int (* GLArrayTexture_allocateLayer)(C(GLArrayTexture) * __this, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_bind)(C(GLArrayTexture) * __this);
LIB_EXPORT void (* GLArrayTexture_copy)(C(GLArrayTexture) * __this, C(GLArrayTexture) * src, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_free)(C(GLArrayTexture) * __this);
LIB_EXPORT void (* GLArrayTexture_freeLayer)(C(GLArrayTexture) * __this, int layer);
LIB_EXPORT void (* GLArrayTexture_init)(C(GLArrayTexture) * __this, int levels, int w, int h, int count);
LIB_EXPORT void (* GLArrayTexture_initMaxLevel)(C(GLArrayTexture) * __this, int levels, int w, int h, int count);
LIB_EXPORT void (* GLArrayTexture_initRGBAUShort)(C(GLArrayTexture) * __this, int levels, int w, int h, int count);
LIB_EXPORT void (* GLArrayTexture_initRGBUShort)(C(GLArrayTexture) * __this, int levels, int w, int h, int count);
LIB_EXPORT void (* GLArrayTexture_initUShort)(C(GLArrayTexture) * __this, int levels, int w, int h, int count);
LIB_EXPORT void (* GLArrayTexture_resize)(C(GLArrayTexture) * __this, uint numLayers, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_set1x1Layer)(C(GLArrayTexture) * __this, int layer, C(ColorAlpha) color, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_setFilter)(C(GLArrayTexture) * __this, C(GLTextureFilter) minFilter, C(GLTextureFilter) magFilter);
LIB_EXPORT void (* GLArrayTexture_setLayer)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_setLayerCompressed)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uintsize sizeBytes, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_setLayerFormat)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uint targetFBO, int format, int type);
LIB_EXPORT void (* GLArrayTexture_setLayerRGBAUShort)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_setLayerRGBUShort)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uint targetFBO);
LIB_EXPORT void (* GLArrayTexture_setLayerUShort)(C(GLArrayTexture) * __this, int level, int x, int y, int layer, byte * c, uint targetFBO);

LIB_EXPORT void (* GLMultiDraw_addDrawCommand)(C(GLMultiDraw) * __this, uint indexCount, uint instanceCount, uint firstIndex, uint baseVertex, uint baseInstance);
LIB_EXPORT void (* GLMultiDraw_addDrawCommandCustomID)(C(GLMultiDraw) * __this, uint indexCount, uint instanceCount, uint firstIndex, uint baseVertex, uint baseInstance, uint layer);
LIB_EXPORT int (* GLMultiDraw_allocateIx)(C(GLMultiDraw) * __this, uint nIndices, uint indexSize, const void * data);
LIB_EXPORT int (* GLMultiDraw_allocateVbo)(C(GLMultiDraw) * __this, uint nVertices, uint vertexSize, const void * data);
LIB_EXPORT void (* GLMultiDraw_draw)(C(GLMultiDraw) * __this);
LIB_EXPORT void (* GLMultiDraw_free)(C(GLMultiDraw) * __this);
LIB_EXPORT void (* GLMultiDraw_freeIx)(C(GLMultiDraw) * __this, int baseIndex, uint indexSize, uint count);
LIB_EXPORT void (* GLMultiDraw_freeVbo)(C(GLMultiDraw) * __this, int baseVertex, uint vertexSize, uint count);
LIB_EXPORT void (* GLMultiDraw_init)(C(GLMultiDraw) * __this, C(GLIMTKMode) mode, uint minAlloc);
LIB_EXPORT void (* GLMultiDraw_prepare)(C(GLMultiDraw) * __this, int vertNCoords, int verticesStride);
LIB_EXPORT void (* GLMultiDraw_printStats)(C(GLMultiDraw) * __this);
LIB_EXPORT void (* GLMultiDraw_resize)(C(GLMultiDraw) * __this, uint size);
LIB_EXPORT void (* GLMultiDraw_resizeCommands)(C(GLMultiDraw) * __this, uint size);
LIB_EXPORT void (* GLMultiDraw_resizeIDs)(C(GLMultiDraw) * __this, uint size);
...
LIB_EXPORT C(bool) (* Bitmap_copy2)(C(Bitmap) __this, C(Bitmap) source, C(bool) moveStuff);
...
LIB_EXPORT C(Bitmap) (* Bitmap_processDD)(C(Bitmap) __this, C(bool) mipMaps, uint cubeMapFace, C(bool) compress, int maxTextureSize, C(bool) makePow2, int enforcedWidth, int enforcedHeight);
...
LIB_EXPORT C(bool) (* CubeMap_loadFromFiles)(C(CubeMap) __this, C(DisplaySystem) displaySystem, C(File) files[], constString extension, C(bool) oldStyle);
...
LIB_EXPORT C(bool) (* Display_drawMeshEx)(C(Display) __this, C(Object) * object, uint64 * id);
LIB_EXPORT C(bool) (* Display_drawObject)(C(Display) __this, C(Object) * object);
LIB_EXPORT C(bool) (* Display_drawObjectEx)(C(Display) __this, C(Object) * object, uint64 * id);
...
LIB_EXPORT void (* Display_setCamera)(C(Display) __this, C(Surface) surface, const C(Camera) camera);
LIB_EXPORT void (* Display_setCameraVR)(C(Display) __this, C(Camera) camera, int eye, int w, int h, C(GLFB) * output, const C(Matrix) * prjMat);
...
LIB_EXPORT void (* DrawList_addObject)(C(DrawList) __this, C(Object) * object);
LIB_EXPORT void (* DrawList_init)(C(DrawList) __this, C(Matrix) * sm, C(Matrix) * vm, C(Vector3D) * cp, C(Plane) * vp, C(Plane) * wp, int guessCount);
LIB_EXPORT void (* DrawList_prepare)(C(DrawList) __this);
LIB_EXPORT void (* DrawList_render)(C(DrawList) __this, C(Display) display);
...
LIB_EXPORT void (* Surface_drawingChar)(C(Surface) __this, byte value);
...
LIB_EXPORT void (* Surface_stretchf)(C(Surface) __this, C(Bitmap) src, float dx, float dy, float sx, float sy, float w, float h, float sw, float sh);
...
LIB_EXPORT void (* DefaultShader_setBoneMatrices)(C(DefaultShader) __this, int n, const C(Matrixf) * matrices);
...
LIB_EXPORT C(DefaultShader) (* DefaultShader_shader)(void);
...
LIB_EXPORT void (* DefaultShader_useExternalTexture)(C(DefaultShader) __this, C(bool) on);

LIB_EXPORT C(BlockEntry) (* FreeBlockMap_allocate)(C(FreeBlockMap) __this, C(GLBType) type, uint size);
LIB_EXPORT void (* FreeBlockMap_freeBlock)(C(FreeBlockMap) __this, C(BlockEntry) block);

LIB_EXPORT void (* GLAB_use)(C(GLAB) * __this, C(GLBufferContents) contents, int n, int type, uint stride, C(GLAttribMode) mode, const void * pointer);
LIB_EXPORT void (* GLAB_useVertTrans)(C(GLAB) * __this, uint count, int n, int type, uint stride, C(GLAttribMode) mode, const void * pointer);

LIB_EXPORT C(bool) (* GLB__allocate)(C(GLB) * __this, C(GLBType) type, uint size, const void * data, C(GLBufferUsage) usage);
LIB_EXPORT void (* GLB__upload)(C(GLB) * __this, C(GLBType) type, uint offset, uint size, const void * data);
LIB_EXPORT C(bool) (* GLB_allocate)(C(GLB) * __this, uint size, const void * data, C(GLBufferUsage) usage);
LIB_EXPORT void (* GLB_copy)(C(GLB) * __this, C(GLB) * src, uint srcStart, uint dstStart, uint size);
LIB_EXPORT void (* GLB_deleteBuffers)(int count, C(GLB) * buffers);
LIB_EXPORT void (* GLB_free)(C(GLB) * __this);
LIB_EXPORT C(bool) (* GLB_resize)(C(GLB) * __this, C(GLBType) type, uint oldSize, uint newSize, C(GLBufferUsage) usage, C(bool) keepSameBufferID);
LIB_EXPORT void (* GLB_upload)(C(GLB) * __this, uint offset, uint size, const void * data);

LIB_EXPORT C(bool) (* GLCAB_allocate)(C(GLCAB) * __this, uint size, const void * data, C(GLBufferUsage) usage);
LIB_EXPORT void (* GLCAB_upload)(C(GLCAB) * __this, uint offset, uint size, const void * data);

LIB_EXPORT C(bool) (* GLEAB_allocate)(C(GLEAB) * __this, uint size, const void * data, C(GLBufferUsage) usage);
LIB_EXPORT void (* GLEAB_draw)(C(GLEAB) * __this, int primType, int count, int type, const void * indices);
LIB_EXPORT void (* GLEAB_draw2)(C(GLEAB) * __this, int primType, int count, int type, const void * indices, uint baseVertex);
LIB_EXPORT void (* GLEAB_upload)(C(GLEAB) * __this, uint offset, uint size, const void * data);

LIB_EXPORT void (* GLFB_copy)(C(GLFB) * __this, const C(GLFB) * src, const C(Box) * srcExtent, const C(Box) * dstExtent, C(ClearType) buffers, C(bool) filter);
LIB_EXPORT void (* GLFB_copyToTexture)(C(GLFB) * __this);
LIB_EXPORT void (* GLFB_free)(C(GLFB) * __this);
LIB_EXPORT void (* GLFB_read)(C(GLFB) * __this, C(Bitmap) bitmap, C(ClearType) buffer, C(bool) sRGB);
LIB_EXPORT C(bool) (* GLFB_setup)(C(GLFB) * __this, C(bool) textureFBO, C(bool) allocTextures, int samples, int colorFormat, int depthFormat, int width, int height);

LIB_EXPORT void (* GLMB_free)(C(GLMB) __this);
LIB_EXPORT void (* GLMB_printStats)(C(GLMB) __this);

LIB_EXPORT void (* GLStats_allocBuffer)(uint buf, uint size);
LIB_EXPORT void (* GLStats_allocTexture)(uint tex, uint w, uint h, C(bool) mipMaps);
LIB_EXPORT void (* GLStats_freeBuffers)(uint count, uint * bufs);
LIB_EXPORT void (* GLStats_freeTextures)(uint count, uint * texs);
LIB_EXPORT void (* GLStats_print)(void);
LIB_EXPORT void (* GLStats_printBuf)(char * output, uint size);
...
LIB_EXPORT void (* Camera_setup)(C(Camera) __this, int width, int height, const C(Point) * origin);
LIB_EXPORT void (* Camera_setupVR)(C(Camera) __this, int width, int height, const C(Matrix) * prjMatrix);
...
LIB_EXPORT void (* Euler_add)(C(Euler) * __this, const C(Euler) * e1, const C(Euler) * e2);
LIB_EXPORT void (* Euler_fromMatrix)(C(Euler) * __this, const C(Matrix) * m, C(EulerRotationOrder) order);
LIB_EXPORT void (* Euler_fromQuaternion)(C(Euler) * __this, const C(Quaternion) * q, C(EulerRotationOrder) order);
...
LIB_EXPORT void (* Matrix_inverse)(C(Matrix) * __this, const C(Matrix) * source);
LIB_EXPORT void (* Matrix_inverseTransposeTransform)(C(Matrix) * __this, const C(Matrix) * source);
LIB_EXPORT void (* Matrix_multiply)(C(Matrix) * __this, const C(Matrix) * a, const C(Matrix) * b);
LIB_EXPORT void (* Matrix_multiply3x4)(C(Matrix) * __this, const C(Matrix) * a, const C(Matrix) * b);
LIB_EXPORT void (* Matrix_rotate)(C(Matrix) * __this, const C(Quaternion) * quat);
LIB_EXPORT void (* Matrix_rotationQuaternion)(C(Matrix) * __this, const C(Quaternion) * quat);
...
LIB_EXPORT void (* Matrix_transpose)(C(Matrix) * __this, const C(Matrix) * source);
LIB_EXPORT C(bool) (* Matrix_isIdentity)(C(Matrix) * __this);

LIB_EXPORT void (* Matrixf_identity)(C(Matrixf) * __this);
LIB_EXPORT void (* Matrixf_fromMatrix)(C(Matrixf) * __this, C(Matrix) * m);
...
LIB_EXPORT void (* Mesh_applyMorphs)(C(Mesh) * __this, C(bool) recomputeNormals);
LIB_EXPORT void (* Mesh_applySkin)(C(Mesh) * __this);
LIB_EXPORT C(bool) (* Mesh_applyTranslucency)(C(Mesh) * __this, C(Object) * object);
LIB_EXPORT void (* Mesh_combineMorphs)(C(Mesh) * __this, C(Array) combined);
LIB_EXPORT void (* Mesh_computeNormals)(C(Mesh) * __this);
LIB_EXPORT void (* Mesh_computeNormals2)(C(Mesh) * __this, C(bool) computeNormals, C(bool) computeTangents);
LIB_EXPORT void (* Mesh_computeNormals3)(C(Mesh) * __this, C(bool) computeNormals, C(bool) computeTangents, C(bool) unlock);
LIB_EXPORT C(Mesh) * (* Mesh_copy)(C(Mesh) * __this);
LIB_EXPORT int (* Mesh_findClosestVertex)(C(Mesh) * __this, const C(Vector3D) * local, C(Vector3Df) * actual);
LIB_EXPORT void (* Mesh_free)(C(Mesh) * __this, C(MeshFeatures) what);
LIB_EXPORT void (* Mesh_freeCPUVertexAttributes)(C(Mesh) * __this, C(MeshFeatures) what);
...
LIB_EXPORT void (* Mesh_unapplySkin)(C(Mesh) * __this);
LIB_EXPORT C(bool) (* Mesh_unapplyTranslucency)(C(Mesh) * __this, C(Object) * object);
...
LIB_EXPORT C(bool) (* Mesh_upload)(C(Mesh) * __this, C(DisplaySystem) displaySystem, C(bool) uploadTextures, C(GLMB) mab, C(GLMB) meab, int nAT, C(GLArrayTexture) * mAT);
LIB_EXPORT void (* Mesh_uploadPrimitive)(C(Mesh) * __this, C(PrimitiveSingle) * g, C(DisplaySystem) displaySystem, C(bool) uploadTextures, int nAT, C(GLArrayTexture) * mAT, C(bool) clearData, C(bool) unlockAndDelete);
LIB_EXPORT void (* Mesh_uploadTexture)(C(Mesh) * __this, C(Bitmap) bitmap, C(DisplaySystem) displaySystem, C(GLArrayTexture) * at);
LIB_EXPORT void (* Mesh_fixMorphSkin)(C(Mesh) * __this);
LIB_EXPORT void (* Mesh_fixSkeletonBones)(C(Mesh) * __this, C(SkinBone) * bone, int boneIx);

LIB_EXPORT void (* Object_add)(C(Object) * __this, C(Object) * object);
LIB_EXPORT void (* Object_addFrameTrack)(C(Object) * __this, C(FrameTrack) * track);
LIB_EXPORT C(bool) (* Object_addName)(C(Object) * __this, C(Object) * object, const char * name);
LIB_EXPORT void (* Object_animate)(C(Object) * __this, int frame);
LIB_EXPORT void (* Object_applyMorphs)(C(Object) * __this, C(bool) recomputeNormals);
LIB_EXPORT void (* Object_applySkins)(C(Object) * __this);
LIB_EXPORT void (* Object_combineMorphs)(C(Object) * __this);
LIB_EXPORT void (* Object_delete)(C(Object) * __this, C(Object) * child, C(DisplaySystem) displaySystem);
...
LIB_EXPORT void (* Object_duplicate2)(C(Object) * __this, C(Object) * model, C(bool) takeOwnership);
LIB_EXPORT C(Object) * (* Object_find)(C(Object) * __this, const char * name);
LIB_EXPORT void (* Object_free)(C(Object) * __this, const C(DisplaySystem) displaySystem);
...
LIB_EXPORT C(FrustumPlacement) (* Object_insideFrustum)(C(Object) * __this, C(Plane) * planes);
LIB_EXPORT C(bool) (* Object_intersectsGroundPolygon)(C(Object) * __this, int count, C(Pointf) * pointfs);
LIB_EXPORT void (* Object_inverseKinematics)(C(Object) * __this, int boneIX, C(Array) limits, int vertex, const C(Vector3D) * target, int maxDepth);
LIB_EXPORT C(bool) (* Object_load)(C(Object) * __this, const char * fileName, const char * type, C(DisplaySystem) displaySystem);
LIB_EXPORT C(bool) (* Object_loadEx)(C(Object) * __this, const char * fileName, const char * type, C(DisplaySystem) displaySystem, void * options);
LIB_EXPORT C(bool) (* Object_merge)(C(Object) * __this, C(DisplaySystem) displaySystem);
LIB_EXPORT C(bool) (* Object_mergeEx)(C(Object) * __this, C(DisplaySystem) displaySystem, C(MeshFeatures) deleteCPUAttrOptions);
LIB_EXPORT void (* Object_move)(C(Object) * __this, C(Vector3D) * direction);
LIB_EXPORT void (* Object_remove)(C(Object) * __this, C(Object) * child);
LIB_EXPORT void (* Object_resetPose)(C(Object) * __this);
LIB_EXPORT void (* Object_rotateEuler)(C(Object) * __this, C(Euler) * rotation, C(Euler) * min, C(Euler) * max);
LIB_EXPORT C(bool) (* Object_save)(C(Object) * __this, const char * fileName, const char * type);
LIB_EXPORT C(bool) (* Object_saveEx)(C(Object) * __this, const char * fileName, const char * type, void * options);
...
LIB_EXPORT void (* Object_upload)(C(Object) * __this, C(DisplaySystem) displaySystem, C(GLMB) mab, C(GLMB) meab, int nAT, C(GLArrayTexture) * mAT);
LIB_EXPORT C(Array) (* Object_listTextures)(C(File) file, const char * fileName, const char * type, void * options);


LIB_EXPORT void (* Plane_fromPointNormal)(C(Plane) * __this, const C(Vector3D) * normal, const C(Vector3D) * point);
LIB_EXPORT void (* Plane_fromPoints)(C(Plane) * __this, const C(Vector3D) * v1, const C(Vector3D) * v2, const C(Vector3D) * v3);
LIB_EXPORT void (* Plane_fromPointsf)(C(Plane) * __this, const C(Vector3Df) * v1, const C(Vector3Df) * v2, const C(Vector3Df) * v3);
LIB_EXPORT void (* Plane_intersectLine)(C(Plane) * __this, const C(Line) * line, C(Vector3D) * result);
LIB_EXPORT void (* Plane_intersectLinef)(C(Plane) * __this, const C(Line) * line, C(Vector3Df) * result);
LIB_EXPORT int (* Plane_intersectLinefT)(C(Plane) * __this, const C(Line) * line, C(Vector3Df) * result, double * rt);
LIB_EXPORT void (* Plane_multMatrix)(C(Plane) * __this, const C(Plane) * source, const C(Matrix) * inverseTranspose);

LIB_EXPORT void (* Quaternion_divide)(C(Quaternion) * __this, const C(Quaternion) * q1, const C(Quaternion) * q2);
LIB_EXPORT void (* Quaternion_identity)(C(Quaternion) * __this);
LIB_EXPORT void (* Quaternion_inverse)(C(Quaternion) * __this, const C(Quaternion) * source);
LIB_EXPORT void (* Quaternion_multiply)(C(Quaternion) * __this, const C(Quaternion) * q1, const C(Quaternion) * q2);
LIB_EXPORT void (* Quaternion_normalize)(C(Quaternion) * __this, const C(Quaternion) * source);
...
LIB_EXPORT void (* Quaternion_rotationAxis)(C(Quaternion) * __this, const C(Vector3D) * axis, C(Angle) angle);
LIB_EXPORT void (* Quaternion_rotationDirection)(C(Quaternion) * __this, const C(Vector3D) * direction);
LIB_EXPORT void (* Quaternion_rotationEuler)(C(Quaternion) * __this, const C(Euler) * euler, C(EulerRotationOrder) rotationOrder);
LIB_EXPORT void (* Quaternion_rotationMatrix)(C(Quaternion) * __this, const C(Matrix) * m);
LIB_EXPORT void (* Quaternion_rotationYawPitchRoll)(C(Quaternion) * __this, const C(Euler) * euler);
LIB_EXPORT void (* Quaternion_slerp)(C(Quaternion) * __this, const C(Quaternion) * from, const C(Quaternion) * to, float t);
...
LIB_EXPORT void (* Quaternion_rotateQuats)(C(Quaternion) * __this, const C(Quaternion) * qPitch, const C(Quaternion) * qYaw, const C(Quaternion) * qRoll, C(EulerRotationOrder) rotationOrder);

LIB_EXPORT void (* Transform_getMatrix3x4f)(C(Transform) * __this, float m[]);

LIB_EXPORT void (* Vector3D_add)(C(Vector3D) * __this, const C(Vector3D) * vector1, const C(Vector3D) * vector2);
LIB_EXPORT void (* Vector3D_crossProduct)(C(Vector3D) * __this, const C(Vector3D) * vector1, const C(Vector3D) * vector2);
LIB_EXPORT void (* Vector3D_divideMatrix)(C(Vector3D) * __this, const C(Vector3D) * v, const C(Matrix) * m);
LIB_EXPORT double (* Vector3D_dotProduct)(C(Vector3D) * __this, const C(Vector3D) * vector2);
LIB_EXPORT double (* Vector3D_dotProductf)(C(Vector3D) * __this, const C(Vector3Df) * vector2);
LIB_EXPORT void (* Vector3D_multMatrix)(C(Vector3D) * __this, const C(Vector3D) * source, const C(Matrix) * matrix);
LIB_EXPORT void (* Vector3D_multMatrixf)(C(Vector3D) * __this, const C(Vector3Df) * source, const C(Matrix) * matrix);
...
LIB_EXPORT void (* Vector3D_scale)(C(Vector3D) * __this, const C(Vector3D) * vector1, double s);
LIB_EXPORT void (* Vector3D_subtract)(C(Vector3D) * __this, const C(Vector3D) * vector1, const C(Vector3D) * vector2);

LIB_EXPORT void (* Vector3Df_add)(C(Vector3Df) * __this, const C(Vector3Df) * vector1, const C(Vector3Df) * vector2);
LIB_EXPORT void (* Vector3Df_crossProduct)(C(Vector3Df) * __this, const C(Vector3Df) * vector1, const C(Vector3Df) * vector2);
LIB_EXPORT void (* Vector3Df_divideMatrix)(C(Vector3Df) * __this, const C(Vector3Df) * source, const C(Matrix) * matrix);
LIB_EXPORT double (* Vector3Df_dotProduct)(C(Vector3Df) * __this, const C(Vector3Df) * vector2);
LIB_EXPORT void (* Vector3Df_multMatrix)(C(Vector3Df) * __this, const C(Vector3Df) * source, const C(Matrix) * matrix);
LIB_EXPORT void (* Vector3Df_multQuaternion)(C(Vector3Df) * __this, const C(Vector3Df) * source, const C(Quaternion) * quat);
LIB_EXPORT void (* Vector3Df_normalize)(C(Vector3Df) * __this, const C(Vector3Df) * source);
LIB_EXPORT void (* Vector3Df_scale)(C(Vector3Df) * __this, const C(Vector3Df) * vector1, float s);
LIB_EXPORT void (* Vector3Df_subtract)(C(Vector3Df) * __this, const C(Vector3Df) * vector1, const C(Vector3Df) * vector2);

LIB_EXPORT C(bool) (* Cube_create)(C(Cube) * __this, const C(DisplaySystem) displaySystem);
...
LIB_EXPORT void (* Cursor_free)(C(Cursor) __this);
LIB_EXPORT C(bool) (* Cursor_load)(C(Cursor) __this, const char * name, int hotSpotX, int hotSpotY, byte * paletteShades, C(DisplaySystem) ds);
...
LIB_EXPORT void (* Window_freeMouseRange)(void);
...
LIB_EXPORT void (* Window_restoreCaret)(void);
...
LIB_EXPORT void (* Window_setMousePosition)(C(Window) __this, int x, int y);
...
LIB_EXPORT void (* Window_update)(C(Window) __this, const C(Box) * region);
...
LIB_EXPORT void (* ListBox_multiSort)(C(ListBox) __this, C(Array) fields);
...
LIB_EXPORT void (* ListBox_sortAlsoBy)(C(ListBox) __this, C(DataField) field, int order);
...
LIB_EXPORT C(MenuItem) (* Menu_findItem)(C(Menu) __this, C(bool) (* notifySelect)(C(Window) __this, C(MenuItem) selection, C(Modifiers) mods), uint64 id);
...
LIB_EXPORT void (* Stacker_moveControl)(C(Stacker) __this, C(IteratorPointer) * ctrl, C(IteratorPointer) * after, C(bool) fixCycle);
...
LIB_EXPORT C(bool) (* DCOMClientObject_callMethod)(C(DCOMClientObject) __this, uint methodID, C(bool) hasReturnValue);
...
LIB_EXPORT C(bool) (* HTTPFile_openURLEx)(C(HTTPFile) __this, const char * name, const char * referer, char * relocation, const char * acceptHeader);
...
LIB_EXPORT C(Property) * PROPERTY(GLMultiDraw, ix32);
LIB_EXPORT void (* GLMultiDraw_set_ix32)(const C(GLMultiDraw) * g, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, fileName);
LIB_EXPORT void (* BitmapResource_set_fileName)(const C(BitmapResource) b, const char * value);
LIB_EXPORT const char * (* BitmapResource_get_fileName)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, grayed);
LIB_EXPORT void (* BitmapResource_set_grayed)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_grayed)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, monochrome);
LIB_EXPORT void (* BitmapResource_set_monochrome)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_monochrome)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, transparent);
LIB_EXPORT void (* BitmapResource_set_transparent)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_transparent)(const C(BitmapResource) b);
LIB_EXPORT C(bool) (* BitmapResource_isSet_transparent)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, alphaBlend);
LIB_EXPORT void (* BitmapResource_set_alphaBlend)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_alphaBlend)(const C(BitmapResource) b);
LIB_EXPORT C(bool) (* BitmapResource_isSet_alphaBlend)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, mipMaps);
LIB_EXPORT void (* BitmapResource_set_mipMaps)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_mipMaps)(const C(BitmapResource) b);
LIB_EXPORT C(bool) (* BitmapResource_isSet_mipMaps)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, keepData);
LIB_EXPORT void (* BitmapResource_set_keepData)(const C(BitmapResource) b, C(bool) value);
LIB_EXPORT C(bool) (* BitmapResource_get_keepData)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, bitmap);
LIB_EXPORT void (* BitmapResource_set_bitmap)(const C(BitmapResource) b, C(Bitmap) value);
LIB_EXPORT C(Bitmap) (* BitmapResource_get_bitmap)(const C(BitmapResource) b);

LIB_EXPORT C(Property) * PROPERTY(BitmapResource, window);
LIB_EXPORT void (* BitmapResource_set_window)(const C(BitmapResource) b, C(Window) value);

LIB_EXPORT C(Property) * PROPERTY(Color, ColorRGB);
LIB_EXPORT C(Color) (* Color_from_ColorRGB)(const C(ColorRGB) * colorRGB);
LIB_EXPORT void (* Color_to_ColorRGB)(const C(Color) color, C(ColorRGB) * value);

LIB_EXPORT C(Property) * PROPERTY(Color444, Color);
LIB_EXPORT C(Color444) (* Color444_from_Color)(const C(Color) color);
LIB_EXPORT C(Color) (* Color444_to_Color)(const C(Color444) color444);

LIB_EXPORT C(Property) * PROPERTY(Color555, Color);
LIB_EXPORT C(Color555) (* Color555_from_Color)(const C(Color) color);
LIB_EXPORT C(Color) (* Color555_to_Color)(const C(Color555) color555);

LIB_EXPORT C(Property) * PROPERTY(Color565, Color);
LIB_EXPORT C(Color565) (* Color565_from_Color)(const C(Color) color);
LIB_EXPORT C(Color) (* Color565_to_Color)(const C(Color565) color565);

LIB_EXPORT C(Property) * PROPERTY(ColorAlpha, Color);
LIB_EXPORT C(ColorAlpha) (* ColorAlpha_from_Color)(const C(Color) color);
LIB_EXPORT C(Color) (* ColorAlpha_to_Color)(const C(ColorAlpha) colorAlpha);

LIB_EXPORT C(Property) * PROPERTY(ColorCMYK, ColorRGB);
LIB_EXPORT void (* ColorCMYK_from_ColorRGB)(const C(ColorCMYK) * c, const C(ColorRGB) * value);
LIB_EXPORT void (* ColorCMYK_to_ColorRGB)(const C(ColorCMYK) * c, C(ColorRGB) * value);

LIB_EXPORT C(Property) * PROPERTY(ColorHSV, ColorRGB);
LIB_EXPORT void (* ColorHSV_from_ColorRGB)(const C(ColorHSV) * c, const C(ColorRGB) * value);
LIB_EXPORT void (* ColorHSV_to_ColorRGB)(const C(ColorHSV) * c, C(ColorRGB) * value);

LIB_EXPORT C(Property) * PROPERTY(ColorLab, ColorRGB);
LIB_EXPORT void (* ColorLab_from_ColorRGB)(const C(ColorLab) * c, const C(ColorRGB) * value);
LIB_EXPORT void (* ColorLab_to_ColorRGB)(const C(ColorLab) * c, C(ColorRGB) * value);

LIB_EXPORT C(Property) * PROPERTY(ColorRGBA, ColorAlpha);
LIB_EXPORT C(ColorRGBA) (* ColorRGBA_from_ColorAlpha)(const C(ColorAlpha) colorAlpha);
LIB_EXPORT C(ColorAlpha) (* ColorRGBA_to_ColorAlpha)(const C(ColorRGBA) colorRGBA);

LIB_EXPORT C(Property) * PROPERTY(ColorRGBA, Color);
LIB_EXPORT C(ColorRGBA) (* ColorRGBA_from_Color)(const C(Color) color);
LIB_EXPORT C(Color) (* ColorRGBA_to_Color)(const C(ColorRGBA) colorRGBA);

LIB_EXPORT C(Property) * PROPERTY(ColorRGBAf, ColorAlpha);
LIB_EXPORT void (* ColorRGBAf_from_ColorAlpha)(const C(ColorRGBAf) * c, C(ColorAlpha) value);
LIB_EXPORT C(ColorAlpha) (* ColorRGBAf_to_ColorAlpha)(const C(ColorRGBAf) * c);

LIB_EXPORT C(Property) * PROPERTY(ColorRGBAf, Color);
LIB_EXPORT void (* ColorRGBAf_from_Color)(const C(ColorRGBAf) * c, C(Color) value);
LIB_EXPORT C(Color) (* ColorRGBAf_to_Color)(const C(ColorRGBAf) * c);

LIB_EXPORT C(Property) * PROPERTY(Display, fillMode);
LIB_EXPORT void (* Display_set_fillMode)(const C(Display) d, C(FillModeValue) value);

LIB_EXPORT C(Property) * PROPERTY(Display, depthTest);
LIB_EXPORT void (* Display_set_depthTest)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, depthWrite);
LIB_EXPORT void (* Display_set_depthWrite)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, fogDensity);
LIB_EXPORT void (* Display_set_fogDensity)(const C(Display) d, float value);

LIB_EXPORT C(Property) * PROPERTY(Display, fogColor);
LIB_EXPORT void (* Display_set_fogColor)(const C(Display) d, C(Color) value);

LIB_EXPORT C(Property) * PROPERTY(Display, blend);
LIB_EXPORT void (* Display_set_blend)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, ambient);
LIB_EXPORT void (* Display_set_ambient)(const C(Display) d, C(Color) value);

LIB_EXPORT C(Property) * PROPERTY(Display, alphaWrite);
LIB_EXPORT void (* Display_set_alphaWrite)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, antiAlias);
LIB_EXPORT void (* Display_set_antiAlias)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, vSync);
LIB_EXPORT void (* Display_set_vSync)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, pickingPlanes);
LIB_EXPORT void (* Display_set_pickingPlanes)(const C(Display) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Display, maxFullSort);
LIB_EXPORT void (* Display_set_maxFullSort)(const C(Display) d, int value);
LIB_EXPORT int (* Display_get_maxFullSort)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, fullProjCheck);
LIB_EXPORT void (* Display_set_fullProjCheck)(const C(Display) d, C(bool) value);
LIB_EXPORT C(bool) (* Display_get_fullProjCheck)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, flags);
LIB_EXPORT C(DisplayFlags) (* Display_get_flags)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, pixelFormat);
LIB_EXPORT C(PixelFormat) (* Display_get_pixelFormat)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, alphaBlend);
LIB_EXPORT void (* Display_set_alphaBlend)(const C(Display) d, C(bool) value);
LIB_EXPORT C(bool) (* Display_get_alphaBlend)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, useSharedMemory);
LIB_EXPORT void (* Display_set_useSharedMemory)(const C(Display) d, C(bool) value);
LIB_EXPORT C(bool) (* Display_get_useSharedMemory)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, systemWindow);
LIB_EXPORT void * (* Display_get_systemWindow)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, displaySystem);
LIB_EXPORT C(DisplaySystem) (* Display_get_displaySystem)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, glCapabilities);
LIB_EXPORT void (* Display_set_glCapabilities)(const C(Display) d, C(GLCapabilities) value);
LIB_EXPORT C(GLCapabilities) (* Display_get_glCapabilities)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(Display, glVersion);
LIB_EXPORT int (* Display_get_glVersion)(const C(Display) d);

LIB_EXPORT C(Property) * PROPERTY(DrawManager, renderingFlipped);
LIB_EXPORT void (* DrawManager_set_renderingFlipped)(const C(DrawManager) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Font, ascent);
LIB_EXPORT int (* Font_get_ascent)(const C(Font) * f);

LIB_EXPORT C(Property) * PROPERTY(Font, descent);
LIB_EXPORT int (* Font_get_descent)(const C(Font) * f);

LIB_EXPORT C(Property) * PROPERTY(FontManager, renderer);
LIB_EXPORT void (* FontManager_set_renderer)(const C(FontManager) f, C(FontManagerRenderer) value);
LIB_EXPORT C(FontManagerRenderer) (* FontManager_get_renderer)(const C(FontManager) f);

LIB_EXPORT C(Property) * PROPERTY(FontRenderer, drawManager);
LIB_EXPORT void (* FontRenderer_set_drawManager)(const C(FontRenderer) f, C(DrawManager) value);

LIB_EXPORT C(Property) * PROPERTY(FontResource, faceName);
LIB_EXPORT void (* FontResource_set_faceName)(const C(FontResource) f, const char * value);
LIB_EXPORT const char * (* FontResource_get_faceName)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, size);
LIB_EXPORT void (* FontResource_set_size)(const C(FontResource) f, float value);
LIB_EXPORT float (* FontResource_get_size)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, bold);
LIB_EXPORT void (* FontResource_set_bold)(const C(FontResource) f, C(bool) value);
LIB_EXPORT C(bool) (* FontResource_get_bold)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, italic);
LIB_EXPORT void (* FontResource_set_italic)(const C(FontResource) f, C(bool) value);
LIB_EXPORT C(bool) (* FontResource_get_italic)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, underline);
LIB_EXPORT void (* FontResource_set_underline)(const C(FontResource) f, C(bool) value);
LIB_EXPORT C(bool) (* FontResource_get_underline)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, font);
LIB_EXPORT C(Font) * (* FontResource_get_font)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, window);
LIB_EXPORT void (* FontResource_set_window)(const C(FontResource) f, C(Window) value);

LIB_EXPORT C(Property) * PROPERTY(FontResource, outlineSize);
LIB_EXPORT void (* FontResource_set_outlineSize)(const C(FontResource) f, float value);
LIB_EXPORT float (* FontResource_get_outlineSize)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, outlineFade);
LIB_EXPORT void (* FontResource_set_outlineFade)(const C(FontResource) f, float value);
LIB_EXPORT float (* FontResource_get_outlineFade)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(FontResource, fmFont);
LIB_EXPORT C(FMFont) * (* FontResource_get_fmFont)(const C(FontResource) f);

LIB_EXPORT C(Property) * PROPERTY(Surface, alphaWrite);
LIB_EXPORT void (* Surface_set_alphaWrite)(const C(Surface) s, C(AlphaWriteMode) value);
LIB_EXPORT C(AlphaWriteMode) (* Surface_get_alphaWrite)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, blend);
LIB_EXPORT void (* Surface_set_blend)(const C(Surface) s, C(bool) value);
LIB_EXPORT C(bool) (* Surface_get_blend)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, bitmap);
LIB_EXPORT C(Bitmap) (* Surface_get_bitmap)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, outlineColor);
LIB_EXPORT void (* Surface_set_outlineColor)(const C(Surface) s, C(ColorAlpha) value);
LIB_EXPORT C(ColorAlpha) (* Surface_get_outlineColor)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, foreground);
LIB_EXPORT void (* Surface_set_foreground)(const C(Surface) s, C(ColorAlpha) value);
LIB_EXPORT C(ColorAlpha) (* Surface_get_foreground)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, background);
LIB_EXPORT void (* Surface_set_background)(const C(Surface) s, C(ColorAlpha) value);
LIB_EXPORT C(ColorAlpha) (* Surface_get_background)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, blitTint);
LIB_EXPORT void (* Surface_set_blitTint)(const C(Surface) s, C(ColorAlpha) value);
LIB_EXPORT C(ColorAlpha) (* Surface_get_blitTint)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, blackTint);
LIB_EXPORT void (* Surface_set_blackTint)(const C(Surface) s, C(Color) value);
LIB_EXPORT C(Color) (* Surface_get_blackTint)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, lineStipple);
LIB_EXPORT void (* Surface_set_lineStipple)(const C(Surface) s, uint value);

LIB_EXPORT C(Property) * PROPERTY(Surface, size);
LIB_EXPORT void (* Surface_get_size)(const C(Surface) s, C(Size) * value);

LIB_EXPORT C(Property) * PROPERTY(Surface, display);
LIB_EXPORT C(Display) (* Surface_get_display)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, font);
LIB_EXPORT void (* Surface_set_font)(const C(Surface) s, C(Font) * value);
LIB_EXPORT C(Font) * (* Surface_get_font)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, textOpacity);
LIB_EXPORT void (* Surface_set_textOpacity)(const C(Surface) s, C(bool) value);
LIB_EXPORT C(bool) (* Surface_get_textOpacity)(const C(Surface) s);

LIB_EXPORT C(Property) * PROPERTY(Surface, drawingChar);
LIB_EXPORT void (* Surface_set_drawingChar)(const C(Surface) s, byte value);

LIB_EXPORT C(Property) * PROPERTY(Surface, clipping);
LIB_EXPORT void (* Surface_set_clipping)(const C(Surface) s, const C(Box) * value);

LIB_EXPORT C(Property) * PROPERTY(DefaultShader, blackTint);
LIB_EXPORT void (* DefaultShader_set_blackTint)(const C(DefaultShader) d, C(Color) value);

LIB_EXPORT C(Property) * PROPERTY(Shader, vertexShaderFile);
LIB_EXPORT void (* Shader_set_vertexShaderFile)(const C(Shader) s, constString value);

LIB_EXPORT C(Property) * PROPERTY(Shader, fragmentShaderFile);
LIB_EXPORT void (* Shader_set_fragmentShaderFile)(const C(Shader) s, constString value);

LIB_EXPORT C(Property) * PROPERTY(Shader, vertexShader);
LIB_EXPORT void (* Shader_set_vertexShader)(const C(Shader) s, constString value);

LIB_EXPORT C(Property) * PROPERTY(Shader, fragmentShader);
LIB_EXPORT void (* Shader_set_fragmentShader)(const C(Shader) s, constString value);

LIB_EXPORT C(Property) * PROPERTY(Shader, activeCompiledShader);
LIB_EXPORT C(CompiledShader) * (* Shader_get_activeCompiledShader)(const C(Shader) s);

LIB_EXPORT C(Property) * PROPERTY(Camera, type);
LIB_EXPORT void (* Camera_set_type)(const C(Camera) c, C(CameraType) value);
LIB_EXPORT C(CameraType) (* Camera_get_type)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, position);
LIB_EXPORT void (* Camera_set_position)(const C(Camera) c, const C(Vector3D) * value);
LIB_EXPORT void (* Camera_get_position)(const C(Camera) c, C(Vector3D) * value);

LIB_EXPORT C(Property) * PROPERTY(Camera, orientation);
LIB_EXPORT void (* Camera_set_orientation)(const C(Camera) c, const C(Quaternion) * value);
LIB_EXPORT void (* Camera_get_orientation)(const C(Camera) c, C(Quaternion) * value);

LIB_EXPORT C(Property) * PROPERTY(Camera, eulerOrientation);
LIB_EXPORT void (* Camera_set_eulerOrientation)(const C(Camera) c, const C(Euler) * value);
LIB_EXPORT void (* Camera_get_eulerOrientation)(const C(Camera) c, C(Euler) * value);

LIB_EXPORT C(Property) * PROPERTY(Camera, cPosition);
LIB_EXPORT void (* Camera_get_cPosition)(const C(Camera) c, C(Vector3D) * value);

LIB_EXPORT C(Property) * PROPERTY(Camera, cOrientation);
LIB_EXPORT void (* Camera_get_cOrientation)(const C(Camera) c, C(Quaternion) * value);

LIB_EXPORT C(Property) * PROPERTY(Camera, fov);
LIB_EXPORT void (* Camera_set_fov)(const C(Camera) c, C(Angle) value);
LIB_EXPORT C(Angle) (* Camera_get_fov)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, zMin);
LIB_EXPORT void (* Camera_set_zMin)(const C(Camera) c, float value);
LIB_EXPORT float (* Camera_get_zMin)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, zMax);
LIB_EXPORT void (* Camera_set_zMax)(const C(Camera) c, float value);
LIB_EXPORT float (* Camera_get_zMax)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, target);
LIB_EXPORT void (* Camera_set_target)(const C(Camera) c, C(Object) * value);
LIB_EXPORT C(Object) * (* Camera_get_target)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, fovDirection);
LIB_EXPORT void (* Camera_set_fovDirection)(const C(Camera) c, C(FovDirection) value);
LIB_EXPORT C(FovDirection) (* Camera_get_fovDirection)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, aspectRatio);
LIB_EXPORT void (* Camera_set_aspectRatio)(const C(Camera) c, float value);
LIB_EXPORT float (* Camera_get_aspectRatio)(const C(Camera) c);

LIB_EXPORT C(Property) * PROPERTY(Camera, focal);
LIB_EXPORT void (* Camera_set_focal)(const C(Camera) c, const C(Size) * value);
LIB_EXPORT void (* Camera_get_focal)(const C(Camera) c, C(Size) * value);

LIB_EXPORT C(Property) * PROPERTY(Euler, Quaternion);
LIB_EXPORT void (* Euler_from_Quaternion)(const C(Euler) * e, const C(Quaternion) * value);
LIB_EXPORT void (* Euler_to_Quaternion)(const C(Euler) * e, C(Quaternion) * value);

LIB_EXPORT C(Property) * PROPERTY(Material, shader);
LIB_EXPORT void (* Material_set_shader)(const C(Material) * m, C(Shader) value);
LIB_EXPORT C(Shader) (* Material_get_shader)(const C(Material) * m);

LIB_EXPORT C(Property) * PROPERTY(Matrix, Quaternion);
LIB_EXPORT void (* Matrix_from_Quaternion)(const C(Matrix) * m, const C(Quaternion) * value);
LIB_EXPORT void (* Matrix_to_Quaternion)(const C(Matrix) * m, C(Quaternion) * value);

LIB_EXPORT C(Property) * PROPERTY(Matrixf, Matrix);
LIB_EXPORT void (* Matrixf_from_Matrix)(const C(Matrixf) * m, const C(Matrix) * value);
LIB_EXPORT void (* Matrixf_to_Matrix)(const C(Matrixf) * m, C(Matrix) * value);

LIB_EXPORT C(Property) * PROPERTY(Mesh, texCoords);
LIB_EXPORT void (* Mesh_set_texCoords)(const C(Mesh) * m, C(Pointf) * value);
LIB_EXPORT C(Pointf) * (* Mesh_get_texCoords)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, nVertices);
LIB_EXPORT void (* Mesh_set_nVertices)(const C(Mesh) * m, int value);
LIB_EXPORT int (* Mesh_get_nVertices)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, vertices);
LIB_EXPORT void (* Mesh_set_vertices)(const C(Mesh) * m, C(Vector3Df) * value);
LIB_EXPORT C(Vector3Df) * (* Mesh_get_vertices)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, nIndices);
LIB_EXPORT void (* Mesh_set_nIndices)(const C(Mesh) * m, int value);
LIB_EXPORT int (* Mesh_get_nIndices)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, meab);
LIB_EXPORT void (* Mesh_set_meab)(const C(Mesh) * m, C(GLMB) value);
LIB_EXPORT C(GLMB) (* Mesh_get_meab)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, baseIndex);
LIB_EXPORT void (* Mesh_set_baseIndex)(const C(Mesh) * m, int value);
LIB_EXPORT int (* Mesh_get_baseIndex)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, baseVertex);
LIB_EXPORT void (* Mesh_set_baseVertex)(const C(Mesh) * m, int value);
LIB_EXPORT int (* Mesh_get_baseVertex)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, indices);
LIB_EXPORT void (* Mesh_set_indices)(const C(Mesh) * m, uint * value);
LIB_EXPORT uint * (* Mesh_get_indices)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, normals);
LIB_EXPORT void (* Mesh_set_normals)(const C(Mesh) * m, C(Vector3Df) * value);
LIB_EXPORT C(Vector3Df) * (* Mesh_get_normals)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, tangents);
LIB_EXPORT void (* Mesh_set_tangents)(const C(Mesh) * m, C(Vector3Df) * value);
LIB_EXPORT C(Vector3Df) * (* Mesh_get_tangents)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, colors);
LIB_EXPORT void (* Mesh_set_colors)(const C(Mesh) * m, C(ColorRGBAf) * value);
LIB_EXPORT C(ColorRGBAf) * (* Mesh_get_colors)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, lightVectors);
LIB_EXPORT void (* Mesh_set_lightVectors)(const C(Mesh) * m, C(ColorRGB) * value);
LIB_EXPORT C(ColorRGB) * (* Mesh_get_lightVectors)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, groups);
LIB_EXPORT void (* Mesh_get_groups)(const C(Mesh) * m, C(OldList) * value);

LIB_EXPORT C(Property) * PROPERTY(Mesh, flags);
LIB_EXPORT void (* Mesh_set_flags)(const C(Mesh) * m, C(MeshFeatures) value);
LIB_EXPORT C(MeshFeatures) (* Mesh_get_flags)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, skin);
LIB_EXPORT void (* Mesh_set_skin)(const C(Mesh) * m, C(MeshSkin) value);
LIB_EXPORT C(MeshSkin) (* Mesh_get_skin)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, dupVerts);
LIB_EXPORT void (* Mesh_set_dupVerts)(const C(Mesh) * m, C(Array) value);
LIB_EXPORT C(Array) (* Mesh_get_dupVerts)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, morphs);
LIB_EXPORT void (* Mesh_set_morphs)(const C(Mesh) * m, C(Array) value);
LIB_EXPORT C(Array) (* Mesh_get_morphs)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, unmorphedMesh);
LIB_EXPORT void (* Mesh_set_unmorphedMesh)(const C(Mesh) * m, C(Mesh) * value);
LIB_EXPORT C(Mesh) * (* Mesh_get_unmorphedMesh)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, translucentPrimitives);
LIB_EXPORT C(PrimitiveSingle) * (* Mesh_get_translucentPrimitives)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, nTranslucentPrimitives);
LIB_EXPORT int (* Mesh_get_nTranslucentPrimitives)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Mesh, parts);
LIB_EXPORT void (* Mesh_set_parts)(const C(Mesh) * m, C(Array) value);
LIB_EXPORT C(Array) (* Mesh_get_parts)(const C(Mesh) * m);

LIB_EXPORT C(Property) * PROPERTY(Object, transform);
LIB_EXPORT void (* Object_set_transform)(const C(Object) * o, const C(Transform) * value);
LIB_EXPORT void (* Object_get_transform)(const C(Object) * o, C(Transform) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, eulerOrientation);
LIB_EXPORT void (* Object_set_eulerOrientation)(const C(Object) * o, const C(Euler) * value);
LIB_EXPORT void (* Object_get_eulerOrientation)(const C(Object) * o, C(Euler) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, material);
LIB_EXPORT void (* Object_set_material)(const C(Object) * o, C(Material) * value);
LIB_EXPORT C(Material) * (* Object_get_material)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, max);
LIB_EXPORT void (* Object_get_max)(const C(Object) * o, C(Vector3Df) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, min);
LIB_EXPORT void (* Object_get_min)(const C(Object) * o, C(Vector3Df) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, center);
LIB_EXPORT void (* Object_get_center)(const C(Object) * o, C(Vector3Df) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, radius);
LIB_EXPORT float (* Object_get_radius)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, wmax);
LIB_EXPORT void (* Object_get_wmax)(const C(Object) * o, C(Vector3D) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, wmin);
LIB_EXPORT void (* Object_get_wmin)(const C(Object) * o, C(Vector3D) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, wcenter);
LIB_EXPORT void (* Object_get_wcenter)(const C(Object) * o, C(Vector3D) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, wradius);
LIB_EXPORT double (* Object_get_wradius)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, tag);
LIB_EXPORT void (* Object_set_tag)(const C(Object) * o, void * value);
LIB_EXPORT void * (* Object_get_tag)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, frame);
LIB_EXPORT void (* Object_set_frame)(const C(Object) * o, int value);
LIB_EXPORT int (* Object_get_frame)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, startFrame);
LIB_EXPORT void (* Object_set_startFrame)(const C(Object) * o, int value);
LIB_EXPORT int (* Object_get_startFrame)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, endFrame);
LIB_EXPORT void (* Object_set_endFrame)(const C(Object) * o, int value);
LIB_EXPORT int (* Object_get_endFrame)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, mesh);
LIB_EXPORT void (* Object_set_mesh)(const C(Object) * o, C(Mesh) * value);
LIB_EXPORT C(Mesh) * (* Object_get_mesh)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, camera);
LIB_EXPORT C(Camera) (* Object_get_camera)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, firstChild);
LIB_EXPORT C(Object) * (* Object_get_firstChild)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, next);
LIB_EXPORT C(Object) * (* Object_get_next)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, name);
LIB_EXPORT void (* Object_set_name)(const C(Object) * o, const char * value);
LIB_EXPORT const char * (* Object_get_name)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, matrix);
LIB_EXPORT void (* Object_get_matrix)(const C(Object) * o, C(Matrix) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, cameraTarget);
LIB_EXPORT void (* Object_set_cameraTarget)(const C(Object) * o, C(Object) * value);
LIB_EXPORT C(Object) * (* Object_get_cameraTarget)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, tracks);
LIB_EXPORT C(OldList) * (* Object_get_tracks)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, flags);
LIB_EXPORT void (* Object_set_flags)(const C(Object) * o, C(ObjectFlags) value);
LIB_EXPORT C(ObjectFlags) (* Object_get_flags)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, parent);
LIB_EXPORT C(Object) * (* Object_get_parent)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, numChildren);
LIB_EXPORT uint (* Object_get_numChildren)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, localMatrixPtr);
LIB_EXPORT C(Matrix) * (* Object_get_localMatrixPtr)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, matrixPtr);
LIB_EXPORT C(Matrix) * (* Object_get_matrixPtr)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, light);
LIB_EXPORT void (* Object_set_light)(const C(Object) * o, const C(Light) * value);
LIB_EXPORT void (* Object_get_light)(const C(Object) * o, C(Light) * value);

LIB_EXPORT C(Property) * PROPERTY(Object, rotationOrder);
LIB_EXPORT void (* Object_set_rotationOrder)(const C(Object) * o, C(EulerRotationOrder) value);
LIB_EXPORT C(EulerRotationOrder) (* Object_get_rotationOrder)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Object, displaySystem);
LIB_EXPORT void (* Object_set_displaySystem)(const C(Object) * o, C(DisplaySystem) value);
LIB_EXPORT C(DisplaySystem) (* Object_get_displaySystem)(const C(Object) * o);

LIB_EXPORT C(Property) * PROPERTY(Transform, Matrix);
LIB_EXPORT void (* Transform_from_Matrix)(const C(Transform) * t, const C(Matrix) * value);
LIB_EXPORT void (* Transform_to_Matrix)(const C(Transform) * t, C(Matrix) * value);
...
LIB_EXPORT double (* Vector3D_get_lengthApprox)(const C(Vector3D) * v);

LIB_EXPORT C(Property) * PROPERTY(Vector3Df, length);
LIB_EXPORT float (* Vector3Df_get_length)(const C(Vector3Df) * v);

LIB_EXPORT C(Property) * PROPERTY(Vector3Df, lengthApprox);
LIB_EXPORT float (* Vector3Df_get_lengthApprox)(const C(Vector3Df) * v);

LIB_EXPORT C(Property) * PROPERTY(Cube, size);
LIB_EXPORT void (* Cube_set_size)(const C(Cube) * c, const C(Vector3Df) * value);

LIB_EXPORT C(Property) * PROPERTY(SkyBox, size);
LIB_EXPORT void (* SkyBox_set_size)(const C(SkyBox) * s, const C(Vector3Df) * value);

LIB_EXPORT C(Property) * PROPERTY(SkyBox, folder);
LIB_EXPORT void (* SkyBox_set_folder)(const C(SkyBox) * s, const char * value);

LIB_EXPORT C(Property) * PROPERTY(SkyBox, extension);
LIB_EXPORT void (* SkyBox_set_extension)(const C(SkyBox) * s, const char * value);

LIB_EXPORT C(Property) * PROPERTY(SkyBox, newStyle);
LIB_EXPORT void (* SkyBox_set_newStyle)(const C(SkyBox) * s, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(SkyBox, cubeMap);
LIB_EXPORT void (* SkyBox_set_cubeMap)(const C(SkyBox) * s, C(CubeMap) value);

LIB_EXPORT C(Property) * PROPERTY(Sphere, numLat);
LIB_EXPORT void (* Sphere_set_numLat)(const C(Sphere) * s, int value);

LIB_EXPORT C(Property) * PROPERTY(Sphere, numLon);
LIB_EXPORT void (* Sphere_set_numLon)(const C(Sphere) * s, int value);

LIB_EXPORT C(Property) * PROPERTY(Sphere, flattenedBody);
LIB_EXPORT void (* Sphere_set_flattenedBody)(const C(Sphere) * s, float value);

LIB_EXPORT C(Property) * PROPERTY(AnchorValue, MinMaxValue);
LIB_EXPORT void (* AnchorValue_from_MinMaxValue)(const C(AnchorValue) * a, C(MinMaxValue) value);
LIB_EXPORT C(MinMaxValue) (* AnchorValue_to_MinMaxValue)(const C(AnchorValue) * a);

LIB_EXPORT C(Property) * PROPERTY(AnchorValue, int);
LIB_EXPORT void (* AnchorValue_from_int)(const C(AnchorValue) * a, int value);
LIB_EXPORT int (* AnchorValue_to_int)(const C(AnchorValue) * a);

LIB_EXPORT C(Property) * PROPERTY(AnchorValue, double);
LIB_EXPORT void (* AnchorValue_from_double)(const C(AnchorValue) * a, double value);
LIB_EXPORT double (* AnchorValue_to_double)(const C(AnchorValue) * a);

LIB_EXPORT C(Property) * PROPERTY(ClipBoard, memory);
LIB_EXPORT char * (* ClipBoard_get_memory)(const C(ClipBoard) * c);

LIB_EXPORT C(Property) * PROPERTY(CommonControl, toolTip);
LIB_EXPORT void (* CommonControl_set_toolTip)(const C(CommonControl) c, constString value);
LIB_EXPORT constString (* CommonControl_get_toolTip)(const C(CommonControl) c);

LIB_EXPORT C(Property) * PROPERTY(Cursor, systemCursor);
LIB_EXPORT void (* Cursor_set_systemCursor)(const C(Cursor) c, C(SystemCursor) value);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, appName);
LIB_EXPORT void (* GuiApplication_set_appName)(const C(GuiApplication) g, const char * value);
LIB_EXPORT const char * (* GuiApplication_get_appName)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, semaphore);
LIB_EXPORT C(Semaphore) * (* GuiApplication_get_semaphore)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, alwaysEmptyInput);
LIB_EXPORT void (* GuiApplication_set_alwaysEmptyInput)(const C(GuiApplication) g, C(bool) value);
LIB_EXPORT C(bool) (* GuiApplication_get_alwaysEmptyInput)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, fullScreen);
LIB_EXPORT void (* GuiApplication_set_fullScreen)(const C(GuiApplication) g, C(bool) value);
LIB_EXPORT C(bool) (* GuiApplication_get_fullScreen)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, driver);
LIB_EXPORT void (* GuiApplication_set_driver)(const C(GuiApplication) g, const char * value);
LIB_EXPORT const char * (* GuiApplication_get_driver)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, resolution);
LIB_EXPORT void (* GuiApplication_set_resolution)(const C(GuiApplication) g, C(Resolution) value);
LIB_EXPORT C(Resolution) (* GuiApplication_get_resolution)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, pixelFormat);
LIB_EXPORT void (* GuiApplication_set_pixelFormat)(const C(GuiApplication) g, C(PixelFormat) value);
LIB_EXPORT C(PixelFormat) (* GuiApplication_get_pixelFormat)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, refreshRate);
LIB_EXPORT void (* GuiApplication_set_refreshRate)(const C(GuiApplication) g, int value);
LIB_EXPORT int (* GuiApplication_get_refreshRate)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, skin);
LIB_EXPORT void (* GuiApplication_set_skin)(const C(GuiApplication) g, const char * value);
LIB_EXPORT const char * (* GuiApplication_get_skin)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, textMode);
LIB_EXPORT void (* GuiApplication_set_textMode)(const C(GuiApplication) g, C(bool) value);
LIB_EXPORT C(bool) (* GuiApplication_get_textMode)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, desktop);
LIB_EXPORT C(Window) (* GuiApplication_get_desktop)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, drivers);
LIB_EXPORT const char ** (* GuiApplication_get_drivers)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, skins);
LIB_EXPORT const char ** (* GuiApplication_get_skins)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, currentSkin);
LIB_EXPORT subclass(Skin) (* GuiApplication_get_currentSkin)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, numDrivers);
LIB_EXPORT int (* GuiApplication_get_numDrivers)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, numSkins);
LIB_EXPORT int (* GuiApplication_get_numSkins)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, timerResolution);
LIB_EXPORT void (* GuiApplication_set_timerResolution)(const C(GuiApplication) g, uint value);

LIB_EXPORT C(Property) * PROPERTY(GuiApplication, acquiredWindow);
LIB_EXPORT C(Window) (* GuiApplication_get_acquiredWindow)(const C(GuiApplication) g);

LIB_EXPORT C(Property) * PROPERTY(Key, SmartKey);
LIB_EXPORT C(SmartKey) (* Key_to_SmartKey)(const C(Key) key);

LIB_EXPORT C(Property) * PROPERTY(MiddleAnchorValue, MinMaxValue);
LIB_EXPORT void (* MiddleAnchorValue_from_MinMaxValue)(const C(MiddleAnchorValue) * m, C(MinMaxValue) value);
LIB_EXPORT C(MinMaxValue) (* MiddleAnchorValue_to_MinMaxValue)(const C(MiddleAnchorValue) * m);

LIB_EXPORT C(Property) * PROPERTY(MiddleAnchorValue, int);
LIB_EXPORT void (* MiddleAnchorValue_from_int)(const C(MiddleAnchorValue) * m, int value);
LIB_EXPORT int (* MiddleAnchorValue_to_int)(const C(MiddleAnchorValue) * m);

LIB_EXPORT C(Property) * PROPERTY(MiddleAnchorValue, double);
LIB_EXPORT void (* MiddleAnchorValue_from_double)(const C(MiddleAnchorValue) * m, double value);
LIB_EXPORT double (* MiddleAnchorValue_to_double)(const C(MiddleAnchorValue) * m);

LIB_EXPORT C(Property) * PROPERTY(Timer, userData);
LIB_EXPORT void (* Timer_set_userData)(const C(Timer) t, void * value);
LIB_EXPORT void * (* Timer_get_userData)(const C(Timer) t);

LIB_EXPORT C(Property) * PROPERTY(Timer, delay);
LIB_EXPORT void (* Timer_set_delay)(const C(Timer) t, C(Time) value);
LIB_EXPORT C(Time) (* Timer_get_delay)(const C(Timer) t);

LIB_EXPORT C(Property) * PROPERTY(Timer, started);
LIB_EXPORT void (* Timer_set_started)(const C(Timer) t, C(bool) value);
LIB_EXPORT C(bool) (* Timer_get_started)(const C(Timer) t);

LIB_EXPORT C(Property) * PROPERTY(Window, parent);
LIB_EXPORT void (* Window_set_parent)(const C(Window) w, C(Window) value);
LIB_EXPORT C(Window) (* Window_get_parent)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, master);
LIB_EXPORT void (* Window_set_master)(const C(Window) w, C(Window) value);
LIB_EXPORT C(Window) (* Window_get_master)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, caption);
LIB_EXPORT void (* Window_set_caption)(const C(Window) w, const char * value);
LIB_EXPORT const char * (* Window_get_caption)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hotKey);
LIB_EXPORT void (* Window_set_hotKey)(const C(Window) w, C(Key) value);
LIB_EXPORT C(Key) (* Window_get_hotKey)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, background);
LIB_EXPORT void (* Window_set_background)(const C(Window) w, C(Color) value);
LIB_EXPORT C(Color) (* Window_get_background)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, opacity);
LIB_EXPORT void (* Window_set_opacity)(const C(Window) w, C(Percentage) value);
LIB_EXPORT C(Percentage) (* Window_get_opacity)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, foreground);
LIB_EXPORT void (* Window_set_foreground)(const C(Window) w, C(Color) value);
LIB_EXPORT C(Color) (* Window_get_foreground)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, borderStyle);
LIB_EXPORT void (* Window_set_borderStyle)(const C(Window) w, C(BorderStyle) value);
LIB_EXPORT C(BorderStyle) (* Window_get_borderStyle)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, minClientSize);
LIB_EXPORT void (* Window_set_minClientSize)(const C(Window) w, const C(Size) * value);
LIB_EXPORT void (* Window_get_minClientSize)(const C(Window) w, C(Size) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, maxClientSize);
LIB_EXPORT void (* Window_set_maxClientSize)(const C(Window) w, const C(Size) * value);
LIB_EXPORT void (* Window_get_maxClientSize)(const C(Window) w, C(Size) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, hasMaximize);
LIB_EXPORT void (* Window_set_hasMaximize)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasMaximize)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasMinimize);
LIB_EXPORT void (* Window_set_hasMinimize)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasMinimize)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasClose);
LIB_EXPORT void (* Window_set_hasClose)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasClose)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, nonClient);
LIB_EXPORT void (* Window_set_nonClient)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_nonClient)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, inactive);
LIB_EXPORT void (* Window_set_inactive)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_inactive)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, clickThrough);
LIB_EXPORT void (* Window_set_clickThrough)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_clickThrough)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, isRemote);
LIB_EXPORT void (* Window_set_isRemote)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_isRemote)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, noCycle);
LIB_EXPORT void (* Window_set_noCycle)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_noCycle)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, isModal);
LIB_EXPORT void (* Window_set_isModal)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_isModal)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, interim);
LIB_EXPORT void (* Window_set_interim)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_interim)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, tabCycle);
LIB_EXPORT void (* Window_set_tabCycle)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_tabCycle)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, isDefault);
LIB_EXPORT void (* Window_set_isDefault)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_isDefault)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, drawBehind);
LIB_EXPORT void (* Window_set_drawBehind)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_drawBehind)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasMenuBar);
LIB_EXPORT void (* Window_set_hasMenuBar)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasMenuBar)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasStatusBar);
LIB_EXPORT void (* Window_set_hasStatusBar)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasStatusBar)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, stayOnTop);
LIB_EXPORT void (* Window_set_stayOnTop)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_stayOnTop)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, menu);
LIB_EXPORT void (* Window_set_menu)(const C(Window) w, C(Menu) value);
LIB_EXPORT C(Menu) (* Window_get_menu)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, font);
LIB_EXPORT void (* Window_set_font)(const C(Window) w, C(FontResource) value);
LIB_EXPORT C(FontResource) (* Window_get_font)(const C(Window) w);
LIB_EXPORT C(bool) (* Window_isSet_font)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, sizeAnchor);
LIB_EXPORT void (* Window_set_sizeAnchor)(const C(Window) w, const C(SizeAnchor) * value);
LIB_EXPORT void (* Window_get_sizeAnchor)(const C(Window) w, C(SizeAnchor) * value);
LIB_EXPORT C(bool) (* Window_isSet_sizeAnchor)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, size);
LIB_EXPORT void (* Window_set_size)(const C(Window) w, const C(Size) * value);
LIB_EXPORT void (* Window_get_size)(const C(Window) w, C(Size) * value);
LIB_EXPORT C(bool) (* Window_isSet_size)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, clientSize);
LIB_EXPORT void (* Window_set_clientSize)(const C(Window) w, const C(Size) * value);
LIB_EXPORT void (* Window_get_clientSize)(const C(Window) w, C(Size) * value);
LIB_EXPORT C(bool) (* Window_isSet_clientSize)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, initSize);
LIB_EXPORT void (* Window_get_initSize)(const C(Window) w, C(Size) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, anchor);
LIB_EXPORT void (* Window_set_anchor)(const C(Window) w, const C(Anchor) * value);
LIB_EXPORT void (* Window_get_anchor)(const C(Window) w, C(Anchor) * value);
LIB_EXPORT C(bool) (* Window_isSet_anchor)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, position);
LIB_EXPORT void (* Window_set_position)(const C(Window) w, const C(Point) * value);
LIB_EXPORT void (* Window_get_position)(const C(Window) w, C(Point) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, disabled);
LIB_EXPORT void (* Window_set_disabled)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_disabled)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, isEnabled);
LIB_EXPORT C(bool) (* Window_get_isEnabled)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, state);
LIB_EXPORT void (* Window_set_state)(const C(Window) w, C(WindowState) value);
LIB_EXPORT C(WindowState) (* Window_get_state)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, visible);
LIB_EXPORT void (* Window_set_visible)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_visible)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, isDocument);
LIB_EXPORT void (* Window_set_isDocument)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_isDocument)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, mergeMenus);
LIB_EXPORT void (* Window_set_mergeMenus)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_mergeMenus)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasHorzScroll);
LIB_EXPORT void (* Window_set_hasHorzScroll)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasHorzScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, hasVertScroll);
LIB_EXPORT void (* Window_set_hasVertScroll)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_hasVertScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, dontHideScroll);
LIB_EXPORT void (* Window_set_dontHideScroll)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_dontHideScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, dontScrollVert);
LIB_EXPORT void (* Window_set_dontScrollVert)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_dontScrollVert)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, dontScrollHorz);
LIB_EXPORT void (* Window_set_dontScrollHorz)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_dontScrollHorz)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, snapVertScroll);
LIB_EXPORT void (* Window_set_snapVertScroll)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_snapVertScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, snapHorzScroll);
LIB_EXPORT void (* Window_set_snapHorzScroll)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_snapHorzScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, scroll);
LIB_EXPORT void (* Window_set_scroll)(const C(Window) w, const C(Point) * value);
LIB_EXPORT void (* Window_get_scroll)(const C(Window) w, C(Point) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, modifyVirtualArea);
LIB_EXPORT void (* Window_set_modifyVirtualArea)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_modifyVirtualArea)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, dontAutoScrollArea);
LIB_EXPORT void (* Window_set_dontAutoScrollArea)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_dontAutoScrollArea)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, fileName);
LIB_EXPORT void (* Window_set_fileName)(const C(Window) w, const char * value);
LIB_EXPORT const char * (* Window_get_fileName)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, id);
LIB_EXPORT void (* Window_set_id)(const C(Window) w, int64 value);
LIB_EXPORT int64 (* Window_get_id)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, modifiedDocument);
LIB_EXPORT void (* Window_set_modifiedDocument)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_modifiedDocument)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, showInTaskBar);
LIB_EXPORT void (* Window_set_showInTaskBar)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_showInTaskBar)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, saveDialog);
LIB_EXPORT void (* Window_set_saveDialog)(const C(Window) w, C(FileDialog) value);

LIB_EXPORT C(Property) * PROPERTY(Window, isActiveClient);
LIB_EXPORT void (* Window_set_isActiveClient)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_isActiveClient)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, cursor);
LIB_EXPORT void (* Window_set_cursor)(const C(Window) w, C(Cursor) value);
LIB_EXPORT C(Cursor) (* Window_get_cursor)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, name);
LIB_EXPORT void (* Window_set_name)(const C(Window) w, const char * value);
LIB_EXPORT const char * (* Window_get_name)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, displayDriver);
LIB_EXPORT void (* Window_set_displayDriver)(const C(Window) w, const char * value);
LIB_EXPORT const char * (* Window_get_displayDriver)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, autoCreate);
LIB_EXPORT void (* Window_set_autoCreate)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_autoCreate)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, scrollArea);
LIB_EXPORT void (* Window_set_scrollArea)(const C(Window) w, const C(Size) * value);
LIB_EXPORT void (* Window_get_scrollArea)(const C(Window) w, C(Size) * value);
LIB_EXPORT C(bool) (* Window_isSet_scrollArea)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, is3D);
LIB_EXPORT void (* Window_set_is3D)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_is3D)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, fontObject);
LIB_EXPORT C(Font) * (* Window_get_fontObject)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, clientStart);
LIB_EXPORT void (* Window_get_clientStart)(const C(Window) w, C(Point) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, absPosition);
LIB_EXPORT void (* Window_get_absPosition)(const C(Window) w, C(Point) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, normalAnchor);
LIB_EXPORT void (* Window_get_normalAnchor)(const C(Window) w, C(Anchor) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, normalSizeAnchor);
LIB_EXPORT void (* Window_get_normalSizeAnchor)(const C(Window) w, C(SizeAnchor) * value);

LIB_EXPORT C(Property) * PROPERTY(Window, active);
LIB_EXPORT C(bool) (* Window_get_active)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, created);
LIB_EXPORT C(bool) (* Window_get_created)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, destroyed);
LIB_EXPORT C(bool) (* Window_get_destroyed)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, firstSlave);
LIB_EXPORT C(Window) (* Window_get_firstSlave)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, firstChild);
LIB_EXPORT C(Window) (* Window_get_firstChild)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, lastChild);
LIB_EXPORT C(Window) (* Window_get_lastChild)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, activeClient);
LIB_EXPORT C(Window) (* Window_get_activeClient)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, activeChild);
LIB_EXPORT C(Window) (* Window_get_activeChild)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, display);
LIB_EXPORT C(Display) (* Window_get_display)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, displaySystem);
LIB_EXPORT C(DisplaySystem) (* Window_get_displaySystem)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, horzScroll);
LIB_EXPORT C(ScrollBar) (* Window_get_horzScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, vertScroll);
LIB_EXPORT C(ScrollBar) (* Window_get_vertScroll)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, statusBar);
LIB_EXPORT C(StatusBar) (* Window_get_statusBar)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, rootWindow);
LIB_EXPORT C(Window) (* Window_get_rootWindow)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, closing);
LIB_EXPORT void (* Window_set_closing)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_closing)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, documentID);
LIB_EXPORT int (* Window_get_documentID)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, previous);
LIB_EXPORT C(Window) (* Window_get_previous)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, next);
LIB_EXPORT C(Window) (* Window_get_next)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, nextSlave);
LIB_EXPORT C(Window) (* Window_get_nextSlave)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, menuBar);
LIB_EXPORT C(PopupMenu) (* Window_get_menuBar)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, sbv);
LIB_EXPORT C(ScrollBar) (* Window_get_sbv)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, sbh);
LIB_EXPORT C(ScrollBar) (* Window_get_sbh)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, fullRender);
LIB_EXPORT void (* Window_set_fullRender)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_fullRender)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, systemHandle);
LIB_EXPORT void * (* Window_get_systemHandle)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, minimizeButton);
LIB_EXPORT C(Button) (* Window_get_minimizeButton)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, maximizeButton);
LIB_EXPORT C(Button) (* Window_get_maximizeButton)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, closeButton);
LIB_EXPORT C(Button) (* Window_get_closeButton)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, icon);
LIB_EXPORT void (* Window_set_icon)(const C(Window) w, C(BitmapResource) value);
LIB_EXPORT C(BitmapResource) (* Window_get_icon)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, moveable);
LIB_EXPORT void (* Window_set_moveable)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_moveable)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, alphaBlend);
LIB_EXPORT void (* Window_set_alphaBlend)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_alphaBlend)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, useSharedMemory);
LIB_EXPORT void (* Window_set_useSharedMemory)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_useSharedMemory)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, glCapabilities);
LIB_EXPORT void (* Window_set_glCapabilities)(const C(Window) w, C(GLCapabilities) value);
LIB_EXPORT C(GLCapabilities) (* Window_get_glCapabilities)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, creationActivation);
LIB_EXPORT void (* Window_set_creationActivation)(const C(Window) w, C(CreationActivationOption) value);
LIB_EXPORT C(CreationActivationOption) (* Window_get_creationActivation)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, nativeDecorations);
LIB_EXPORT void (* Window_set_nativeDecorations)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_nativeDecorations)(const C(Window) w);
LIB_EXPORT C(bool) (* Window_isSet_nativeDecorations)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, manageDisplay);
LIB_EXPORT void (* Window_set_manageDisplay)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_manageDisplay)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, text);
LIB_EXPORT void (* Window_set_text)(const C(Window) w, const char * value);
LIB_EXPORT const char * (* Window_get_text)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, controller);
LIB_EXPORT void (* Window_set_controller)(const C(Window) w, C(WindowController) value);
LIB_EXPORT C(WindowController) (* Window_get_controller)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(Window, noConsequential);
LIB_EXPORT void (* Window_set_noConsequential)(const C(Window) w, C(bool) value);
LIB_EXPORT C(bool) (* Window_get_noConsequential)(const C(Window) w);

LIB_EXPORT C(Property) * PROPERTY(WindowController, window);
LIB_EXPORT C(Window) (* WindowController_get_window)(const C(WindowController) w);

LIB_EXPORT C(Property) * PROPERTY(WindowController, controlled);
LIB_EXPORT void (* WindowController_set_controlled)(const C(WindowController) w, TP(WindowController, V) value);
LIB_EXPORT TP(WindowController, V) (* WindowController_get_controlled)(const C(WindowController) w);

LIB_EXPORT C(Property) * PROPERTY(Button, opacity);
LIB_EXPORT void (* Button_set_opacity)(const C(Button) b, C(Percentage) value);
LIB_EXPORT C(Percentage) (* Button_get_opacity)(const C(Button) b);
LIB_EXPORT C(bool) (* Button_isSet_opacity)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, drawBehind);
LIB_EXPORT void (* Button_set_drawBehind)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_drawBehind)(const C(Button) b);
LIB_EXPORT C(bool) (* Button_isSet_drawBehind)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, isRadio);
LIB_EXPORT void (* Button_set_isRadio)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_isRadio)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, isCheckbox);
LIB_EXPORT void (* Button_set_isCheckbox)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_isCheckbox)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, bevel);
LIB_EXPORT void (* Button_set_bevel)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_bevel)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, bevelOver);
LIB_EXPORT void (* Button_set_bevelOver)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_bevelOver)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, toggle);
LIB_EXPORT void (* Button_set_toggle)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_toggle)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, checked);
LIB_EXPORT void (* Button_set_checked)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_checked)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, alignment);
LIB_EXPORT void (* Button_set_alignment)(const C(Button) b, C(Alignment) value);
LIB_EXPORT C(Alignment) (* Button_get_alignment)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, bitmap);
LIB_EXPORT void (* Button_set_bitmap)(const C(Button) b, C(BitmapResource) value);
LIB_EXPORT C(BitmapResource) (* Button_get_bitmap)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, stayUp);
LIB_EXPORT void (* Button_set_stayUp)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_stayUp)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, scaleBitmap);
LIB_EXPORT void (* Button_set_scaleBitmap)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_scaleBitmap)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, keyRepeat);
LIB_EXPORT void (* Button_set_keyRepeat)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_keyRepeat)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, symbol);
LIB_EXPORT void (* Button_set_symbol)(const C(Button) b, unichar value);
LIB_EXPORT unichar (* Button_get_symbol)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, ellipsis);
LIB_EXPORT void (* Button_set_ellipsis)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_ellipsis)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, stayDown);
LIB_EXPORT void (* Button_set_stayDown)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_stayDown)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, offset);
LIB_EXPORT void (* Button_set_offset)(const C(Button) b, C(bool) value);
LIB_EXPORT C(bool) (* Button_get_offset)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, buttonState);
LIB_EXPORT void (* Button_set_buttonState)(const C(Button) b, C(ButtonState) value);
LIB_EXPORT C(ButtonState) (* Button_get_buttonState)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(Button, bitmapAlignment);
LIB_EXPORT void (* Button_set_bitmapAlignment)(const C(Button) b, C(BoxAlignment) value);
LIB_EXPORT C(BoxAlignment) (* Button_get_bitmapAlignment)(const C(Button) b);

LIB_EXPORT C(Property) * PROPERTY(DataField, dataType);
LIB_EXPORT void (* DataField_set_dataType)(const C(DataField) d, C(Class) * value);
LIB_EXPORT C(Class) * (* DataField_get_dataType)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, editable);
LIB_EXPORT void (* DataField_set_editable)(const C(DataField) d, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(DataField, fixed);
LIB_EXPORT void (* DataField_set_fixed)(const C(DataField) d, C(bool) value);
LIB_EXPORT C(bool) (* DataField_get_fixed)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, alignment);
LIB_EXPORT void (* DataField_set_alignment)(const C(DataField) d, C(Alignment) value);
LIB_EXPORT C(Alignment) (* DataField_get_alignment)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, width);
LIB_EXPORT void (* DataField_set_width)(const C(DataField) d, int value);
LIB_EXPORT int (* DataField_get_width)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, index);
LIB_EXPORT int (* DataField_get_index)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, position);
LIB_EXPORT void (* DataField_set_position)(const C(DataField) d, int value);
LIB_EXPORT int (* DataField_get_position)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, sortOrder);
LIB_EXPORT int (* DataField_get_sortOrder)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, header);
LIB_EXPORT void (* DataField_set_header)(const C(DataField) d, const char * value);

LIB_EXPORT C(Property) * PROPERTY(DataField, userData);
LIB_EXPORT void (* DataField_set_userData)(const C(DataField) d, void * value);
LIB_EXPORT void * (* DataField_get_userData)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, freeData);
LIB_EXPORT void (* DataField_set_freeData)(const C(DataField) d, C(bool) value);
LIB_EXPORT C(bool) (* DataField_get_freeData)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, prev);
LIB_EXPORT C(DataField) (* DataField_get_prev)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataField, next);
LIB_EXPORT C(DataField) (* DataField_get_next)(const C(DataField) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, tag);
LIB_EXPORT void (* DataRow_set_tag)(const C(DataRow) d, int64 value);
LIB_EXPORT int64 (* DataRow_get_tag)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, previous);
LIB_EXPORT C(DataRow) (* DataRow_get_previous)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, next);
LIB_EXPORT C(DataRow) (* DataRow_get_next)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, index);
LIB_EXPORT int (* DataRow_get_index)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, string);
LIB_EXPORT void (* DataRow_set_string)(const C(DataRow) d, const char * value);
LIB_EXPORT const char * (* DataRow_get_string)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, isHeader);
LIB_EXPORT void (* DataRow_set_isHeader)(const C(DataRow) d, C(bool) value);
LIB_EXPORT C(bool) (* DataRow_get_isHeader)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, icon);
LIB_EXPORT void (* DataRow_set_icon)(const C(DataRow) d, C(BitmapResource) value);
LIB_EXPORT C(BitmapResource) (* DataRow_get_icon)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, collapsed);
LIB_EXPORT void (* DataRow_set_collapsed)(const C(DataRow) d, C(bool) value);
LIB_EXPORT C(bool) (* DataRow_get_collapsed)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, selected);
LIB_EXPORT void (* DataRow_set_selected)(const C(DataRow) d, C(bool) value);
LIB_EXPORT C(bool) (* DataRow_get_selected)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, parent);
LIB_EXPORT void (* DataRow_set_parent)(const C(DataRow) d, C(DataRow) value);
LIB_EXPORT C(DataRow) (* DataRow_get_parent)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, lastRow);
LIB_EXPORT C(DataRow) (* DataRow_get_lastRow)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DataRow, firstRow);
LIB_EXPORT C(DataRow) (* DataRow_get_firstRow)(const C(DataRow) d);

LIB_EXPORT C(Property) * PROPERTY(DirectoriesBox, strings);
LIB_EXPORT void (* DirectoriesBox_set_strings)(const C(DirectoriesBox) d, C(Array) value);
LIB_EXPORT C(Array) (* DirectoriesBox_get_strings)(const C(DirectoriesBox) d);

LIB_EXPORT C(Property) * PROPERTY(DirectoriesBox, browseDialog);
LIB_EXPORT void (* DirectoriesBox_set_browseDialog)(const C(DirectoriesBox) d, C(FileDialog) value);
LIB_EXPORT C(FileDialog) (* DirectoriesBox_get_browseDialog)(const C(DirectoriesBox) d);

LIB_EXPORT C(Property) * PROPERTY(DirectoriesBox, baseBrowsePath);
LIB_EXPORT void (* DirectoriesBox_set_baseBrowsePath)(const C(DirectoriesBox) d, C(String) value);
LIB_EXPORT C(String) (* DirectoriesBox_get_baseBrowsePath)(const C(DirectoriesBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, activeStipple);
LIB_EXPORT void (* DropBox_set_activeStipple)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_activeStipple)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, showButton);
LIB_EXPORT void (* DropBox_set_showButton)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_showButton)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, alignment);
LIB_EXPORT void (* DropBox_set_alignment)(const C(DropBox) d, C(Alignment) value);
LIB_EXPORT C(Alignment) (* DropBox_get_alignment)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, noHighlight);
LIB_EXPORT void (* DropBox_set_noHighlight)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_noHighlight)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, activeColor);
LIB_EXPORT void (* DropBox_set_activeColor)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_activeColor)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, currentRow);
LIB_EXPORT void (* DropBox_set_currentRow)(const C(DropBox) d, C(DataRow) value);
LIB_EXPORT C(DataRow) (* DropBox_get_currentRow)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, firstRow);
LIB_EXPORT C(DataRow) (* DropBox_get_firstRow)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, lastRow);
LIB_EXPORT C(DataRow) (* DropBox_get_lastRow)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, contents);
LIB_EXPORT void (* DropBox_set_contents)(const C(DropBox) d, const char * value);
LIB_EXPORT const char * (* DropBox_get_contents)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, editText);
LIB_EXPORT void (* DropBox_set_editText)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_editText)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, editBox);
LIB_EXPORT C(EditBox) (* DropBox_get_editBox)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, typingTimeout);
LIB_EXPORT void (* DropBox_set_typingTimeout)(const C(DropBox) d, C(Time) value);
LIB_EXPORT C(Time) (* DropBox_get_typingTimeout)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, rowHeight);
LIB_EXPORT void (* DropBox_set_rowHeight)(const C(DropBox) d, int value);
LIB_EXPORT int (* DropBox_get_rowHeight)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, maxShown);
LIB_EXPORT void (* DropBox_set_maxShown)(const C(DropBox) d, int value);
LIB_EXPORT int (* DropBox_get_maxShown)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, pullDown);
LIB_EXPORT C(Window) (* DropBox_get_pullDown)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, showNone);
LIB_EXPORT void (* DropBox_set_showNone)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_showNone)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, selectionColor);
LIB_EXPORT void (* DropBox_set_selectionColor)(const C(DropBox) d, C(Color) value);
LIB_EXPORT C(Color) (* DropBox_get_selectionColor)(const C(DropBox) d);
LIB_EXPORT C(bool) (* DropBox_isSet_selectionColor)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, selectionText);
LIB_EXPORT void (* DropBox_set_selectionText)(const C(DropBox) d, C(Color) value);
LIB_EXPORT C(Color) (* DropBox_get_selectionText)(const C(DropBox) d);
LIB_EXPORT C(bool) (* DropBox_isSet_selectionText)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, changeContents);
LIB_EXPORT void (* DropBox_set_changeContents)(const C(DropBox) d, C(bool) value);
LIB_EXPORT C(bool) (* DropBox_get_changeContents)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, listBox);
LIB_EXPORT C(ListBox) (* DropBox_get_listBox)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(DropBox, rowCount);
LIB_EXPORT int (* DropBox_get_rowCount)(const C(DropBox) d);

LIB_EXPORT C(Property) * PROPERTY(EditBox, textHorzScroll);
LIB_EXPORT void (* EditBox_set_textHorzScroll)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_textHorzScroll)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, textVertScroll);
LIB_EXPORT void (* EditBox_set_textVertScroll)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_textVertScroll)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, readOnly);
LIB_EXPORT void (* EditBox_set_readOnly)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_readOnly)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, multiLine);
LIB_EXPORT void (* EditBox_set_multiLine)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_multiLine)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, freeCaret);
LIB_EXPORT void (* EditBox_set_freeCaret)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_freeCaret)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, tabKey);
LIB_EXPORT void (* EditBox_set_tabKey)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_tabKey)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, tabSize);
LIB_EXPORT void (* EditBox_set_tabSize)(const C(EditBox) e, int value);
LIB_EXPORT int (* EditBox_get_tabSize)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, tabSelection);
LIB_EXPORT void (* EditBox_set_tabSelection)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_tabSelection)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, smartHome);
LIB_EXPORT void (* EditBox_set_smartHome)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_smartHome)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, autoEmpty);
LIB_EXPORT void (* EditBox_set_autoEmpty)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_autoEmpty)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, noCaret);
LIB_EXPORT void (* EditBox_set_noCaret)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_noCaret)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, maxLineSize);
LIB_EXPORT void (* EditBox_set_maxLineSize)(const C(EditBox) e, int value);
LIB_EXPORT int (* EditBox_get_maxLineSize)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, maxNumLines);
LIB_EXPORT void (* EditBox_set_maxNumLines)(const C(EditBox) e, int value);
LIB_EXPORT int (* EditBox_get_maxNumLines)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, useTab);
LIB_EXPORT void (* EditBox_set_useTab)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_useTab)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, syntaxHighlighting);
LIB_EXPORT void (* EditBox_set_syntaxHighlighting)(const C(EditBox) e, C(EditSyntaxHL) value);
LIB_EXPORT C(EditSyntaxHL) (* EditBox_get_syntaxHighlighting)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, noSelect);
LIB_EXPORT void (* EditBox_set_noSelect)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_noSelect)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, allCaps);
LIB_EXPORT void (* EditBox_set_allCaps)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_allCaps)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, autoSize);
LIB_EXPORT void (* EditBox_set_autoSize)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_autoSize)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, wrap);
LIB_EXPORT void (* EditBox_set_wrap)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_wrap)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, numLines);
LIB_EXPORT int (* EditBox_get_numLines)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, lineNumber);
LIB_EXPORT int (* EditBox_get_lineNumber)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, column);
LIB_EXPORT int (* EditBox_get_column)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, charPos);
LIB_EXPORT int (* EditBox_get_charPos)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, firstLine);
LIB_EXPORT C(EditLine) * (* EditBox_get_firstLine)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, lastLine);
LIB_EXPORT C(EditLine) * (* EditBox_get_lastLine)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, line);
LIB_EXPORT C(EditLine) * (* EditBox_get_line)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, contents);
LIB_EXPORT void (* EditBox_set_contents)(const C(EditBox) e, const char * value);
LIB_EXPORT const char * (* EditBox_get_contents)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, overwrite);
LIB_EXPORT C(bool) (* EditBox_get_overwrite)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, caretFollowsScrolling);
LIB_EXPORT void (* EditBox_set_caretFollowsScrolling)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_caretFollowsScrolling)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, multiLineContents);
LIB_EXPORT char * (* EditBox_get_multiLineContents)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, selectionColor);
LIB_EXPORT void (* EditBox_set_selectionColor)(const C(EditBox) e, C(Color) value);
LIB_EXPORT C(Color) (* EditBox_get_selectionColor)(const C(EditBox) e);
LIB_EXPORT C(bool) (* EditBox_isSet_selectionColor)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, selectionText);
LIB_EXPORT void (* EditBox_set_selectionText)(const C(EditBox) e, C(Color) value);
LIB_EXPORT C(Color) (* EditBox_get_selectionText)(const C(EditBox) e);
LIB_EXPORT C(bool) (* EditBox_isSet_selectionText)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBox, recordUndoEvent);
LIB_EXPORT void (* EditBox_set_recordUndoEvent)(const C(EditBox) e, C(bool) value);
LIB_EXPORT C(bool) (* EditBox_get_recordUndoEvent)(const C(EditBox) e);

LIB_EXPORT C(Property) * PROPERTY(EditBoxStream, editBox);
LIB_EXPORT void (* EditBoxStream_set_editBox)(const C(EditBoxStream) e, C(EditBox) value);
LIB_EXPORT C(EditBox) (* EditBoxStream_get_editBox)(const C(EditBoxStream) e);

LIB_EXPORT C(Property) * PROPERTY(EditLine, text);
LIB_EXPORT void (* EditLine_set_text)(const C(EditLine) * e, const char * value);
LIB_EXPORT const char * (* EditLine_get_text)(const C(EditLine) * e);

LIB_EXPORT C(Property) * PROPERTY(EditLine, prev);
LIB_EXPORT C(EditLine) * (* EditLine_get_prev)(const C(EditLine) * e);

LIB_EXPORT C(Property) * PROPERTY(EditLine, next);
LIB_EXPORT C(EditLine) * (* EditLine_get_next)(const C(EditLine) * e);

LIB_EXPORT C(Property) * PROPERTY(EditLine, count);
LIB_EXPORT int (* EditLine_get_count)(const C(EditLine) * e);

LIB_EXPORT C(Property) * PROPERTY(EditableSelectorButton, renameable);
LIB_EXPORT void (* EditableSelectorButton_set_renameable)(const C(EditableSelectorButton) e, C(bool) value);
LIB_EXPORT C(bool) (* EditableSelectorButton_get_renameable)(const C(EditableSelectorButton) e);

LIB_EXPORT C(Property) * PROPERTY(EditableSelectorButton, editBox);
LIB_EXPORT C(EditBox) (* EditableSelectorButton_get_editBox)(const C(EditableSelectorButton) e);

LIB_EXPORT C(Property) * PROPERTY(Label, labeledWindow);
LIB_EXPORT void (* Label_set_labeledWindow)(const C(Label) l, C(Window) value);
LIB_EXPORT C(Window) (* Label_get_labeledWindow)(const C(Label) l);

LIB_EXPORT C(Property) * PROPERTY(Label, isGroupBox);
LIB_EXPORT void (* Label_set_isGroupBox)(const C(Label) l, C(bool) value);
LIB_EXPORT C(bool) (* Label_get_isGroupBox)(const C(Label) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, freeSelect);
LIB_EXPORT void (* ListBox_set_freeSelect)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_freeSelect)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, currentRow);
LIB_EXPORT void (* ListBox_set_currentRow)(const C(ListBox) l, C(DataRow) value);
LIB_EXPORT C(DataRow) (* ListBox_get_currentRow)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, currentField);
LIB_EXPORT void (* ListBox_set_currentField)(const C(ListBox) l, C(DataField) value);
LIB_EXPORT C(DataField) (* ListBox_get_currentField)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, rowHeight);
LIB_EXPORT void (* ListBox_set_rowHeight)(const C(ListBox) l, int value);
LIB_EXPORT int (* ListBox_get_rowHeight)(const C(ListBox) l);
LIB_EXPORT C(bool) (* ListBox_isSet_rowHeight)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, typingTimeout);
LIB_EXPORT void (* ListBox_set_typingTimeout)(const C(ListBox) l, C(Time) value);
LIB_EXPORT C(Time) (* ListBox_get_typingTimeout)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, moveRows);
LIB_EXPORT void (* ListBox_set_moveRows)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_moveRows)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, moveFields);
LIB_EXPORT void (* ListBox_set_moveFields)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_moveFields)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, resizable);
LIB_EXPORT void (* ListBox_set_resizable)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_resizable)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, autoScroll);
LIB_EXPORT void (* ListBox_set_autoScroll)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_autoScroll)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, alwaysHighLight);
LIB_EXPORT void (* ListBox_set_alwaysHighLight)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_alwaysHighLight)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, hasClearHeader);
LIB_EXPORT void (* ListBox_set_hasClearHeader)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_hasClearHeader)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, hasHeader);
LIB_EXPORT void (* ListBox_set_hasHeader)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_hasHeader)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, multiSelect);
LIB_EXPORT void (* ListBox_set_multiSelect)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_multiSelect)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, alwaysEdit);
LIB_EXPORT void (* ListBox_set_alwaysEdit)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_alwaysEdit)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, fullRowSelect);
LIB_EXPORT void (* ListBox_set_fullRowSelect)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_fullRowSelect)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, collapseControl);
LIB_EXPORT void (* ListBox_set_collapseControl)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_collapseControl)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, treeBranches);
LIB_EXPORT void (* ListBox_set_treeBranches)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_treeBranches)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, rootCollapseButton);
LIB_EXPORT void (* ListBox_set_rootCollapseButton)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_rootCollapseButton)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, sortable);
LIB_EXPORT void (* ListBox_set_sortable)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_sortable)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, noDragging);
LIB_EXPORT void (* ListBox_set_noDragging)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_noDragging)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, fillLastField);
LIB_EXPORT void (* ListBox_set_fillLastField)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_fillLastField)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, numSelections);
LIB_EXPORT int (* ListBox_get_numSelections)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, currentIndex);
LIB_EXPORT int (* ListBox_get_currentIndex)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, lastRow);
LIB_EXPORT C(DataRow) (* ListBox_get_lastRow)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, firstRow);
LIB_EXPORT C(DataRow) (* ListBox_get_firstRow)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, rowCount);
LIB_EXPORT int (* ListBox_get_rowCount)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, firstField);
LIB_EXPORT C(DataField) (* ListBox_get_firstField)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, selectionColor);
LIB_EXPORT void (* ListBox_set_selectionColor)(const C(ListBox) l, C(Color) value);
LIB_EXPORT C(Color) (* ListBox_get_selectionColor)(const C(ListBox) l);
LIB_EXPORT C(bool) (* ListBox_isSet_selectionColor)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, selectionText);
LIB_EXPORT void (* ListBox_set_selectionText)(const C(ListBox) l, C(Color) value);
LIB_EXPORT C(Color) (* ListBox_get_selectionText)(const C(ListBox) l);
LIB_EXPORT C(bool) (* ListBox_isSet_selectionText)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, stippleColor);
LIB_EXPORT void (* ListBox_set_stippleColor)(const C(ListBox) l, C(Color) value);
LIB_EXPORT C(Color) (* ListBox_get_stippleColor)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(ListBox, expandOnAdd);
LIB_EXPORT void (* ListBox_set_expandOnAdd)(const C(ListBox) l, C(bool) value);
LIB_EXPORT C(bool) (* ListBox_get_expandOnAdd)(const C(ListBox) l);

LIB_EXPORT C(Property) * PROPERTY(Menu, parent);
LIB_EXPORT void (* Menu_set_parent)(const C(Menu) m, C(Menu) value);

LIB_EXPORT C(Property) * PROPERTY(Menu, text);
LIB_EXPORT void (* Menu_set_text)(const C(Menu) m, const char * value);

LIB_EXPORT C(Property) * PROPERTY(Menu, hotKey);
LIB_EXPORT void (* Menu_set_hotKey)(const C(Menu) m, C(Key) value);

LIB_EXPORT C(Property) * PROPERTY(Menu, hasMargin);
LIB_EXPORT void (* Menu_set_hasMargin)(const C(Menu) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(Menu, copyText);
LIB_EXPORT void (* Menu_set_copyText)(const C(Menu) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, parent);
LIB_EXPORT void (* MenuItem_set_parent)(const C(MenuItem) m, C(Menu) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, text);
LIB_EXPORT void (* MenuItem_set_text)(const C(MenuItem) m, const char * value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, hotKey);
LIB_EXPORT void (* MenuItem_set_hotKey)(const C(MenuItem) m, C(Key) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, accelerator);
LIB_EXPORT void (* MenuItem_set_accelerator)(const C(MenuItem) m, C(Key) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, checked);
LIB_EXPORT void (* MenuItem_set_checked)(const C(MenuItem) m, C(bool) value);
LIB_EXPORT C(bool) (* MenuItem_get_checked)(const C(MenuItem) m);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, disabled);
LIB_EXPORT void (* MenuItem_set_disabled)(const C(MenuItem) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, checkable);
LIB_EXPORT void (* MenuItem_set_checkable)(const C(MenuItem) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, isRadio);
LIB_EXPORT void (* MenuItem_set_isRadio)(const C(MenuItem) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, id);
LIB_EXPORT void (* MenuItem_set_id)(const C(MenuItem) m, uint64 value);
LIB_EXPORT uint64 (* MenuItem_get_id)(const C(MenuItem) m);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, bitmap);
LIB_EXPORT void (* MenuItem_set_bitmap)(const C(MenuItem) m, C(BitmapResource) value);
LIB_EXPORT C(BitmapResource) (* MenuItem_get_bitmap)(const C(MenuItem) m);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, copyText);
LIB_EXPORT void (* MenuItem_set_copyText)(const C(MenuItem) m, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(MenuItem, bold);
LIB_EXPORT void (* MenuItem_set_bold)(const C(MenuItem) m, C(bool) value);
LIB_EXPORT C(bool) (* MenuItem_get_bold)(const C(MenuItem) m);

LIB_EXPORT C(Property) * PROPERTY(OldArray, size);
LIB_EXPORT void (* OldArray_set_size)(const C(OldArray) o, uint value);
LIB_EXPORT uint (* OldArray_get_size)(const C(OldArray) o);

LIB_EXPORT C(Property) * PROPERTY(OldArray, data);
LIB_EXPORT void (* OldArray_set_data)(const C(OldArray) o, void * value);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, toolSize);
LIB_EXPORT void (* PaneSplitter_set_toolSize)(const C(PaneSplitter) p, int value);
LIB_EXPORT int (* PaneSplitter_get_toolSize)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, toolGap);
LIB_EXPORT void (* PaneSplitter_set_toolGap)(const C(PaneSplitter) p, int value);
LIB_EXPORT int (* PaneSplitter_get_toolGap)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, leftPane);
LIB_EXPORT void (* PaneSplitter_set_leftPane)(const C(PaneSplitter) p, C(Window) value);
LIB_EXPORT C(Window) (* PaneSplitter_get_leftPane)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, rightPane);
LIB_EXPORT void (* PaneSplitter_set_rightPane)(const C(PaneSplitter) p, C(Window) value);
LIB_EXPORT C(Window) (* PaneSplitter_get_rightPane)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, topPane);
LIB_EXPORT void (* PaneSplitter_set_topPane)(const C(PaneSplitter) p, C(Window) value);
LIB_EXPORT C(Window) (* PaneSplitter_get_topPane)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, bottomPane);
LIB_EXPORT void (* PaneSplitter_set_bottomPane)(const C(PaneSplitter) p, C(Window) value);
LIB_EXPORT C(Window) (* PaneSplitter_get_bottomPane)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, scaleSplit);
LIB_EXPORT void (* PaneSplitter_set_scaleSplit)(const C(PaneSplitter) p, double value);
LIB_EXPORT double (* PaneSplitter_get_scaleSplit)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, orientation);
LIB_EXPORT void (* PaneSplitter_set_orientation)(const C(PaneSplitter) p, C(ScrollDirection) value);
LIB_EXPORT C(ScrollDirection) (* PaneSplitter_get_orientation)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PaneSplitter, split);
LIB_EXPORT void (* PaneSplitter_set_split)(const C(PaneSplitter) p, int value);
LIB_EXPORT int (* PaneSplitter_get_split)(const C(PaneSplitter) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, editBox);
LIB_EXPORT C(EditBox) (* PathBox_get_editBox)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, typeExpected);
LIB_EXPORT void (* PathBox_set_typeExpected)(const C(PathBox) p, C(PathTypeExpected) value);

LIB_EXPORT C(Property) * PROPERTY(PathBox, browseDialog);
LIB_EXPORT void (* PathBox_set_browseDialog)(const C(PathBox) p, C(FileDialog) value);
LIB_EXPORT C(FileDialog) (* PathBox_get_browseDialog)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, path);
LIB_EXPORT void (* PathBox_set_path)(const C(PathBox) p, constString value);
LIB_EXPORT constString (* PathBox_get_path)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, slashPath);
LIB_EXPORT C(String) (* PathBox_get_slashPath)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, systemPath);
LIB_EXPORT C(String) (* PathBox_get_systemPath)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, selectionColor);
LIB_EXPORT void (* PathBox_set_selectionColor)(const C(PathBox) p, C(Color) value);
LIB_EXPORT C(Color) (* PathBox_get_selectionColor)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(PathBox, selectionText);
LIB_EXPORT void (* PathBox_set_selectionText)(const C(PathBox) p, C(Color) value);
LIB_EXPORT C(Color) (* PathBox_get_selectionText)(const C(PathBox) p);

LIB_EXPORT C(Property) * PROPERTY(Picture, tint);
LIB_EXPORT void (* Picture_set_tint)(const C(Picture) p, C(Color) value);

LIB_EXPORT C(Property) * PROPERTY(Picture, image);
LIB_EXPORT void (* Picture_set_image)(const C(Picture) p, C(BitmapResource) value);
LIB_EXPORT C(BitmapResource) (* Picture_get_image)(const C(Picture) p);

LIB_EXPORT C(Property) * PROPERTY(Picture, filter);
LIB_EXPORT void (* Picture_set_filter)(const C(Picture) p, C(bool) value);
LIB_EXPORT C(bool) (* Picture_get_filter)(const C(Picture) p);

LIB_EXPORT C(Property) * PROPERTY(Picture, bitmapImage);
LIB_EXPORT void (* Picture_set_bitmapImage)(const C(Picture) p, C(Bitmap) value);

LIB_EXPORT C(Property) * PROPERTY(PopupMenu, menu);
LIB_EXPORT void (* PopupMenu_set_menu)(const C(PopupMenu) p, C(Menu) value);
LIB_EXPORT C(Menu) (* PopupMenu_get_menu)(const C(PopupMenu) p);

LIB_EXPORT C(Property) * PROPERTY(PopupMenu, isMenuBar);
LIB_EXPORT void (* PopupMenu_set_isMenuBar)(const C(PopupMenu) p, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(PopupMenu, focus);
LIB_EXPORT C(bool) (* PopupMenu_get_focus)(const C(PopupMenu) p);

LIB_EXPORT C(Property) * PROPERTY(ProgressBar, progress);
LIB_EXPORT void (* ProgressBar_set_progress)(const C(ProgressBar) p, uint value);
LIB_EXPORT uint (* ProgressBar_get_progress)(const C(ProgressBar) p);

LIB_EXPORT C(Property) * PROPERTY(ProgressBar, range);
LIB_EXPORT void (* ProgressBar_set_range)(const C(ProgressBar) p, uint value);
LIB_EXPORT uint (* ProgressBar_get_range)(const C(ProgressBar) p);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, direction);
LIB_EXPORT void (* ScrollBar_set_direction)(const C(ScrollBar) s, C(ScrollDirection) value);
LIB_EXPORT C(ScrollDirection) (* ScrollBar_get_direction)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, windowOwned);
LIB_EXPORT void (* ScrollBar_set_windowOwned)(const C(ScrollBar) s, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, snap);
LIB_EXPORT void (* ScrollBar_set_snap)(const C(ScrollBar) s, C(bool) value);
LIB_EXPORT C(bool) (* ScrollBar_get_snap)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, range);
LIB_EXPORT void (* ScrollBar_set_range)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_range)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, seen);
LIB_EXPORT void (* ScrollBar_set_seen)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_seen)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, total);
LIB_EXPORT void (* ScrollBar_set_total)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_total)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, lineStep);
LIB_EXPORT void (* ScrollBar_set_lineStep)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_lineStep)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, pageStep);
LIB_EXPORT void (* ScrollBar_set_pageStep)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_pageStep)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(ScrollBar, thumbPosition);
LIB_EXPORT void (* ScrollBar_set_thumbPosition)(const C(ScrollBar) s, int value);
LIB_EXPORT int (* ScrollBar_get_thumbPosition)(const C(ScrollBar) s);

LIB_EXPORT C(Property) * PROPERTY(SelectorBar, selectedButton);
LIB_EXPORT C(SelectorButton) (* SelectorBar_get_selectedButton)(const C(SelectorBar) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, direction);
LIB_EXPORT void (* Stacker_set_direction)(const C(Stacker) s, C(ScrollDirection) value);
LIB_EXPORT C(ScrollDirection) (* Stacker_get_direction)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, gap);
LIB_EXPORT void (* Stacker_set_gap)(const C(Stacker) s, int value);
LIB_EXPORT int (* Stacker_get_gap)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, reverse);
LIB_EXPORT void (* Stacker_set_reverse)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_reverse)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, scrollable);
LIB_EXPORT void (* Stacker_set_scrollable)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_scrollable)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, controls);
LIB_EXPORT C(Array) (* Stacker_get_controls)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, flipper);
LIB_EXPORT void (* Stacker_set_flipper)(const C(Stacker) s, C(Window) value);
LIB_EXPORT C(Window) (* Stacker_get_flipper)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, flipSpring);
LIB_EXPORT void (* Stacker_set_flipSpring)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_flipSpring)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, autoSize);
LIB_EXPORT void (* Stacker_set_autoSize)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_autoSize)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, margin);
LIB_EXPORT void (* Stacker_set_margin)(const C(Stacker) s, int value);
LIB_EXPORT int (* Stacker_get_margin)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, endButtons);
LIB_EXPORT void (* Stacker_set_endButtons)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_endButtons)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(Stacker, hoverScroll);
LIB_EXPORT void (* Stacker_set_hoverScroll)(const C(Stacker) s, C(bool) value);
LIB_EXPORT C(bool) (* Stacker_get_hoverScroll)(const C(Stacker) s);

LIB_EXPORT C(Property) * PROPERTY(StatusBar, minInfoWidth);
LIB_EXPORT void (* StatusBar_set_minInfoWidth)(const C(StatusBar) s, int value);
LIB_EXPORT int (* StatusBar_get_minInfoWidth)(const C(StatusBar) s);

LIB_EXPORT C(Property) * PROPERTY(StatusField, statusBar);
LIB_EXPORT void (* StatusField_set_statusBar)(const C(StatusField) s, C(StatusBar) value);

LIB_EXPORT C(Property) * PROPERTY(StatusField, color);
LIB_EXPORT void (* StatusField_set_color)(const C(StatusField) s, C(Color) value);

LIB_EXPORT C(Property) * PROPERTY(StatusField, backColor);
LIB_EXPORT void (* StatusField_set_backColor)(const C(StatusField) s, C(ColorAlpha) value);

LIB_EXPORT C(Property) * PROPERTY(StatusField, bold);
LIB_EXPORT void (* StatusField_set_bold)(const C(StatusField) s, C(bool) value);

LIB_EXPORT C(Property) * PROPERTY(StatusField, text);
LIB_EXPORT void (* StatusField_set_text)(const C(StatusField) s, const char * value);

LIB_EXPORT C(Property) * PROPERTY(StatusField, width);
LIB_EXPORT void (* StatusField_set_width)(const C(StatusField) s, int value);

LIB_EXPORT C(Property) * PROPERTY(Tab, tabControl);
LIB_EXPORT void (* Tab_set_tabControl)(const C(Tab) t, C(TabControl) value);
LIB_EXPORT C(TabControl) (* Tab_get_tabControl)(const C(Tab) t);

LIB_EXPORT C(Property) * PROPERTY(Tab, isAdded);
LIB_EXPORT C(bool) (* Tab_get_isAdded)(const C(Tab) t);

LIB_EXPORT C(Property) * PROPERTY(TabControl, placement);
LIB_EXPORT void (* TabControl_set_placement)(const C(TabControl) t, C(TabsPlacement) value);
LIB_EXPORT C(TabsPlacement) (* TabControl_get_placement)(const C(TabControl) t);

LIB_EXPORT C(Property) * PROPERTY(TabControl, buttonsOffset);
LIB_EXPORT void (* TabControl_set_buttonsOffset)(const C(TabControl) t, int value);
LIB_EXPORT int (* TabControl_get_buttonsOffset)(const C(TabControl) t);

LIB_EXPORT C(Property) * PROPERTY(TabControl, curTab);
LIB_EXPORT void (* TabControl_set_curTab)(const C(TabControl) t, C(Tab) value);
LIB_EXPORT C(Tab) (* TabControl_get_curTab)(const C(TabControl) t);

LIB_EXPORT C(Property) * PROPERTY(ToolButton, menuItemPtr);
LIB_EXPORT void (* ToolButton_set_menuItemPtr)(const C(ToolButton) t, C(MenuItem) * value);

LIB_EXPORT C(Property) * PROPERTY(ToolButton, menuItem);
LIB_EXPORT C(MenuItem) (* ToolButton_get_menuItem)(const C(ToolButton) t);

LIB_EXPORT C(Property) * PROPERTY(ToolTip, tip);
LIB_EXPORT void (* ToolTip_set_tip)(const C(ToolTip) t, constString value);
LIB_EXPORT constString (* ToolTip_get_tip)(const C(ToolTip) t);

LIB_EXPORT C(Property) * PROPERTY(ColorPicker, color);
LIB_EXPORT void (* ColorPicker_set_color)(const C(ColorPicker) c, C(Color) value);
LIB_EXPORT C(Color) (* ColorPicker_get_color)(const C(ColorPicker) c);

LIB_EXPORT C(Property) * PROPERTY(ColorPicker, hasAlpha);
LIB_EXPORT void (* ColorPicker_set_hasAlpha)(const C(ColorPicker) c, C(bool) value);
LIB_EXPORT C(bool) (* ColorPicker_get_hasAlpha)(const C(ColorPicker) c);

LIB_EXPORT C(Property) * PROPERTY(CreateDirectoryDialog, currentDirectory);
LIB_EXPORT void (* CreateDirectoryDialog_set_currentDirectory)(const C(CreateDirectoryDialog) c, const char * value);
LIB_EXPORT const char * (* CreateDirectoryDialog_get_currentDirectory)(const C(CreateDirectoryDialog) c);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, type);
LIB_EXPORT void (* FileDialog_set_type)(const C(FileDialog) f, C(FileDialogType) value);
LIB_EXPORT C(FileDialogType) (* FileDialog_get_type)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, filePath);
LIB_EXPORT void (* FileDialog_set_filePath)(const C(FileDialog) f, const char * value);
LIB_EXPORT const char * (* FileDialog_get_filePath)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, currentDirectory);
LIB_EXPORT void (* FileDialog_set_currentDirectory)(const C(FileDialog) f, const char * value);
LIB_EXPORT const char * (* FileDialog_get_currentDirectory)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, filters);
LIB_EXPORT void (* FileDialog_set_filters)(const C(FileDialog) f, C(FileFilter) * value);
LIB_EXPORT C(FileFilter) * (* FileDialog_get_filters)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, types);
LIB_EXPORT void (* FileDialog_set_types)(const C(FileDialog) f, C(FileType) * value);
LIB_EXPORT C(FileType) * (* FileDialog_get_types)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, sizeFilters);
LIB_EXPORT void (* FileDialog_set_sizeFilters)(const C(FileDialog) f, int value);
LIB_EXPORT int (* FileDialog_get_sizeFilters)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, sizeTypes);
LIB_EXPORT void (* FileDialog_set_sizeTypes)(const C(FileDialog) f, int value);
LIB_EXPORT int (* FileDialog_get_sizeTypes)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, filter);
LIB_EXPORT void (* FileDialog_set_filter)(const C(FileDialog) f, int value);
LIB_EXPORT int (* FileDialog_get_filter)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, fileType);
LIB_EXPORT void (* FileDialog_set_fileType)(const C(FileDialog) f, int value);
LIB_EXPORT int (* FileDialog_get_fileType)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, mayNotExist);
LIB_EXPORT void (* FileDialog_set_mayNotExist)(const C(FileDialog) f, C(bool) value);
LIB_EXPORT C(bool) (* FileDialog_get_mayNotExist)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, numSelections);
LIB_EXPORT int (* FileDialog_get_numSelections)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileDialog, multiFilePaths);
LIB_EXPORT const char ** (* FileDialog_get_multiFilePaths)(const C(FileDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FileNameType, isFolderType);
LIB_EXPORT C(bool) (* FileNameType_get_isFolderType)(const C(FileNameType) f);

LIB_EXPORT C(Property) * PROPERTY(FileNameType, isFileType);
LIB_EXPORT C(bool) (* FileNameType_get_isFileType)(const C(FileNameType) f);

LIB_EXPORT C(Property) * PROPERTY(FindDialog, editBox);
LIB_EXPORT void (* FindDialog_set_editBox)(const C(FindDialog) f, C(EditBox) value);

LIB_EXPORT C(Property) * PROPERTY(FindDialog, searchString);
LIB_EXPORT void (* FindDialog_set_searchString)(const C(FindDialog) f, const char * value);
LIB_EXPORT const char * (* FindDialog_get_searchString)(const C(FindDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FindDialog, wholeWord);
LIB_EXPORT void (* FindDialog_set_wholeWord)(const C(FindDialog) f, C(bool) value);
LIB_EXPORT C(bool) (* FindDialog_get_wholeWord)(const C(FindDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FindDialog, matchCase);
LIB_EXPORT void (* FindDialog_set_matchCase)(const C(FindDialog) f, C(bool) value);
LIB_EXPORT C(bool) (* FindDialog_get_matchCase)(const C(FindDialog) f);

LIB_EXPORT C(Property) * PROPERTY(FindDialog, searchUp);
LIB_EXPORT void (* FindDialog_set_searchUp)(const C(FindDialog) f, C(bool) value);
LIB_EXPORT C(bool) (* FindDialog_get_searchUp)(const C(FindDialog) f);

LIB_EXPORT C(Property) * PROPERTY(GoToDialog, line);
LIB_EXPORT void (* GoToDialog_set_line)(const C(GoToDialog) g, int value);
LIB_EXPORT int (* GoToDialog_get_line)(const C(GoToDialog) g);

LIB_EXPORT C(Property) * PROPERTY(GoToDialog, editBox);
LIB_EXPORT void (* GoToDialog_set_editBox)(const C(GoToDialog) g, C(EditBox) value);
LIB_EXPORT C(EditBox) (* GoToDialog_get_editBox)(const C(GoToDialog) g);

LIB_EXPORT C(Property) * PROPERTY(MessageBox, type);
LIB_EXPORT void (* MessageBox_set_type)(const C(MessageBox) m, C(MessageBoxType) value);

LIB_EXPORT C(Property) * PROPERTY(MessageBox, contents);
LIB_EXPORT void (* MessageBox_set_contents)(const C(MessageBox) m, const char * value);

LIB_EXPORT C(Property) * PROPERTY(ReplaceDialog, editBox);
LIB_EXPORT void (* ReplaceDialog_set_editBox)(const C(ReplaceDialog) r, C(EditBox) value);

LIB_EXPORT C(Property) * PROPERTY(ReplaceDialog, searchString);
LIB_EXPORT void (* ReplaceDialog_set_searchString)(const C(ReplaceDialog) r, const char * value);
LIB_EXPORT const char * (* ReplaceDialog_get_searchString)(const C(ReplaceDialog) r);

LIB_EXPORT C(Property) * PROPERTY(ReplaceDialog, replaceString);
LIB_EXPORT void (* ReplaceDialog_set_replaceString)(const C(ReplaceDialog) r, const char * value);
LIB_EXPORT const char * (* ReplaceDialog_get_replaceString)(const C(ReplaceDialog) r);

LIB_EXPORT C(Property) * PROPERTY(ReplaceDialog, wholeWord);
LIB_EXPORT void (* ReplaceDialog_set_wholeWord)(const C(ReplaceDialog) r, C(bool) value);
LIB_EXPORT C(bool) (* ReplaceDialog_get_wholeWord)(const C(ReplaceDialog) r);

LIB_EXPORT C(Property) * PROPERTY(ReplaceDialog, matchCase);
LIB_EXPORT void (* ReplaceDialog_set_matchCase)(const C(ReplaceDialog) r, C(bool) value);
LIB_EXPORT C(bool) (* ReplaceDialog_get_matchCase)(const C(ReplaceDialog) r);

LIB_EXPORT C(Property) * PROPERTY(HTTPFile, reuseConnection);
LIB_EXPORT void (* HTTPFile_set_reuseConnection)(const C(HTTPFile) h, C(bool) value);
LIB_EXPORT C(bool) (* HTTPFile_get_reuseConnection)(const C(HTTPFile) h);

LIB_EXPORT C(Property) * PROPERTY(HTTPFile, contentType);
LIB_EXPORT C(String) (* HTTPFile_get_contentType)(const C(HTTPFile) h);

LIB_EXPORT C(Property) * PROPERTY(HTTPFile, contentDisposition);
LIB_EXPORT C(String) (* HTTPFile_get_contentDisposition)(const C(HTTPFile) h);

LIB_EXPORT C(Property) * PROPERTY(HTTPFile, httpCode);
LIB_EXPORT int (* HTTPFile_get_httpCode)(const C(HTTPFile) h);

LIB_EXPORT C(Property) * PROPERTY(SSLSocket, autoEstablish);
LIB_EXPORT void (* SSLSocket_set_autoEstablish)(const C(SSLSocket) s, C(bool) value);
LIB_EXPORT C(bool) (* SSLSocket_get_autoEstablish)(const C(SSLSocket) s);

LIB_EXPORT C(Property) * PROPERTY(Service, port);
LIB_EXPORT void (* Service_set_port)(const C(Service) s, int value);
LIB_EXPORT int (* Service_get_port)(const C(Service) s);

LIB_EXPORT C(Property) * PROPERTY(Service, firstClient);
LIB_EXPORT C(Socket) (* Service_get_firstClient)(const C(Service) s);

LIB_EXPORT C(Property) * PROPERTY(Service, processAlone);
LIB_EXPORT void (* Service_set_processAlone)(const C(Service) s, C(bool) value);
LIB_EXPORT C(bool) (* Service_get_processAlone)(const C(Service) s);

LIB_EXPORT C(Property) * PROPERTY(Service, started);
LIB_EXPORT C(bool) (* Service_get_started)(const C(Service) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, service);
LIB_EXPORT void (* Socket_set_service)(const C(Socket) s, C(Service) value);
LIB_EXPORT C(Service) (* Socket_get_service)(const C(Socket) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, inetAddress);
LIB_EXPORT const char * (* Socket_get_inetAddress)(const C(Socket) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, inetPort);
LIB_EXPORT int (* Socket_get_inetPort)(const C(Socket) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, next);
LIB_EXPORT C(Socket) (* Socket_get_next)(const C(Socket) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, connected);
LIB_EXPORT C(bool) (* Socket_get_connected)(const C(Socket) s);

LIB_EXPORT C(Property) * PROPERTY(Socket, processAlone);
LIB_EXPORT void (* Socket_set_processAlone)(const C(Socket) s, C(bool) value);
LIB_EXPORT C(bool) (* Socket_get_processAlone)(const C(Socket) s);
...
LIB_EXPORT void (* RepButton_set_delay)(const C(RepButton) r, C(Time) value);

LIB_EXPORT C(Property) * PROPERTY(RepButton, delay0);
LIB_EXPORT void (* RepButton_set_delay0)(const C(RepButton) r, C(Time) value);
...
LIB_EXPORT C(Class) * CO(BlockEntry);
LIB_EXPORT C(Class) * CO(DefaultShaderBits);
LIB_EXPORT C(Class) * CO(ShaderModifiedUniforms);
...
// enumClass
LIB_EXPORT C(Class) * CO(GLTextureFilter);
LIB_EXPORT C(Class) * CO(Alignment);
...
LIB_EXPORT C(Class) * CO(GLSamplesCount);
...
LIB_EXPORT C(Class) * CO(GLAttribMode);
LIB_EXPORT C(Class) * CO(GLBType);
...
LIB_EXPORT C(Class) * CO(EulerRotationOrder);
...
// systemClass
// structClass
LIB_EXPORT C(Class) * CO(FreeSpots);
LIB_EXPORT C(Class) * CO(GLArrayTexture);
LIB_EXPORT C(Class) * CO(GLDrawCommand);
LIB_EXPORT C(Class) * CO(GLMultiDraw);
...
LIB_EXPORT C(Class) * CO(DrawSlot);
...
LIB_EXPORT C(Class) * CO(PNGOptions);
LIB_EXPORT C(Class) * CO(GLAB);
LIB_EXPORT C(Class) * CO(GLB);
LIB_EXPORT C(Class) * CO(GLCAB);
LIB_EXPORT C(Class) * CO(GLEAB);
LIB_EXPORT C(Class) * CO(GLFB);
LIB_EXPORT C(Class) * CO(Euler);
LIB_EXPORT C(Class) * CO(FrameKey);
LIB_EXPORT C(Class) * CO(Line);
LIB_EXPORT C(Class) * CO(Matrix);
LIB_EXPORT C(Class) * CO(Matrixf);
LIB_EXPORT C(Class) * CO(MeshMorph);
LIB_EXPORT C(Class) * CO(MeshPart);
LIB_EXPORT C(Class) * CO(Plane);
LIB_EXPORT C(Class) * CO(PrimitiveSingle);
LIB_EXPORT C(Class) * CO(Quaternion);
LIB_EXPORT C(Class) * CO(SkinBone);
LIB_EXPORT C(Class) * CO(SkinVert);
...
LIB_EXPORT C(Class) * CO(DataFieldSort);
...
LIB_EXPORT C(Class) * CO(DrawList);
...
LIB_EXPORT C(Class) * CO(FreeBlockMap);
LIB_EXPORT C(Class) * CO(GLMB);
LIB_EXPORT C(Class) * CO(GLStats);
LIB_EXPORT C(Class) * CO(LFBDisplayDriver);
LIB_EXPORT C(Class) * CO(Shader);
LIB_EXPORT C(Class) * CO(Camera);
LIB_EXPORT C(Class) * CO(MeshSkin);
...
LIB_EXPORT C(Class) * CO(EditSyntaxHL);
...
LIB_EXPORT int M_VTBLID(DisplayDriver, setCameraVR);
...
LIB_EXPORT int M_VTBLID(DisplayDriver, stretchf);
...
LIB_EXPORT int M_VTBLID(FreeBlockMap, onExpand);
...
LIB_EXPORT int M_VTBLID(Shader, setupDrawCommand);
LIB_EXPORT int M_VTBLID(Shader, updateMatrix);
LIB_EXPORT int M_VTBLID(Shader, uploadUniforms);

LIB_EXPORT int M_VTBLID(ObjectFormat, load);
LIB_EXPORT int M_VTBLID(ObjectFormat, save);
LIB_EXPORT int M_VTBLID(ObjectFormat, listTextures);
...
LIB_EXPORT int M_VTBLID(EditSyntaxHL, canImpactOtherLines);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, figureStartSyntaxStates);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, gotSpace);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, initDraw);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, nextLine);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, parseWord);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, process);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, resetState);
LIB_EXPORT int M_VTBLID(EditSyntaxHL, startLine);
...
LIB_EXPORT void (* F(gLMultisampling))(C(bool) value);
LIB_EXPORT int (* F(bestColorMatch))(C(ColorAlpha) * palette, int start, int end, C(Color) rgb);
LIB_EXPORT byte (* F(getColorDepthShifts))(C(PixelFormat) format);
LIB_EXPORT C(Material) * (* F(getDefaultMaterial))(void);
LIB_EXPORT C(ColorAlpha) * (* F(getDefaultPalette))(void);
LIB_EXPORT int (* F(getDepthBits))(C(PixelFormat) colorDepth);
LIB_EXPORT int (* F(getResolutionHeight))(C(Resolution) resolution);
LIB_EXPORT int (* F(getResolutionWidth))(C(Resolution) resolution);
LIB_EXPORT C(Map) (* F(listAvailableFonts))(void);
LIB_EXPORT C(ColorAlpha) * (* F(loadPalette))(const char * fileName, const char * type);
LIB_EXPORT void (* F(paletteGradient))(C(ColorAlpha) * palette, int numColors, C(ColorKey) * keys, int numKeys, float smoothness);
LIB_EXPORT C(FaceInfo) * (* F(resolveCharFont))(constString faceName, float size, C(FontFlags) flags, constString lang, unichar testChar);
LIB_EXPORT C(Array) (* F(resolveFont))(constString faceName, float size, C(FontFlags) flags);
LIB_EXPORT void (* F(setPrintingDocumentName))(constString name);
LIB_EXPORT void (* F(gLABBindBuffer))(int target, uint buffer);
LIB_EXPORT void (* F(gLABBindVertexArray))(uint vao);
LIB_EXPORT void (* F(gLSetupFog))(C(bool) enable);
LIB_EXPORT void (* F(gLSetupLighting))(C(bool) enable);
LIB_EXPORT void (* F(gLSetupTexturing))(C(bool) enable);
LIB_EXPORT void (* F(useSingleGLContext))(C(bool) useSingle);
LIB_EXPORT void (* F(glimtkBegin))(C(GLIMTKMode) mode);
LIB_EXPORT void (* F(glimtkColor3f))(float r, float g, float b);
LIB_EXPORT void (* F(glimtkColor4f))(float r, float g, float b, float a);
LIB_EXPORT void (* F(glimtkColor4fv))(float * a);
LIB_EXPORT void (* F(glimtkColor4ub))(byte r, byte g, byte b, byte a);
LIB_EXPORT void (* F(glimtkEnd))(void);
LIB_EXPORT void (* F(glimtkNormal3d))(double x, double y, double z);
LIB_EXPORT void (* F(glimtkNormal3f))(float x, float y, float z);
LIB_EXPORT void (* F(glimtkNormal3fd))(double * coords);
LIB_EXPORT void (* F(glimtkNormal3fv))(float * coords);
LIB_EXPORT void (* F(glimtkRecti))(int a, int b, int c, int d);
LIB_EXPORT void (* F(glimtkTexCoord2d))(double x, double y);
LIB_EXPORT void (* F(glimtkTexCoord2f))(float x, float y);
LIB_EXPORT void (* F(glimtkTexCoord2fv))(float * a);
LIB_EXPORT void (* F(glimtkTexCoord2i))(int x, int y);
LIB_EXPORT void (* F(glimtkVertex2d))(double x, double y);
LIB_EXPORT void (* F(glimtkVertex2f))(float x, float y);
LIB_EXPORT void (* F(glimtkVertex2i))(int x, int y);
LIB_EXPORT void (* F(glimtkVertex3d))(double x, double y, double z);
LIB_EXPORT void (* F(glimtkVertex3dv))(double * coords);
LIB_EXPORT void (* F(glimtkVertex3f))(float x, float y, float z);
LIB_EXPORT void (* F(glimtkVertex3fv))(float * coords);
LIB_EXPORT void (* F(glmsFlushMatrices))(void);
LIB_EXPORT void (* F(glmsFrustum))(double l, double r, double b, double t, double n, double f);
LIB_EXPORT void (* F(glmsGetDoublev))(C(GLMSWhatToGet) what, double * i);
LIB_EXPORT double (* F(glmsGetNearPlane))(void);
LIB_EXPORT void (* F(glmsLoadIdentity))(void);
LIB_EXPORT void (* F(glmsLoadMatrix))(C(Matrix) * matrix);
LIB_EXPORT void (* F(glmsLoadMatrixd))(double * i);
LIB_EXPORT void (* F(glmsLoadMatrixf))(float * i);
LIB_EXPORT void (* F(glmsMatrixMode))(C(MatrixMode) mode);
LIB_EXPORT void (* F(glmsMultMatrixd))(double * i);
LIB_EXPORT void (* F(glmsMultMatrixf))(float * i);
LIB_EXPORT void (* F(glmsOrtho))(double l, double r, double b, double t, double n, double f);
LIB_EXPORT void (* F(glmsPopMatrix))(void);
LIB_EXPORT void (* F(glmsPushMatrix))(void);
LIB_EXPORT void (* F(glmsRotated))(double angle, double x, double y, double z);
LIB_EXPORT void (* F(glmsScaled))(double a, double b, double c);
LIB_EXPORT void (* F(glmsSetNearPlane))(double value);
LIB_EXPORT void (* F(glmsTranslated))(double a, double b, double c);
LIB_EXPORT void (* F(glsupLightModeli))(uint pname, int param);
LIB_EXPORT void (* F(glsupLineStipple))(int i, uint16 j);
LIB_EXPORT float (* F(fastInvSqrt))(float x);
LIB_EXPORT double (* F(fastInvSqrtDouble))(double x);
LIB_EXPORT void (* F(applySkin))(C(Class) * c, const char * name, void ** vTbl);
LIB_EXPORT C(bool) (* F(desktop3DFullScreen))(C(Window) window);
LIB_EXPORT void (* F(desktop3DGetClipBox))(C(Box) * box);
LIB_EXPORT C(Window) (* F(desktop3DGetClippedWindow))(void);
LIB_EXPORT void * (* F(desktop3DGetWindowHandle))(C(Window) window);
LIB_EXPORT void (* F(desktop3DInitialize))(C(Window) window, void (* setup)(C(Window) window, int w, int h), void (* update)(C(Window) window, C(Box) * box));
LIB_EXPORT C(bool) (* F(desktop3DMouseMessage))(C(Window) window, uint method, int x, int y, C(Modifiers) * mods, C(bool) consequential, C(bool) activate);
LIB_EXPORT void (* F(desktop3DSetDesktopDirty))(void);
LIB_EXPORT C(bool) (* F(desktop3DTitleBarClicked))(C(Window) clickedWindow, int x, int y);
LIB_EXPORT C(bool) (* F(desktop3DUpdateDisplay))(void);
LIB_EXPORT void (* F(queryCompass))(C(Euler) * value);
LIB_EXPORT void (* F(unapplySkin))(C(Class) * c);
LIB_EXPORT C(FileServerConnection) (* F(connectToFileServer))(const char * hostName, int port);
LIB_EXPORT C(HTTPFile) (* F(fileOpenURL))(const char * name);
LIB_EXPORT C(bool) (* F(getAddressFromName))(const char * hostName, char * inetAddress);
LIB_EXPORT C(bool) (* F(getHostName))(char * hostName, int size);
LIB_EXPORT C(bool) (* F(getNameFromAddress))(const char * inetAddress, char * hostName);
LIB_EXPORT C(bool) (* F(setCurlEmbeddedCA))(void * curlHandle);
...
LIB_EXPORT C(Module) ecere_init(C(Module) fromModule)
{
   ...
   if(module)
   {
      ...
      CO(FreeSpots) = eC_findClass(module, "FreeSpots");
      if(CO(FreeSpots))
      {
         METHOD(FreeSpots, init) = Class_findMethod(CO(FreeSpots), "init", module);
         if(METHOD(FreeSpots, init))
            FreeSpots_init = (void (*)(C(FreeSpots) *, uint))METHOD(FreeSpots, init)->function;

         METHOD(FreeSpots, markFree) = Class_findMethod(CO(FreeSpots), "markFree", module);
         if(METHOD(FreeSpots, markFree))
            FreeSpots_markFree = (void (*)(C(FreeSpots) *, int))METHOD(FreeSpots, markFree)->function;

         METHOD(FreeSpots, next) = Class_findMethod(CO(FreeSpots), "next", module);
         if(METHOD(FreeSpots, next))
            FreeSpots_next = (int (*)(C(FreeSpots) *))METHOD(FreeSpots, next)->function;

         METHOD(FreeSpots, resize) = Class_findMethod(CO(FreeSpots), "resize", module);
         if(METHOD(FreeSpots, resize))
            FreeSpots_resize = (void (*)(C(FreeSpots) *, uint))METHOD(FreeSpots, resize)->function;
      }
      CO(GLArrayTexture) = eC_findClass(module, "GLArrayTexture");
      if(CO(GLArrayTexture))
      {
         METHOD(GLArrayTexture, _init) = Class_findMethod(CO(GLArrayTexture), "_init", module);
         if(METHOD(GLArrayTexture, _init))
            GLArrayTexture__init = (void (*)(C(GLArrayTexture) *, int, int, int, int, int, C(bool)))METHOD(GLArrayTexture, _init)->function;

         METHOD(GLArrayTexture, allocateLayer) = Class_findMethod(CO(GLArrayTexture), "allocateLayer", module);
         if(METHOD(GLArrayTexture, allocateLayer))
            GLArrayTexture_allocateLayer = (int (*)(C(GLArrayTexture) *, uint))METHOD(GLArrayTexture, allocateLayer)->function;

         METHOD(GLArrayTexture, bind) = Class_findMethod(CO(GLArrayTexture), "bind", module);
         if(METHOD(GLArrayTexture, bind))
            GLArrayTexture_bind = (void (*)(C(GLArrayTexture) *))METHOD(GLArrayTexture, bind)->function;

         METHOD(GLArrayTexture, copy) = Class_findMethod(CO(GLArrayTexture), "copy", module);
         if(METHOD(GLArrayTexture, copy))
            GLArrayTexture_copy = (void (*)(C(GLArrayTexture) *, C(GLArrayTexture) *, uint))METHOD(GLArrayTexture, copy)->function;

         METHOD(GLArrayTexture, free) = Class_findMethod(CO(GLArrayTexture), "free", module);
         if(METHOD(GLArrayTexture, free))
            GLArrayTexture_free = (void (*)(C(GLArrayTexture) *))METHOD(GLArrayTexture, free)->function;

         METHOD(GLArrayTexture, freeLayer) = Class_findMethod(CO(GLArrayTexture), "freeLayer", module);
         if(METHOD(GLArrayTexture, freeLayer))
            GLArrayTexture_freeLayer = (void (*)(C(GLArrayTexture) *, int))METHOD(GLArrayTexture, freeLayer)->function;

         METHOD(GLArrayTexture, init) = Class_findMethod(CO(GLArrayTexture), "init", module);
         if(METHOD(GLArrayTexture, init))
            GLArrayTexture_init = (void (*)(C(GLArrayTexture) *, int, int, int, int))METHOD(GLArrayTexture, init)->function;

         METHOD(GLArrayTexture, initMaxLevel) = Class_findMethod(CO(GLArrayTexture), "initMaxLevel", module);
         if(METHOD(GLArrayTexture, initMaxLevel))
            GLArrayTexture_initMaxLevel = (void (*)(C(GLArrayTexture) *, int, int, int, int))METHOD(GLArrayTexture, initMaxLevel)->function;

         METHOD(GLArrayTexture, initRGBAUShort) = Class_findMethod(CO(GLArrayTexture), "initRGBAUShort", module);
         if(METHOD(GLArrayTexture, initRGBAUShort))
            GLArrayTexture_initRGBAUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int))METHOD(GLArrayTexture, initRGBAUShort)->function;

         METHOD(GLArrayTexture, initRGBUShort) = Class_findMethod(CO(GLArrayTexture), "initRGBUShort", module);
         if(METHOD(GLArrayTexture, initRGBUShort))
            GLArrayTexture_initRGBUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int))METHOD(GLArrayTexture, initRGBUShort)->function;

         METHOD(GLArrayTexture, initUShort) = Class_findMethod(CO(GLArrayTexture), "initUShort", module);
         if(METHOD(GLArrayTexture, initUShort))
            GLArrayTexture_initUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int))METHOD(GLArrayTexture, initUShort)->function;

         METHOD(GLArrayTexture, resize) = Class_findMethod(CO(GLArrayTexture), "resize", module);
         if(METHOD(GLArrayTexture, resize))
            GLArrayTexture_resize = (void (*)(C(GLArrayTexture) *, uint, uint))METHOD(GLArrayTexture, resize)->function;

         METHOD(GLArrayTexture, set1x1Layer) = Class_findMethod(CO(GLArrayTexture), "set1x1Layer", module);
         if(METHOD(GLArrayTexture, set1x1Layer))
            GLArrayTexture_set1x1Layer = (void (*)(C(GLArrayTexture) *, int, C(ColorAlpha), uint))METHOD(GLArrayTexture, set1x1Layer)->function;

         METHOD(GLArrayTexture, setFilter) = Class_findMethod(CO(GLArrayTexture), "setFilter", module);
         if(METHOD(GLArrayTexture, setFilter))
            GLArrayTexture_setFilter = (void (*)(C(GLArrayTexture) *, C(GLTextureFilter), C(GLTextureFilter)))METHOD(GLArrayTexture, setFilter)->function;

         METHOD(GLArrayTexture, setLayer) = Class_findMethod(CO(GLArrayTexture), "setLayer", module);
         if(METHOD(GLArrayTexture, setLayer))
            GLArrayTexture_setLayer = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uint))METHOD(GLArrayTexture, setLayer)->function;

         METHOD(GLArrayTexture, setLayerCompressed) = Class_findMethod(CO(GLArrayTexture), "setLayerCompressed", module);
         if(METHOD(GLArrayTexture, setLayerCompressed))
            GLArrayTexture_setLayerCompressed = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uintsize, uint))METHOD(GLArrayTexture, setLayerCompressed)->function;

         METHOD(GLArrayTexture, setLayerFormat) = Class_findMethod(CO(GLArrayTexture), "setLayerFormat", module);
         if(METHOD(GLArrayTexture, setLayerFormat))
            GLArrayTexture_setLayerFormat = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uint, int, int))METHOD(GLArrayTexture, setLayerFormat)->function;

         METHOD(GLArrayTexture, setLayerRGBAUShort) = Class_findMethod(CO(GLArrayTexture), "setLayerRGBAUShort", module);
         if(METHOD(GLArrayTexture, setLayerRGBAUShort))
            GLArrayTexture_setLayerRGBAUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uint))METHOD(GLArrayTexture, setLayerRGBAUShort)->function;

         METHOD(GLArrayTexture, setLayerRGBUShort) = Class_findMethod(CO(GLArrayTexture), "setLayerRGBUShort", module);
         if(METHOD(GLArrayTexture, setLayerRGBUShort))
            GLArrayTexture_setLayerRGBUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uint))METHOD(GLArrayTexture, setLayerRGBUShort)->function;

         METHOD(GLArrayTexture, setLayerUShort) = Class_findMethod(CO(GLArrayTexture), "setLayerUShort", module);
         if(METHOD(GLArrayTexture, setLayerUShort))
            GLArrayTexture_setLayerUShort = (void (*)(C(GLArrayTexture) *, int, int, int, int, byte *, uint))METHOD(GLArrayTexture, setLayerUShort)->function;
      }
      CO(GLDrawCommand) = eC_findClass(module, "GLDrawCommand");
      CO(GLMultiDraw) = eC_findClass(module, "GLMultiDraw");
      if(CO(GLMultiDraw))
      {
         METHOD(GLMultiDraw, addDrawCommand) = Class_findMethod(CO(GLMultiDraw), "addDrawCommand", module);
         if(METHOD(GLMultiDraw, addDrawCommand))
            GLMultiDraw_addDrawCommand = (void (*)(C(GLMultiDraw) *, uint, uint, uint, uint, uint))METHOD(GLMultiDraw, addDrawCommand)->function;

         METHOD(GLMultiDraw, addDrawCommandCustomID) = Class_findMethod(CO(GLMultiDraw), "addDrawCommandCustomID", module);
         if(METHOD(GLMultiDraw, addDrawCommandCustomID))
            GLMultiDraw_addDrawCommandCustomID = (void (*)(C(GLMultiDraw) *, uint, uint, uint, uint, uint, uint))METHOD(GLMultiDraw, addDrawCommandCustomID)->function;

         METHOD(GLMultiDraw, allocateIx) = Class_findMethod(CO(GLMultiDraw), "allocateIx", module);
         if(METHOD(GLMultiDraw, allocateIx))
            GLMultiDraw_allocateIx = (int (*)(C(GLMultiDraw) *, uint, uint, const void *))METHOD(GLMultiDraw, allocateIx)->function;

         METHOD(GLMultiDraw, allocateVbo) = Class_findMethod(CO(GLMultiDraw), "allocateVbo", module);
         if(METHOD(GLMultiDraw, allocateVbo))
            GLMultiDraw_allocateVbo = (int (*)(C(GLMultiDraw) *, uint, uint, const void *))METHOD(GLMultiDraw, allocateVbo)->function;

         METHOD(GLMultiDraw, draw) = Class_findMethod(CO(GLMultiDraw), "draw", module);
         if(METHOD(GLMultiDraw, draw))
            GLMultiDraw_draw = (void (*)(C(GLMultiDraw) *))METHOD(GLMultiDraw, draw)->function;

         METHOD(GLMultiDraw, free) = Class_findMethod(CO(GLMultiDraw), "free", module);
         if(METHOD(GLMultiDraw, free))
            GLMultiDraw_free = (void (*)(C(GLMultiDraw) *))METHOD(GLMultiDraw, free)->function;

         METHOD(GLMultiDraw, freeIx) = Class_findMethod(CO(GLMultiDraw), "freeIx", module);
         if(METHOD(GLMultiDraw, freeIx))
            GLMultiDraw_freeIx = (void (*)(C(GLMultiDraw) *, int, uint, uint))METHOD(GLMultiDraw, freeIx)->function;

         METHOD(GLMultiDraw, freeVbo) = Class_findMethod(CO(GLMultiDraw), "freeVbo", module);
         if(METHOD(GLMultiDraw, freeVbo))
            GLMultiDraw_freeVbo = (void (*)(C(GLMultiDraw) *, int, uint, uint))METHOD(GLMultiDraw, freeVbo)->function;

         METHOD(GLMultiDraw, init) = Class_findMethod(CO(GLMultiDraw), "init", module);
         if(METHOD(GLMultiDraw, init))
            GLMultiDraw_init = (void (*)(C(GLMultiDraw) *, C(GLIMTKMode), uint))METHOD(GLMultiDraw, init)->function;

         METHOD(GLMultiDraw, prepare) = Class_findMethod(CO(GLMultiDraw), "prepare", module);
         if(METHOD(GLMultiDraw, prepare))
            GLMultiDraw_prepare = (void (*)(C(GLMultiDraw) *, int, int))METHOD(GLMultiDraw, prepare)->function;

         METHOD(GLMultiDraw, printStats) = Class_findMethod(CO(GLMultiDraw), "printStats", module);
         if(METHOD(GLMultiDraw, printStats))
            GLMultiDraw_printStats = (void (*)(C(GLMultiDraw) *))METHOD(GLMultiDraw, printStats)->function;

         METHOD(GLMultiDraw, resize) = Class_findMethod(CO(GLMultiDraw), "resize", module);
         if(METHOD(GLMultiDraw, resize))
            GLMultiDraw_resize = (void (*)(C(GLMultiDraw) *, uint))METHOD(GLMultiDraw, resize)->function;

         METHOD(GLMultiDraw, resizeCommands) = Class_findMethod(CO(GLMultiDraw), "resizeCommands", module);
         if(METHOD(GLMultiDraw, resizeCommands))
            GLMultiDraw_resizeCommands = (void (*)(C(GLMultiDraw) *, uint))METHOD(GLMultiDraw, resizeCommands)->function;

         METHOD(GLMultiDraw, resizeIDs) = Class_findMethod(CO(GLMultiDraw), "resizeIDs", module);
         if(METHOD(GLMultiDraw, resizeIDs))
            GLMultiDraw_resizeIDs = (void (*)(C(GLMultiDraw) *, uint))METHOD(GLMultiDraw, resizeIDs)->function;

         PROPERTY(GLMultiDraw, ix32) = Class_findProperty(CO(GLMultiDraw), "ix32", module);
         if(PROPERTY(GLMultiDraw, ix32))
            GLMultiDraw_set_ix32 = (void *)PROPERTY(GLMultiDraw, ix32)->Set;
      }
      CO(GLTextureFilter) = eC_findClass(module, "GLTextureFilter");
      CO(Alignment) = eC_findClass(module, "Alignment");
      ...
      if(CO(Bitmap))
      {
         ...
         METHOD(Bitmap, copy2) = Class_findMethod(CO(Bitmap), "Copy2", module);
         if(METHOD(Bitmap, copy2))
            Bitmap_copy2 = (C(bool) (*)(C(Bitmap), C(Bitmap), C(bool)))METHOD(Bitmap, copy2)->function;
         ...
         METHOD(Bitmap, processDD) = Class_findMethod(CO(Bitmap), "ProcessDD", module);
         if(METHOD(Bitmap, processDD))
            Bitmap_processDD = (C(Bitmap) (*)(C(Bitmap), C(bool), uint, C(bool), int, C(bool), int, int))METHOD(Bitmap, processDD)->function;
      ...
      if(CO(CubeMap))
      {
         ...
         METHOD(CubeMap, loadFromFiles) = Class_findMethod(CO(CubeMap), "LoadFromFiles", module);
         if(METHOD(CubeMap, loadFromFiles))
            CubeMap_loadFromFiles = (C(bool) (*)(C(CubeMap), C(DisplaySystem), C(File) [], constString, C(bool)))METHOD(CubeMap, loadFromFiles)->function;
      }
      ...
      if(CO(Display))
      {
         ...
         METHOD(Display, drawMeshEx) = Class_findMethod(CO(Display), "DrawMeshEx", module);
         if(METHOD(Display, drawMeshEx))
            Display_drawMeshEx = (C(bool) (*)(C(Display), C(Object) *, uint64 *))METHOD(Display, drawMeshEx)->function;
         ...
         METHOD(Display, drawObjectEx) = Class_findMethod(CO(Display), "DrawObjectEx", module);
         if(METHOD(Display, drawObjectEx))
            Display_drawObjectEx = (C(bool) (*)(C(Display), C(Object) *, uint64 *))METHOD(Display, drawObjectEx)->function;
         ...
         if(METHOD(Display, setCamera))
            Display_setCamera = (void (*)(C(Display), C(Surface), const C(Camera)))METHOD(Display, setCamera)->function;

         METHOD(Display, setCameraVR) = Class_findMethod(CO(Display), "SetCameraVR", module);
         if(METHOD(Display, setCameraVR))
            Display_setCameraVR = (void (*)(C(Display), C(Camera), int, int, int, C(GLFB) *, const C(Matrix) *))METHOD(Display, setCameraVR)->function;
         ...
         PROPERTY(Display, maxFullSort) = Class_findProperty(CO(Display), "maxFullSort", module);
         if(PROPERTY(Display, maxFullSort))
         {
            Display_set_maxFullSort = (void *)PROPERTY(Display, maxFullSort)->Set;
            Display_get_maxFullSort = (void *)PROPERTY(Display, maxFullSort)->Get;
         }

         PROPERTY(Display, fullProjCheck) = Class_findProperty(CO(Display), "fullProjCheck", module);
         if(PROPERTY(Display, fullProjCheck))
         {
            Display_set_fullProjCheck = (void *)PROPERTY(Display, fullProjCheck)->Set;
            Display_get_fullProjCheck = (void *)PROPERTY(Display, fullProjCheck)->Get;
         }
         ...
         PROPERTY(Display, glVersion) = Class_findProperty(CO(Display), "glVersion", module);
         if(PROPERTY(Display, glVersion))
            Display_get_glVersion = (void *)PROPERTY(Display, glVersion)->Get;
      }
      ...
      if(CO(DisplayDriver))
      {
         ...
         METHOD(DisplayDriver, setCameraVR) = Class_findMethod(CO(DisplayDriver), "SetCameraVR", module);
         if(METHOD(DisplayDriver, setCameraVR))
            M_VTBLID(DisplayDriver, setCameraVR) = METHOD(DisplayDriver, setCameraVR)->vid;
         ...
         METHOD(DisplayDriver, stretchf) = Class_findMethod(CO(DisplayDriver), "Stretchf", module);
         if(METHOD(DisplayDriver, stretchf))
            M_VTBLID(DisplayDriver, stretchf) = METHOD(DisplayDriver, stretchf)->vid;
      ...
      CO(DrawList) = eC_findClass(module, "DrawList");
      if(CO(DrawList))
      {
         METHOD(DrawList, addObject) = Class_findMethod(CO(DrawList), "addObject", module);
         if(METHOD(DrawList, addObject))
            DrawList_addObject = (void (*)(C(DrawList), C(Object) *))METHOD(DrawList, addObject)->function;

         METHOD(DrawList, init) = Class_findMethod(CO(DrawList), "init", module);
         if(METHOD(DrawList, init))
            DrawList_init = (void (*)(C(DrawList), C(Matrix) *, C(Matrix) *, C(Vector3D) *, C(Plane) *, C(Plane) *, int))METHOD(DrawList, init)->function;

         METHOD(DrawList, prepare) = Class_findMethod(CO(DrawList), "prepare", module);
         if(METHOD(DrawList, prepare))
            DrawList_prepare = (void (*)(C(DrawList)))METHOD(DrawList, prepare)->function;

         METHOD(DrawList, render) = Class_findMethod(CO(DrawList), "render", module);
         if(METHOD(DrawList, render))
            DrawList_render = (void (*)(C(DrawList), C(Display)))METHOD(DrawList, render)->function;
      }
      ...
      CO(DrawSlot) = eC_findClass(module, "DrawSlot");
      ...
      CO(GLSamplesCount) = eC_findClass(module, "GLSamplesCount");
      ...
      if(CO(Surface))
      {
         ...
         if(METHOD(Surface, drawingChar))
            Surface_drawingChar = (void (*)(C(Surface), byte))METHOD(Surface, drawingChar)->function;
         ...
         METHOD(Surface, stretchf) = Class_findMethod(CO(Surface), "Stretchf", module);
         if(METHOD(Surface, stretchf))
            Surface_stretchf = (void (*)(C(Surface), C(Bitmap), float, float, float, float, float, float, float, float))METHOD(Surface, stretchf)->function;
         ...
         PROPERTY(Surface, blackTint) = Class_findProperty(CO(Surface), "blackTint", module);
         if(PROPERTY(Surface, blackTint))
         {
            Surface_set_blackTint = (void *)PROPERTY(Surface, blackTint)->Set;
            Surface_get_blackTint = (void *)PROPERTY(Surface, blackTint)->Get;
         }
      ...
      CO(PNGOptions) = eC_findClass(module, "PNGOptions");
      CO(BlockEntry) = eC_findClass(module, "BlockEntry");
      ...
      if(CO(DefaultShader))
      {
         ...
         METHOD(DefaultShader, setBoneMatrices) = Class_findMethod(CO(DefaultShader), "setBoneMatrices", module);
         if(METHOD(DefaultShader, setBoneMatrices))
            DefaultShader_setBoneMatrices = (void (*)(C(DefaultShader), int, const C(Matrixf) *))METHOD(DefaultShader, setBoneMatrices)->function;
         ...
         if(METHOD(DefaultShader, shader))
            DefaultShader_shader = (C(DefaultShader) (*)(void))METHOD(DefaultShader, shader)->function;
         ...
         METHOD(DefaultShader, useExternalTexture) = Class_findMethod(CO(DefaultShader), "useExternalTexture", module);
         if(METHOD(DefaultShader, useExternalTexture))
            DefaultShader_useExternalTexture = (void (*)(C(DefaultShader), C(bool)))METHOD(DefaultShader, useExternalTexture)->function;

         PROPERTY(DefaultShader, blackTint) = Class_findProperty(CO(DefaultShader), "blackTint", module);
         if(PROPERTY(DefaultShader, blackTint))
            DefaultShader_set_blackTint = (void *)PROPERTY(DefaultShader, blackTint)->Set;
      }
      CO(DefaultShaderBits) = eC_findClass(module, "DefaultShaderBits");
      CO(FreeBlockMap) = eC_findClass(module, "FreeBlockMap");
      if(CO(FreeBlockMap))
      {
         METHOD(FreeBlockMap, allocate) = Class_findMethod(CO(FreeBlockMap), "allocate", module);
         if(METHOD(FreeBlockMap, allocate))
            FreeBlockMap_allocate = (C(BlockEntry) (*)(C(FreeBlockMap), C(GLBType), uint))METHOD(FreeBlockMap, allocate)->function;

         METHOD(FreeBlockMap, freeBlock) = Class_findMethod(CO(FreeBlockMap), "freeBlock", module);
         if(METHOD(FreeBlockMap, freeBlock))
            FreeBlockMap_freeBlock = (void (*)(C(FreeBlockMap), C(BlockEntry)))METHOD(FreeBlockMap, freeBlock)->function;

         METHOD(FreeBlockMap, onExpand) = Class_findMethod(CO(FreeBlockMap), "onExpand", module);
         if(METHOD(FreeBlockMap, onExpand))
            M_VTBLID(FreeBlockMap, onExpand) = METHOD(FreeBlockMap, onExpand)->vid;
      }
      ...
      if(CO(GLAB))
      {
         ...
         if(METHOD(GLAB, use))
            GLAB_use = (void (*)(C(GLAB) *, C(GLBufferContents), int, int, uint, C(GLAttribMode), const void *))METHOD(GLAB, use)->function;

         METHOD(GLAB, useVertTrans) = Class_findMethod(CO(GLAB), "useVertTrans", module);
         if(METHOD(GLAB, useVertTrans))
            GLAB_useVertTrans = (void (*)(C(GLAB) *, uint, int, int, uint, C(GLAttribMode), const void *))METHOD(GLAB, useVertTrans)->function;
      }
      CO(GLAttribMode) = eC_findClass(module, "GLAttribMode");
      CO(GLB) = eC_findClass(module, "GLB");
      if(CO(GLB))
      {
         METHOD(GLB, _allocate) = Class_findMethod(CO(GLB), "_allocate", module);
         if(METHOD(GLB, _allocate))
            GLB__allocate = (C(bool) (*)(C(GLB) *, C(GLBType), uint, const void *, C(GLBufferUsage)))METHOD(GLB, _allocate)->function;

         METHOD(GLB, _upload) = Class_findMethod(CO(GLB), "_upload", module);
         if(METHOD(GLB, _upload))
            GLB__upload = (void (*)(C(GLB) *, C(GLBType), uint, uint, const void *))METHOD(GLB, _upload)->function;

         METHOD(GLB, allocate) = Class_findMethod(CO(GLB), "allocate", module);
         if(METHOD(GLB, allocate))
            GLB_allocate = (C(bool) (*)(C(GLB) *, uint, const void *, C(GLBufferUsage)))METHOD(GLB, allocate)->function;

         METHOD(GLB, copy) = Class_findMethod(CO(GLB), "copy", module);
         if(METHOD(GLB, copy))
            GLB_copy = (void (*)(C(GLB) *, C(GLB) *, uint, uint, uint))METHOD(GLB, copy)->function;

         METHOD(GLB, deleteBuffers) = Class_findMethod(CO(GLB), "deleteBuffers", module);
         if(METHOD(GLB, deleteBuffers))
            GLB_deleteBuffers = (void (*)(int, C(GLB) *))METHOD(GLB, deleteBuffers)->function;

         METHOD(GLB, free) = Class_findMethod(CO(GLB), "free", module);
         if(METHOD(GLB, free))
            GLB_free = (void (*)(C(GLB) *))METHOD(GLB, free)->function;

         METHOD(GLB, resize) = Class_findMethod(CO(GLB), "resize", module);
         if(METHOD(GLB, resize))
            GLB_resize = (C(bool) (*)(C(GLB) *, C(GLBType), uint, uint, C(GLBufferUsage), C(bool)))METHOD(GLB, resize)->function;

         METHOD(GLB, upload) = Class_findMethod(CO(GLB), "upload", module);
         if(METHOD(GLB, upload))
            GLB_upload = (void (*)(C(GLB) *, uint, uint, const void *))METHOD(GLB, upload)->function;
      }
      CO(GLBType) = eC_findClass(module, "GLBType");
      CO(GLBufferContents) = eC_findClass(module, "GLBufferContents");
      CO(GLBufferUsage) = eC_findClass(module, "GLBufferUsage");
      CO(GLCAB) = eC_findClass(module, "GLCAB");
      if(CO(GLCAB))
      {
         METHOD(GLCAB, allocate) = Class_findMethod(CO(GLCAB), "allocate", module);
         if(METHOD(GLCAB, allocate))
            GLCAB_allocate = (C(bool) (*)(C(GLCAB) *, uint, const void *, C(GLBufferUsage)))METHOD(GLCAB, allocate)->function;

         METHOD(GLCAB, upload) = Class_findMethod(CO(GLCAB), "upload", module);
         if(METHOD(GLCAB, upload))
            GLCAB_upload = (void (*)(C(GLCAB) *, uint, uint, const void *))METHOD(GLCAB, upload)->function;
      }
      ...
      if(CO(GLEAB))
      {
         ...
         if(METHOD(GLEAB, allocate))
            GLEAB_allocate = (C(bool) (*)(C(GLEAB) *, uint, const void *, C(GLBufferUsage)))METHOD(GLEAB, allocate)->function;

         METHOD(GLEAB, draw) = Class_findMethod(CO(GLEAB), "draw", module);
         if(METHOD(GLEAB, draw))
            GLEAB_draw = (void (*)(C(GLEAB) *, int, int, int, const void *))METHOD(GLEAB, draw)->function;

         METHOD(GLEAB, draw2) = Class_findMethod(CO(GLEAB), "draw2", module);
         if(METHOD(GLEAB, draw2))
            GLEAB_draw2 = (void (*)(C(GLEAB) *, int, int, int, const void *, uint))METHOD(GLEAB, draw2)->function;

         METHOD(GLEAB, upload) = Class_findMethod(CO(GLEAB), "upload", module);
         if(METHOD(GLEAB, upload))
            GLEAB_upload = (void (*)(C(GLEAB) *, uint, uint, const void *))METHOD(GLEAB, upload)->function;
      }
      CO(GLFB) = eC_findClass(module, "GLFB");
      if(CO(GLFB))
      {
         METHOD(GLFB, copy) = Class_findMethod(CO(GLFB), "copy", module);
         if(METHOD(GLFB, copy))
            GLFB_copy = (void (*)(C(GLFB) *, const C(GLFB) *, const C(Box) *, const C(Box) *, C(ClearType), C(bool)))METHOD(GLFB, copy)->function;

         METHOD(GLFB, copyToTexture) = Class_findMethod(CO(GLFB), "copyToTexture", module);
         if(METHOD(GLFB, copyToTexture))
            GLFB_copyToTexture = (void (*)(C(GLFB) *))METHOD(GLFB, copyToTexture)->function;

         METHOD(GLFB, free) = Class_findMethod(CO(GLFB), "free", module);
         if(METHOD(GLFB, free))
            GLFB_free = (void (*)(C(GLFB) *))METHOD(GLFB, free)->function;

         METHOD(GLFB, read) = Class_findMethod(CO(GLFB), "read", module);
         if(METHOD(GLFB, read))
            GLFB_read = (void (*)(C(GLFB) *, C(Bitmap), C(ClearType), C(bool)))METHOD(GLFB, read)->function;

         METHOD(GLFB, setup) = Class_findMethod(CO(GLFB), "setup", module);
         if(METHOD(GLFB, setup))
            GLFB_setup = (C(bool) (*)(C(GLFB) *, C(bool), C(bool), int, int, int, int, int))METHOD(GLFB, setup)->function;
      }
      CO(GLIMTKMode) = eC_findClass(module, "GLIMTKMode");
      CO(GLMB) = eC_findClass(module, "GLMB");
      if(CO(GLMB))
      {
         METHOD(GLMB, free) = Class_findMethod(CO(GLMB), "free", module);
         if(METHOD(GLMB, free))
            GLMB_free = (void (*)(C(GLMB)))METHOD(GLMB, free)->function;

         METHOD(GLMB, printStats) = Class_findMethod(CO(GLMB), "printStats", module);
         if(METHOD(GLMB, printStats))
            GLMB_printStats = (void (*)(C(GLMB)))METHOD(GLMB, printStats)->function;
      }
      CO(GLMSWhatToGet) = eC_findClass(module, "GLMSWhatToGet");
      CO(GLStats) = eC_findClass(module, "GLStats");
      if(CO(GLStats))
      {
         METHOD(GLStats, allocBuffer) = Class_findMethod(CO(GLStats), "allocBuffer", module);
         if(METHOD(GLStats, allocBuffer))
            GLStats_allocBuffer = (void (*)(uint, uint))METHOD(GLStats, allocBuffer)->function;

         METHOD(GLStats, allocTexture) = Class_findMethod(CO(GLStats), "allocTexture", module);
         if(METHOD(GLStats, allocTexture))
            GLStats_allocTexture = (void (*)(uint, uint, uint, C(bool)))METHOD(GLStats, allocTexture)->function;

         METHOD(GLStats, freeBuffers) = Class_findMethod(CO(GLStats), "freeBuffers", module);
         if(METHOD(GLStats, freeBuffers))
            GLStats_freeBuffers = (void (*)(uint, uint *))METHOD(GLStats, freeBuffers)->function;

         METHOD(GLStats, freeTextures) = Class_findMethod(CO(GLStats), "freeTextures", module);
         if(METHOD(GLStats, freeTextures))
            GLStats_freeTextures = (void (*)(uint, uint *))METHOD(GLStats, freeTextures)->function;

         METHOD(GLStats, print) = Class_findMethod(CO(GLStats), "print", module);
         if(METHOD(GLStats, print))
            GLStats_print = (void (*)(void))METHOD(GLStats, print)->function;

         METHOD(GLStats, printBuf) = Class_findMethod(CO(GLStats), "printBuf", module);
         if(METHOD(GLStats, printBuf))
            GLStats_printBuf = (void (*)(char *, uint))METHOD(GLStats, printBuf)->function;
      }
      ...
      if(CO(Shader))
      {
         ...
         METHOD(Shader, setupDrawCommand) = Class_findMethod(CO(Shader), "setupDrawCommand", module);
         if(METHOD(Shader, setupDrawCommand))
            M_VTBLID(Shader, setupDrawCommand) = METHOD(Shader, setupDrawCommand)->vid;
         ...
         PROPERTY(Shader, activeCompiledShader) = Class_findProperty(CO(Shader), "activeCompiledShader", module);
         if(PROPERTY(Shader, activeCompiledShader))
            Shader_get_activeCompiledShader = (void *)PROPERTY(Shader, activeCompiledShader)->Get;
      }
      CO(ShaderModifiedUniforms) = eC_findClass(module, "ShaderModifiedUniforms");
      ...
      if(CO(Camera))
      {
         ...
         if(METHOD(Camera, setup))
            Camera_setup = (void (*)(C(Camera), int, int, const C(Point) *))METHOD(Camera, setup)->function;

         METHOD(Camera, setupVR) = Class_findMethod(CO(Camera), "SetupVR", module);
         if(METHOD(Camera, setupVR))
            Camera_setupVR = (void (*)(C(Camera), int, int, const C(Matrix) *))METHOD(Camera, setupVR)->function;
         ...
         {
            Camera_set_focal = (void *)PROPERTY(Camera, focal)->Set;
      ...
      if(CO(Euler))
      {
         ...
         if(METHOD(Euler, add))
            Euler_add = (void (*)(C(Euler) *, const C(Euler) *, const C(Euler) *))METHOD(Euler, add)->function;

         METHOD(Euler, fromMatrix) = Class_findMethod(CO(Euler), "FromMatrix", module);
         if(METHOD(Euler, fromMatrix))
            Euler_fromMatrix = (void (*)(C(Euler) *, const C(Matrix) *, C(EulerRotationOrder)))METHOD(Euler, fromMatrix)->function;

         METHOD(Euler, fromQuaternion) = Class_findMethod(CO(Euler), "FromQuaternion", module);
         if(METHOD(Euler, fromQuaternion))
            Euler_fromQuaternion = (void (*)(C(Euler) *, const C(Quaternion) *, C(EulerRotationOrder)))METHOD(Euler, fromQuaternion)->function;
      ...
      CO(EulerRotationOrder) = eC_findClass(module, "EulerRotationOrder");
      ...
      if(CO(Material))
      {
         ...
         PROPERTY(Material, shader) = Class_findProperty(CO(Material), "shader", module);
         if(PROPERTY(Material, shader))
         {
            Material_set_shader = (void *)PROPERTY(Material, shader)->Set;
            Material_get_shader = (void *)PROPERTY(Material, shader)->Get;
         }
      }
      ...
      if(CO(Matrix))
      {
         ...
         if(METHOD(Matrix, inverse))
            Matrix_inverse = (void (*)(C(Matrix) *, const C(Matrix) *))METHOD(Matrix, inverse)->function;

         METHOD(Matrix, inverseTransposeTransform) = Class_findMethod(CO(Matrix), "InverseTransposeTransform", module);
         if(METHOD(Matrix, inverseTransposeTransform))
            Matrix_inverseTransposeTransform = (void (*)(C(Matrix) *, const C(Matrix) *))METHOD(Matrix, inverseTransposeTransform)->function;

         METHOD(Matrix, multiply) = Class_findMethod(CO(Matrix), "Multiply", module);
         if(METHOD(Matrix, multiply))
            Matrix_multiply = (void (*)(C(Matrix) *, const C(Matrix) *, const C(Matrix) *))METHOD(Matrix, multiply)->function;

         METHOD(Matrix, multiply3x4) = Class_findMethod(CO(Matrix), "Multiply3x4", module);
         if(METHOD(Matrix, multiply3x4))
            Matrix_multiply3x4 = (void (*)(C(Matrix) *, const C(Matrix) *, const C(Matrix) *))METHOD(Matrix, multiply3x4)->function;

         METHOD(Matrix, rotate) = Class_findMethod(CO(Matrix), "Rotate", module);
         if(METHOD(Matrix, rotate))
            Matrix_rotate = (void (*)(C(Matrix) *, const C(Quaternion) *))METHOD(Matrix, rotate)->function;

         METHOD(Matrix, rotationQuaternion) = Class_findMethod(CO(Matrix), "RotationQuaternion", module);
         if(METHOD(Matrix, rotationQuaternion))
            Matrix_rotationQuaternion = (void (*)(C(Matrix) *, const C(Quaternion) *))METHOD(Matrix, rotationQuaternion)->function;
         ...
         if(METHOD(Matrix, transpose))
            Matrix_transpose = (void (*)(C(Matrix) *, const C(Matrix) *))METHOD(Matrix, transpose)->function;

         METHOD(Matrix, isIdentity) = Class_findMethod(CO(Matrix), "isIdentity", module);
         if(METHOD(Matrix, isIdentity))
            Matrix_isIdentity = (C(bool) (*)(C(Matrix) *))METHOD(Matrix, isIdentity)->function;
      ...
      CO(Matrixf) = eC_findClass(module, "Matrixf");
      if(CO(Matrixf))
      {
         METHOD(Matrixf, identity) = Class_findMethod(CO(Matrixf), "Identity", module);
         if(METHOD(Matrixf, identity))
            Matrixf_identity = (void (*)(C(Matrixf) *))METHOD(Matrixf, identity)->function;

         METHOD(Matrixf, fromMatrix) = Class_findMethod(CO(Matrixf), "fromMatrix", module);
         if(METHOD(Matrixf, fromMatrix))
            Matrixf_fromMatrix = (void (*)(C(Matrixf) *, C(Matrix) *))METHOD(Matrixf, fromMatrix)->function;

         PROPERTY(Matrixf, Matrix) = Class_findProperty(CO(Matrixf), "ecere::gfx3D::Matrix", module);
         if(PROPERTY(Matrixf, Matrix))
         {
            Matrixf_from_Matrix = (void *)PROPERTY(Matrixf, Matrix)->Set;
            Matrixf_to_Matrix = (void *)PROPERTY(Matrixf, Matrix)->Get;
         }
      }
      ...
      if(CO(Mesh))
      {
         ...
         METHOD(Mesh, applyMorphs) = Class_findMethod(CO(Mesh), "ApplyMorphs", module);
         if(METHOD(Mesh, applyMorphs))
            Mesh_applyMorphs = (void (*)(C(Mesh) *, C(bool)))METHOD(Mesh, applyMorphs)->function;

         METHOD(Mesh, applySkin) = Class_findMethod(CO(Mesh), "ApplySkin", module);
         if(METHOD(Mesh, applySkin))
            Mesh_applySkin = (void (*)(C(Mesh) *))METHOD(Mesh, applySkin)->function;
         ...
         METHOD(Mesh, combineMorphs) = Class_findMethod(CO(Mesh), "CombineMorphs", module);
         if(METHOD(Mesh, combineMorphs))
            Mesh_combineMorphs = (void (*)(C(Mesh) *, C(Array)))METHOD(Mesh, combineMorphs)->function;
         ...
         METHOD(Mesh, computeNormals2) = Class_findMethod(CO(Mesh), "ComputeNormals2", module);
         if(METHOD(Mesh, computeNormals2))
            Mesh_computeNormals2 = (void (*)(C(Mesh) *, C(bool), C(bool)))METHOD(Mesh, computeNormals2)->function;

         METHOD(Mesh, computeNormals3) = Class_findMethod(CO(Mesh), "ComputeNormals3", module);
         if(METHOD(Mesh, computeNormals3))
            Mesh_computeNormals3 = (void (*)(C(Mesh) *, C(bool), C(bool), C(bool)))METHOD(Mesh, computeNormals3)->function;

         METHOD(Mesh, copy) = Class_findMethod(CO(Mesh), "Copy", module);
         if(METHOD(Mesh, copy))
            Mesh_copy = (C(Mesh) * (*)(C(Mesh) *))METHOD(Mesh, copy)->function;

         METHOD(Mesh, findClosestVertex) = Class_findMethod(CO(Mesh), "FindClosestVertex", module);
         if(METHOD(Mesh, findClosestVertex))
            Mesh_findClosestVertex = (int (*)(C(Mesh) *, const C(Vector3D) *, C(Vector3Df) *))METHOD(Mesh, findClosestVertex)->function;

         METHOD(Mesh, free) = Class_findMethod(CO(Mesh), "Free", module);
         if(METHOD(Mesh, free))
            Mesh_free = (void (*)(C(Mesh) *, C(MeshFeatures)))METHOD(Mesh, free)->function;

         METHOD(Mesh, freeCPUVertexAttributes) = Class_findMethod(CO(Mesh), "FreeCPUVertexAttributes", module);
         if(METHOD(Mesh, freeCPUVertexAttributes))
            Mesh_freeCPUVertexAttributes = (void (*)(C(Mesh) *, C(MeshFeatures)))METHOD(Mesh, freeCPUVertexAttributes)->function;
         ...
         METHOD(Mesh, unapplySkin) = Class_findMethod(CO(Mesh), "UnapplySkin", module);
         if(METHOD(Mesh, unapplySkin))
            Mesh_unapplySkin = (void (*)(C(Mesh) *))METHOD(Mesh, unapplySkin)->function;

         METHOD(Mesh, unapplyTranslucency) = Class_findMethod(CO(Mesh), "UnapplyTranslucency", module);
         if(METHOD(Mesh, unapplyTranslucency))
            Mesh_unapplyTranslucency = (C(bool) (*)(C(Mesh) *, C(Object) *))METHOD(Mesh, unapplyTranslucency)->function;
         ...
         METHOD(Mesh, upload) = Class_findMethod(CO(Mesh), "Upload", module);
         if(METHOD(Mesh, upload))
            Mesh_upload = (C(bool) (*)(C(Mesh) *, C(DisplaySystem), C(bool), C(GLMB), C(GLMB), int, C(GLArrayTexture) *))METHOD(Mesh, upload)->function;

         METHOD(Mesh, uploadPrimitive) = Class_findMethod(CO(Mesh), "UploadPrimitive", module);
         if(METHOD(Mesh, uploadPrimitive))
            Mesh_uploadPrimitive = (void (*)(C(Mesh) *, C(PrimitiveSingle) *, C(DisplaySystem), C(bool), int, C(GLArrayTexture) *, C(bool), C(bool)))METHOD(Mesh, uploadPrimitive)->function;

         METHOD(Mesh, uploadTexture) = Class_findMethod(CO(Mesh), "UploadTexture", module);
         if(METHOD(Mesh, uploadTexture))
            Mesh_uploadTexture = (void (*)(C(Mesh) *, C(Bitmap), C(DisplaySystem), C(GLArrayTexture) *))METHOD(Mesh, uploadTexture)->function;

         METHOD(Mesh, fixMorphSkin) = Class_findMethod(CO(Mesh), "fixMorphSkin", module);
         if(METHOD(Mesh, fixMorphSkin))
            Mesh_fixMorphSkin = (void (*)(C(Mesh) *))METHOD(Mesh, fixMorphSkin)->function;

         METHOD(Mesh, fixSkeletonBones) = Class_findMethod(CO(Mesh), "fixSkeletonBones", module);
         if(METHOD(Mesh, fixSkeletonBones))
            Mesh_fixSkeletonBones = (void (*)(C(Mesh) *, C(SkinBone) *, int))METHOD(Mesh, fixSkeletonBones)->function;
         ...
         PROPERTY(Mesh, nIndices) = Class_findProperty(CO(Mesh), "nIndices", module);
         if(PROPERTY(Mesh, nIndices))
         {
            Mesh_set_nIndices = (void *)PROPERTY(Mesh, nIndices)->Set;
            Mesh_get_nIndices = (void *)PROPERTY(Mesh, nIndices)->Get;
         }

         PROPERTY(Mesh, meab) = Class_findProperty(CO(Mesh), "meab", module);
         if(PROPERTY(Mesh, meab))
         {
            Mesh_set_meab = (void *)PROPERTY(Mesh, meab)->Set;
            Mesh_get_meab = (void *)PROPERTY(Mesh, meab)->Get;
         }

         PROPERTY(Mesh, baseIndex) = Class_findProperty(CO(Mesh), "baseIndex", module);
         if(PROPERTY(Mesh, baseIndex))
         {
            Mesh_set_baseIndex = (void *)PROPERTY(Mesh, baseIndex)->Set;
            Mesh_get_baseIndex = (void *)PROPERTY(Mesh, baseIndex)->Get;
         }

         PROPERTY(Mesh, baseVertex) = Class_findProperty(CO(Mesh), "baseVertex", module);
         if(PROPERTY(Mesh, baseVertex))
         {
            Mesh_set_baseVertex = (void *)PROPERTY(Mesh, baseVertex)->Set;
            Mesh_get_baseVertex = (void *)PROPERTY(Mesh, baseVertex)->Get;
         }

         PROPERTY(Mesh, indices) = Class_findProperty(CO(Mesh), "indices", module);
         if(PROPERTY(Mesh, indices))
         {
            Mesh_set_indices = (void *)PROPERTY(Mesh, indices)->Set;
            Mesh_get_indices = (void *)PROPERTY(Mesh, indices)->Get;
         }
         ...
         PROPERTY(Mesh, skin) = Class_findProperty(CO(Mesh), "skin", module);
         if(PROPERTY(Mesh, skin))
         {
            Mesh_set_skin = (void *)PROPERTY(Mesh, skin)->Set;
            Mesh_get_skin = (void *)PROPERTY(Mesh, skin)->Get;
         }

         PROPERTY(Mesh, dupVerts) = Class_findProperty(CO(Mesh), "dupVerts", module);
         if(PROPERTY(Mesh, dupVerts))
         {
            Mesh_set_dupVerts = (void *)PROPERTY(Mesh, dupVerts)->Set;
            Mesh_get_dupVerts = (void *)PROPERTY(Mesh, dupVerts)->Get;
         }

         PROPERTY(Mesh, morphs) = Class_findProperty(CO(Mesh), "morphs", module);
         if(PROPERTY(Mesh, morphs))
         {
            Mesh_set_morphs = (void *)PROPERTY(Mesh, morphs)->Set;
            Mesh_get_morphs = (void *)PROPERTY(Mesh, morphs)->Get;
         }

         PROPERTY(Mesh, unmorphedMesh) = Class_findProperty(CO(Mesh), "unmorphedMesh", module);
         if(PROPERTY(Mesh, unmorphedMesh))
         {
            Mesh_set_unmorphedMesh = (void *)PROPERTY(Mesh, unmorphedMesh)->Set;
            Mesh_get_unmorphedMesh = (void *)PROPERTY(Mesh, unmorphedMesh)->Get;
         }

         PROPERTY(Mesh, translucentPrimitives) = Class_findProperty(CO(Mesh), "translucentPrimitives", module);
         if(PROPERTY(Mesh, translucentPrimitives))
            Mesh_get_translucentPrimitives = (void *)PROPERTY(Mesh, translucentPrimitives)->Get;

         PROPERTY(Mesh, nTranslucentPrimitives) = Class_findProperty(CO(Mesh), "nTranslucentPrimitives", module);
         if(PROPERTY(Mesh, nTranslucentPrimitives))
            Mesh_get_nTranslucentPrimitives = (void *)PROPERTY(Mesh, nTranslucentPrimitives)->Get;

         PROPERTY(Mesh, parts) = Class_findProperty(CO(Mesh), "parts", module);
         if(PROPERTY(Mesh, parts))
         {
            Mesh_set_parts = (void *)PROPERTY(Mesh, parts)->Set;
            Mesh_get_parts = (void *)PROPERTY(Mesh, parts)->Get;
         }
      }
      CO(MeshFeatures) = eC_findClass(module, "MeshFeatures");
      CO(MeshMorph) = eC_findClass(module, "MeshMorph");
      CO(MeshPart) = eC_findClass(module, "MeshPart");
      CO(MeshSkin) = eC_findClass(module, "MeshSkin");
      ...
      if(CO(Object))
      {
         ...
         METHOD(Object, addFrameTrack) = Class_findMethod(CO(Object), "AddFrameTrack", module);
         if(METHOD(Object, addFrameTrack))
            Object_addFrameTrack = (void (*)(C(Object) *, C(FrameTrack) *))METHOD(Object, addFrameTrack)->function;
         ...
         if(METHOD(Object, animate))
            Object_animate = (void (*)(C(Object) *, int))METHOD(Object, animate)->function;

         METHOD(Object, applyMorphs) = Class_findMethod(CO(Object), "ApplyMorphs", module);
         if(METHOD(Object, applyMorphs))
            Object_applyMorphs = (void (*)(C(Object) *, C(bool)))METHOD(Object, applyMorphs)->function;

         METHOD(Object, applySkins) = Class_findMethod(CO(Object), "ApplySkins", module);
         if(METHOD(Object, applySkins))
            Object_applySkins = (void (*)(C(Object) *))METHOD(Object, applySkins)->function;

         METHOD(Object, combineMorphs) = Class_findMethod(CO(Object), "CombineMorphs", module);
         if(METHOD(Object, combineMorphs))
            Object_combineMorphs = (void (*)(C(Object) *))METHOD(Object, combineMorphs)->function;

         METHOD(Object, delete) = Class_findMethod(CO(Object), "Delete", module);
         if(METHOD(Object, delete))
            Object_delete = (void (*)(C(Object) *, C(Object) *, C(DisplaySystem)))METHOD(Object, delete)->function;
         ...
         METHOD(Object, duplicate2) = Class_findMethod(CO(Object), "Duplicate2", module);
         if(METHOD(Object, duplicate2))
            Object_duplicate2 = (void (*)(C(Object) *, C(Object) *, C(bool)))METHOD(Object, duplicate2)->function;
         ...
         if(METHOD(Object, free))
            Object_free = (void (*)(C(Object) *, const C(DisplaySystem)))METHOD(Object, free)->function;
         ...
         METHOD(Object, insideFrustum) = Class_findMethod(CO(Object), "InsideFrustum", module);
         if(METHOD(Object, insideFrustum))
            Object_insideFrustum = (C(FrustumPlacement) (*)(C(Object) *, C(Plane) *))METHOD(Object, insideFrustum)->function;
         ...
         METHOD(Object, inverseKinematics) = Class_findMethod(CO(Object), "InverseKinematics", module);
         if(METHOD(Object, inverseKinematics))
            Object_inverseKinematics = (void (*)(C(Object) *, int, C(Array), int, const C(Vector3D) *, int))METHOD(Object, inverseKinematics)->function;
         ...
         METHOD(Object, loadEx) = Class_findMethod(CO(Object), "LoadEx", module);
         if(METHOD(Object, loadEx))
            Object_loadEx = (C(bool) (*)(C(Object) *, const char *, const char *, C(DisplaySystem), void *))METHOD(Object, loadEx)->function;
         ...
         METHOD(Object, mergeEx) = Class_findMethod(CO(Object), "MergeEx", module);
         if(METHOD(Object, mergeEx))
            Object_mergeEx = (C(bool) (*)(C(Object) *, C(DisplaySystem), C(MeshFeatures)))METHOD(Object, mergeEx)->function;
         ...
         METHOD(Object, remove) = Class_findMethod(CO(Object), "Remove", module);
         if(METHOD(Object, remove))
            Object_remove = (void (*)(C(Object) *, C(Object) *))METHOD(Object, remove)->function;

         METHOD(Object, resetPose) = Class_findMethod(CO(Object), "ResetPose", module);
         if(METHOD(Object, resetPose))
            Object_resetPose = (void (*)(C(Object) *))METHOD(Object, resetPose)->function;
         ...
         METHOD(Object, save) = Class_findMethod(CO(Object), "Save", module);
         if(METHOD(Object, save))
            Object_save = (C(bool) (*)(C(Object) *, const char *, const char *))METHOD(Object, save)->function;

         METHOD(Object, saveEx) = Class_findMethod(CO(Object), "SaveEx", module);
         if(METHOD(Object, saveEx))
            Object_saveEx = (C(bool) (*)(C(Object) *, const char *, const char *, void *))METHOD(Object, saveEx)->function;
         ...
         METHOD(Object, upload) = Class_findMethod(CO(Object), "Upload", module);
         if(METHOD(Object, upload))
            Object_upload = (void (*)(C(Object) *, C(DisplaySystem), C(GLMB), C(GLMB), int, C(GLArrayTexture) *))METHOD(Object, upload)->function;

         METHOD(Object, listTextures) = Class_findMethod(CO(Object), "listTextures", module);
         if(METHOD(Object, listTextures))
            Object_listTextures = (C(Array) (*)(C(File), const char *, const char *, void *))METHOD(Object, listTextures)->function;
         ...
         PROPERTY(Object, eulerOrientation) = Class_findProperty(CO(Object), "eulerOrientation", module);
         if(PROPERTY(Object, eulerOrientation))
         {
            Object_set_eulerOrientation = (void *)PROPERTY(Object, eulerOrientation)->Set;
            Object_get_eulerOrientation = (void *)PROPERTY(Object, eulerOrientation)->Get;
         }
         ...
         {
            Object_set_name = (void *)PROPERTY(Object, name)->Set;
         ...
         PROPERTY(Object, rotationOrder) = Class_findProperty(CO(Object), "rotationOrder", module);
         if(PROPERTY(Object, rotationOrder))
         {
            Object_set_rotationOrder = (void *)PROPERTY(Object, rotationOrder)->Set;
            Object_get_rotationOrder = (void *)PROPERTY(Object, rotationOrder)->Get;
         }

         PROPERTY(Object, displaySystem) = Class_findProperty(CO(Object), "displaySystem", module);
         if(PROPERTY(Object, displaySystem))
         {
            Object_set_displaySystem = (void *)PROPERTY(Object, displaySystem)->Set;
            Object_get_displaySystem = (void *)PROPERTY(Object, displaySystem)->Get;
         }
      }
      ...
      if(CO(ObjectFormat))
      {
         METHOD(ObjectFormat, load) = Class_findMethod(CO(ObjectFormat), "Load", module);
         if(METHOD(ObjectFormat, load))
            M_VTBLID(ObjectFormat, load) = METHOD(ObjectFormat, load)->vid;

         METHOD(ObjectFormat, save) = Class_findMethod(CO(ObjectFormat), "Save", module);
         if(METHOD(ObjectFormat, save))
            M_VTBLID(ObjectFormat, save) = METHOD(ObjectFormat, save)->vid;

         METHOD(ObjectFormat, listTextures) = Class_findMethod(CO(ObjectFormat), "listTextures", module);
         if(METHOD(ObjectFormat, listTextures))
            M_VTBLID(ObjectFormat, listTextures) = METHOD(ObjectFormat, listTextures)->vid;
      }
      ...
      if(CO(Plane))
      {
         ...
         if(METHOD(Plane, fromPointNormal))
            Plane_fromPointNormal = (void (*)(C(Plane) *, const C(Vector3D) *, const C(Vector3D) *))METHOD(Plane, fromPointNormal)->function;
         ...
         if(METHOD(Plane, fromPointsf))
            Plane_fromPointsf = (void (*)(C(Plane) *, const C(Vector3Df) *, const C(Vector3Df) *, const C(Vector3Df) *))METHOD(Plane, fromPointsf)->function;

         METHOD(Plane, intersectLine) = Class_findMethod(CO(Plane), "IntersectLine", module);
         if(METHOD(Plane, intersectLine))
            Plane_intersectLine = (void (*)(C(Plane) *, const C(Line) *, C(Vector3D) *))METHOD(Plane, intersectLine)->function;

         METHOD(Plane, intersectLinef) = Class_findMethod(CO(Plane), "IntersectLinef", module);
         if(METHOD(Plane, intersectLinef))
            Plane_intersectLinef = (void (*)(C(Plane) *, const C(Line) *, C(Vector3Df) *))METHOD(Plane, intersectLinef)->function;

         METHOD(Plane, intersectLinefT) = Class_findMethod(CO(Plane), "IntersectLinefT", module);
         if(METHOD(Plane, intersectLinefT))
            Plane_intersectLinefT = (int (*)(C(Plane) *, const C(Line) *, C(Vector3Df) *, double *))METHOD(Plane, intersectLinefT)->function;

         METHOD(Plane, multMatrix) = Class_findMethod(CO(Plane), "MultMatrix", module);
         if(METHOD(Plane, multMatrix))
            Plane_multMatrix = (void (*)(C(Plane) *, const C(Plane) *, const C(Matrix) *))METHOD(Plane, multMatrix)->function;
      }
      ...
      if(CO(Quaternion))
      {
         ...
         if(METHOD(Quaternion, divide))
            Quaternion_divide = (void (*)(C(Quaternion) *, const C(Quaternion) *, const C(Quaternion) *))METHOD(Quaternion, divide)->function;
         ...
         if(METHOD(Quaternion, inverse))
            Quaternion_inverse = (void (*)(C(Quaternion) *, const C(Quaternion) *))METHOD(Quaternion, inverse)->function;

         METHOD(Quaternion, multiply) = Class_findMethod(CO(Quaternion), "Multiply", module);
         if(METHOD(Quaternion, multiply))
            Quaternion_multiply = (void (*)(C(Quaternion) *, const C(Quaternion) *, const C(Quaternion) *))METHOD(Quaternion, multiply)->function;

         METHOD(Quaternion, normalize) = Class_findMethod(CO(Quaternion), "Normalize", module);
         if(METHOD(Quaternion, normalize))
            Quaternion_normalize = (void (*)(C(Quaternion) *, const C(Quaternion) *))METHOD(Quaternion, normalize)->function;
         ...
         if(METHOD(Quaternion, rotationAxis))
            Quaternion_rotationAxis = (void (*)(C(Quaternion) *, const C(Vector3D) *, C(Angle)))METHOD(Quaternion, rotationAxis)->function;
         ...
         if(METHOD(Quaternion, rotationDirection))
            Quaternion_rotationDirection = (void (*)(C(Quaternion) *, const C(Vector3D) *))METHOD(Quaternion, rotationDirection)->function;

         METHOD(Quaternion, rotationEuler) = Class_findMethod(CO(Quaternion), "RotationEuler", module);
         if(METHOD(Quaternion, rotationEuler))
            Quaternion_rotationEuler = (void (*)(C(Quaternion) *, const C(Euler) *, C(EulerRotationOrder)))METHOD(Quaternion, rotationEuler)->function;

         METHOD(Quaternion, rotationMatrix) = Class_findMethod(CO(Quaternion), "RotationMatrix", module);
         if(METHOD(Quaternion, rotationMatrix))
            Quaternion_rotationMatrix = (void (*)(C(Quaternion) *, const C(Matrix) *))METHOD(Quaternion, rotationMatrix)->function;
         ...
         if(METHOD(Quaternion, rotationYawPitchRoll))
            Quaternion_rotationYawPitchRoll = (void (*)(C(Quaternion) *, const C(Euler) *))METHOD(Quaternion, rotationYawPitchRoll)->function;

         METHOD(Quaternion, slerp) = Class_findMethod(CO(Quaternion), "Slerp", module);
         if(METHOD(Quaternion, slerp))
            Quaternion_slerp = (void (*)(C(Quaternion) *, const C(Quaternion) *, const C(Quaternion) *, float))METHOD(Quaternion, slerp)->function;
         ...
         METHOD(Quaternion, rotateQuats) = Class_findMethod(CO(Quaternion), "rotateQuats", module);
         if(METHOD(Quaternion, rotateQuats))
            Quaternion_rotateQuats = (void (*)(C(Quaternion) *, const C(Quaternion) *, const C(Quaternion) *, const C(Quaternion) *, C(EulerRotationOrder)))METHOD(Quaternion, rotateQuats)->function;
      }
      CO(RenderPrimitiveType) = eC_findClass(module, "RenderPrimitiveType");
      CO(SkinBone) = eC_findClass(module, "SkinBone");
      CO(SkinVert) = eC_findClass(module, "SkinVert");
      CO(Transform) = eC_findClass(module, "Transform");
      if(CO(Transform))
      {
         METHOD(Transform, getMatrix3x4f) = Class_findMethod(CO(Transform), "getMatrix3x4f", module);
         if(METHOD(Transform, getMatrix3x4f))
            Transform_getMatrix3x4f = (void (*)(C(Transform) *, float []))METHOD(Transform, getMatrix3x4f)->function;

         PROPERTY(Transform, Matrix) = Class_findProperty(CO(Transform), "ecere::gfx3D::Matrix", module);
         if(PROPERTY(Transform, Matrix))
         {
            Transform_from_Matrix = (void *)PROPERTY(Transform, Matrix)->Set;
            Transform_to_Matrix = (void *)PROPERTY(Transform, Matrix)->Get;
         }
      }
      ...
      if(CO(Vector3D))
      {
         ...
         if(METHOD(Vector3D, add))
            Vector3D_add = (void (*)(C(Vector3D) *, const C(Vector3D) *, const C(Vector3D) *))METHOD(Vector3D, add)->function;
         ...
         if(METHOD(Vector3D, divideMatrix))
            Vector3D_divideMatrix = (void (*)(C(Vector3D) *, const C(Vector3D) *, const C(Matrix) *))METHOD(Vector3D, divideMatrix)->function;
         ...
         if(METHOD(Vector3D, dotProductf))
            Vector3D_dotProductf = (double (*)(C(Vector3D) *, const C(Vector3Df) *))METHOD(Vector3D, dotProductf)->function;

         METHOD(Vector3D, multMatrix) = Class_findMethod(CO(Vector3D), "MultMatrix", module);
         if(METHOD(Vector3D, multMatrix))
            Vector3D_multMatrix = (void (*)(C(Vector3D) *, const C(Vector3D) *, const C(Matrix) *))METHOD(Vector3D, multMatrix)->function;

         METHOD(Vector3D, multMatrixf) = Class_findMethod(CO(Vector3D), "MultMatrixf", module);
         if(METHOD(Vector3D, multMatrixf))
            Vector3D_multMatrixf = (void (*)(C(Vector3D) *, const C(Vector3Df) *, const C(Matrix) *))METHOD(Vector3D, multMatrixf)->function;
         ...
         if(METHOD(Vector3D, scale))
            Vector3D_scale = (void (*)(C(Vector3D) *, const C(Vector3D) *, double))METHOD(Vector3D, scale)->function;
      ...
      if(CO(Vector3Df))
      {
         ...
         if(METHOD(Vector3Df, add))
            Vector3Df_add = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Vector3Df) *))METHOD(Vector3Df, add)->function;

         METHOD(Vector3Df, crossProduct) = Class_findMethod(CO(Vector3Df), "CrossProduct", module);
         if(METHOD(Vector3Df, crossProduct))
            Vector3Df_crossProduct = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Vector3Df) *))METHOD(Vector3Df, crossProduct)->function;

         METHOD(Vector3Df, divideMatrix) = Class_findMethod(CO(Vector3Df), "DivideMatrix", module);
         if(METHOD(Vector3Df, divideMatrix))
            Vector3Df_divideMatrix = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Matrix) *))METHOD(Vector3Df, divideMatrix)->function;

         METHOD(Vector3Df, dotProduct) = Class_findMethod(CO(Vector3Df), "DotProduct", module);
         if(METHOD(Vector3Df, dotProduct))
            Vector3Df_dotProduct = (double (*)(C(Vector3Df) *, const C(Vector3Df) *))METHOD(Vector3Df, dotProduct)->function;

         METHOD(Vector3Df, multMatrix) = Class_findMethod(CO(Vector3Df), "MultMatrix", module);
         if(METHOD(Vector3Df, multMatrix))
            Vector3Df_multMatrix = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Matrix) *))METHOD(Vector3Df, multMatrix)->function;

         METHOD(Vector3Df, multQuaternion) = Class_findMethod(CO(Vector3Df), "MultQuaternion", module);
         if(METHOD(Vector3Df, multQuaternion))
            Vector3Df_multQuaternion = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Quaternion) *))METHOD(Vector3Df, multQuaternion)->function;

         METHOD(Vector3Df, normalize) = Class_findMethod(CO(Vector3Df), "Normalize", module);
         if(METHOD(Vector3Df, normalize))
            Vector3Df_normalize = (void (*)(C(Vector3Df) *, const C(Vector3Df) *))METHOD(Vector3Df, normalize)->function;

         METHOD(Vector3Df, scale) = Class_findMethod(CO(Vector3Df), "Scale", module);
         if(METHOD(Vector3Df, scale))
            Vector3Df_scale = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, float))METHOD(Vector3Df, scale)->function;

         METHOD(Vector3Df, subtract) = Class_findMethod(CO(Vector3Df), "Subtract", module);
         if(METHOD(Vector3Df, subtract))
            Vector3Df_subtract = (void (*)(C(Vector3Df) *, const C(Vector3Df) *, const C(Vector3Df) *))METHOD(Vector3Df, subtract)->function;
      ...
      if(CO(Cube))
      {
         ...
         if(METHOD(Cube, create))
            Cube_create = (C(bool) (*)(C(Cube) *, const C(DisplaySystem)))METHOD(Cube, create)->function;
      ...
      if(CO(Cursor))
      {
         METHOD(Cursor, free) = Class_findMethod(CO(Cursor), "Free", module);
         if(METHOD(Cursor, free))
            Cursor_free = (void (*)(C(Cursor)))METHOD(Cursor, free)->function;

         METHOD(Cursor, load) = Class_findMethod(CO(Cursor), "Load", module);
         if(METHOD(Cursor, load))
            Cursor_load = (C(bool) (*)(C(Cursor), const char *, int, int, byte *, C(DisplaySystem)))METHOD(Cursor, load)->function;
      ...
      if(CO(Window))
      {
         ...
         if(METHOD(Window, freeMouseRange))
            Window_freeMouseRange = (void (*)(void))METHOD(Window, freeMouseRange)->function;
         ...
         if(METHOD(Window, restoreCaret))
            Window_restoreCaret = (void (*)(void))METHOD(Window, restoreCaret)->function;
         ...
         METHOD(Window, setMousePosition) = Class_findMethod(CO(Window), "SetMousePosition", module);
         if(METHOD(Window, setMousePosition))
            Window_setMousePosition = (void (*)(C(Window), int, int))METHOD(Window, setMousePosition)->function;
         ...
         if(METHOD(Window, update))
            Window_update = (void (*)(C(Window), const C(Box) *))METHOD(Window, update)->function;
      ...
      CO(DataFieldSort) = eC_findClass(module, "DataFieldSort");
      ...
      CO(EditSyntaxHL) = eC_findClass(module, "EditSyntaxHL");
      if(CO(EditSyntaxHL))
      {
         METHOD(EditSyntaxHL, canImpactOtherLines) = Class_findMethod(CO(EditSyntaxHL), "CanImpactOtherLines", module);
         if(METHOD(EditSyntaxHL, canImpactOtherLines))
            M_VTBLID(EditSyntaxHL, canImpactOtherLines) = METHOD(EditSyntaxHL, canImpactOtherLines)->vid;

         METHOD(EditSyntaxHL, figureStartSyntaxStates) = Class_findMethod(CO(EditSyntaxHL), "FigureStartSyntaxStates", module);
         if(METHOD(EditSyntaxHL, figureStartSyntaxStates))
            M_VTBLID(EditSyntaxHL, figureStartSyntaxStates) = METHOD(EditSyntaxHL, figureStartSyntaxStates)->vid;

         METHOD(EditSyntaxHL, gotSpace) = Class_findMethod(CO(EditSyntaxHL), "GotSpace", module);
         if(METHOD(EditSyntaxHL, gotSpace))
            M_VTBLID(EditSyntaxHL, gotSpace) = METHOD(EditSyntaxHL, gotSpace)->vid;

         METHOD(EditSyntaxHL, initDraw) = Class_findMethod(CO(EditSyntaxHL), "InitDraw", module);
         if(METHOD(EditSyntaxHL, initDraw))
            M_VTBLID(EditSyntaxHL, initDraw) = METHOD(EditSyntaxHL, initDraw)->vid;

         METHOD(EditSyntaxHL, nextLine) = Class_findMethod(CO(EditSyntaxHL), "NextLine", module);
         if(METHOD(EditSyntaxHL, nextLine))
            M_VTBLID(EditSyntaxHL, nextLine) = METHOD(EditSyntaxHL, nextLine)->vid;

         METHOD(EditSyntaxHL, parseWord) = Class_findMethod(CO(EditSyntaxHL), "ParseWord", module);
         if(METHOD(EditSyntaxHL, parseWord))
            M_VTBLID(EditSyntaxHL, parseWord) = METHOD(EditSyntaxHL, parseWord)->vid;

         METHOD(EditSyntaxHL, process) = Class_findMethod(CO(EditSyntaxHL), "Process", module);
         if(METHOD(EditSyntaxHL, process))
            M_VTBLID(EditSyntaxHL, process) = METHOD(EditSyntaxHL, process)->vid;

         METHOD(EditSyntaxHL, resetState) = Class_findMethod(CO(EditSyntaxHL), "ResetState", module);
         if(METHOD(EditSyntaxHL, resetState))
            M_VTBLID(EditSyntaxHL, resetState) = METHOD(EditSyntaxHL, resetState)->vid;

         METHOD(EditSyntaxHL, startLine) = Class_findMethod(CO(EditSyntaxHL), "StartLine", module);
         if(METHOD(EditSyntaxHL, startLine))
            M_VTBLID(EditSyntaxHL, startLine) = METHOD(EditSyntaxHL, startLine)->vid;
      }
      ...
      if(CO(ListBox))
      {
         ...
         METHOD(ListBox, multiSort) = Class_findMethod(CO(ListBox), "MultiSort", module);
         if(METHOD(ListBox, multiSort))
            ListBox_multiSort = (void (*)(C(ListBox), C(Array)))METHOD(ListBox, multiSort)->function;
         ...
         METHOD(ListBox, sortAlsoBy) = Class_findMethod(CO(ListBox), "SortAlsoBy", module);
         if(METHOD(ListBox, sortAlsoBy))
            ListBox_sortAlsoBy = (void (*)(C(ListBox), C(DataField), int))METHOD(ListBox, sortAlsoBy)->function;
      ...
      if(CO(Menu))
      {
         ...
         if(METHOD(Menu, findItem))
            Menu_findItem = (C(MenuItem) (*)(C(Menu), C(bool) (*)(C(Window), C(MenuItem), C(Modifiers)), uint64))METHOD(Menu, findItem)->function;
      ...
      if(CO(Stacker))
      {
         ...
         METHOD(Stacker, moveControl) = Class_findMethod(CO(Stacker), "MoveControl", module);
         if(METHOD(Stacker, moveControl))
            Stacker_moveControl = (void (*)(C(Stacker), C(IteratorPointer) *, C(IteratorPointer) *, C(bool)))METHOD(Stacker, moveControl)->function;
      ...
      if(CO(DCOMClientObject))
      {
         ...
         if(METHOD(DCOMClientObject, callMethod))
            DCOMClientObject_callMethod = (C(bool) (*)(C(DCOMClientObject), uint, C(bool)))METHOD(DCOMClientObject, callMethod)->function;
      ...
      if(CO(HTTPFile))
      {
         ...
         METHOD(HTTPFile, openURLEx) = Class_findMethod(CO(HTTPFile), "OpenURLEx", module);
         if(METHOD(HTTPFile, openURLEx))
            HTTPFile_openURLEx = (C(bool) (*)(C(HTTPFile), const char *, const char *, char *, const char *))METHOD(HTTPFile, openURLEx)->function;
         ...
         PROPERTY(HTTPFile, httpCode) = Class_findProperty(CO(HTTPFile), "httpCode", module);
         if(PROPERTY(HTTPFile, httpCode))
            HTTPFile_get_httpCode = (void *)PROPERTY(HTTPFile, httpCode)->Get;
      }
      ...
      if(CO(Service))
      {
         ...
         PROPERTY(Service, started) = Class_findProperty(CO(Service), "started", module);
         if(PROPERTY(Service, started))
            Service_get_started = (void *)PROPERTY(Service, started)->Get;
      }
      ...
      if(CO(Archive))
      {
         ...
         METHOD(Archive, fileOpenCompressed) = Class_findMethod(CO(Archive), "FileOpenCompressed", module);
      ...
      if(CO(File))
      {
         ...
         METHOD(File, copyToFile) = Class_findMethod(CO(File), "CopyToFile", module);
      ...
      CO(JSONFirstLetterCapitalization) = eC_findClass(module, "JSONFirstLetterCapitalization");
      ...
      if(CO(JSONParser))
      {
         ...
         PROPERTY(JSONParser, debug) = Class_findProperty(CO(JSONParser), "debug", module);
         ...
         PROPERTY(JSONParser, warnings) = Class_findProperty(CO(JSONParser), "warnings", module);
      ...
      CO(JSONTypeOptions) = eC_findClass(module, "JSONTypeOptions");
      ...
      if(CO(TempFile))
      {
         METHOD(TempFile, stealBuffer) = Class_findMethod(CO(TempFile), "StealBuffer", module);
         ...
         PROPERTY(TempFile, size) = Class_findProperty(CO(TempFile), "size", module);
         ...
         PROPERTY(TempFile, allocated) = Class_findProperty(CO(TempFile), "allocated", module);
      ...
      FUNCTION(getCombiningClass) = eC_findFunction(module, "GetCombiningClass");
      ...
      FUNCTION(__e_log) = eC_findFunction(module, "Log");
      if(FUNCTION(__e_log))
      ...
      FUNCTION(__e_logf) = eC_findFunction(module, "Logf");
      ...
      FUNCTION(printECONObject) = eC_findFunction(module, "PrintECONObject");
      if(FUNCTION(printECONObject))
         F(printECONObject) = (void *)FUNCTION(printECONObject)->function;

      FUNCTION(printObjectNotationString) = eC_findFunction(module, "PrintObjectNotationString");
      ...
      FUNCTION(stringIndent) = eC_findFunction(module, "StringIndent");
